...
/** Городские лендинги: /{city}/night-bridges/ */
...
/** Город по умолчанию для городского лендинга (полные slug). */
...
/** Входные алиасы → канонический slug города в URL. */
...
/** Канон slug → сегмент в URL (для СПб — полное saint-petersburg). */
...
/** /saint-petersburg/rechnye-progulki/ → /rechnye-progulki/saint-petersburg/ */
...
/** 301 с /landings/... и старых односегментных category-path. */
