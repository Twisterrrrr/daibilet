...
export const CITY_INFO: Record<string, CityInfoEntry> = {
  ...
  kaliningrad: {
    brief:
      'Самый западный и необычный регион России с ярким европейским прошлым. Город старинных фортов, готических кирх, сочных кёнигсбергских клопсов, пронзительного Балтийского моря и шуршащего под ногами янтаря.',
  ...
  'nizhny-novgorod': {
    ...
    hookFact: 'Набережная Федоровского - одна из лучших смотровых в городе: отсюда встречают закаты на слиянии Волги и Оки, а рядом Чкаловская лестница спускается к реке восьмеркой.',
    mustSee: [
