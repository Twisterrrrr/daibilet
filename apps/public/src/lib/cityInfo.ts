...
export interface CityInfoEntry {
   ...
   * Опционально `places` - несколько локаций внутри мини-destination.
   */
...
export const CITY_INFO: Record<string, CityInfoEntry> = {
  'saint-petersburg': {
    ...
    mustSee: [
      ...
      { name: 'Эрмитаж', desc: 'Один из крупнейших музеев мира; Зимний дворец и анфилады. Дворцовая', mustSeeFilter: 'main', venueSlug: 'ermitazh' },
      { name: 'Петропавловская крепость', desc: 'Ядро города на Заячьем острове, полуденный выстрел. Петроградская / Заячий', mustSeeFilter: 'main', locationSlug: 'saint-petersburg-petropavlovskaya-krepost' },
      { name: 'Дворцовая площадь', desc: 'Главный штаб, Александровская колонна, парадный «открыточный» кадр. Центр', mustSeeFilter: 'main', locationSlug: 'saint-petersburg-dvortsovaya-ploschad' },
      { name: 'Исаакиевский собор', desc: 'Купол и колоннада с круговой панорамой. Адмиралтейская', mustSeeFilter: 'main', locationSlug: 'saint-petersburg-isaakievskiy-sobor' },
      { name: 'Спас на Крови', desc: 'Храм-мозаика на месте покушения на Александра II. канал Грибоедова', mustSeeFilter: 'main', locationSlug: 'saint-petersburg-spas-na-krovi' },
      { name: 'Невский проспект', desc: 'Главная ось города от Адмиралтейства к Лавре. Центр', mustSeeFilter: 'main' },
      { name: 'Адмиралтейство', desc: 'Шпиль-кораблик, точка отсчёта трёх лучей. Адмиралтейская', mustSeeFilter: 'main' },
      { name: 'Медный всадник / Сенатская площадь', desc: 'Петровский символ у Невы. Адмиралтейская', mustSeeFilter: 'main' },
      { name: 'Стрелка Васильевского острова', desc: 'Ростральные колонны и разворот Невы. ВО', mustSeeFilter: 'main' },
      { name: 'Казанский собор', desc: 'Колоннада на Невском, военная слава 1812. Невский', mustSeeFilter: 'main' },
      { name: 'Михайловский замок', desc: 'Розовый дворец Павла I у Летнего сада. Инженерная', mustSeeFilter: 'main' },
      { name: 'Аничков мост', desc: 'Кони Клодта и вид на Фонтанку. Невский / Фонтанка', mustSeeFilter: 'main' },
      { name: 'Русский музей', desc: 'Главное собрание русского искусства в Михайловском дворце. пл. Искусств', mustSeeFilter: 'museum' },
      { name: 'Главный штаб (Эрмитаж)', desc: 'Импрессионисты и панорама площади через арку. Дворцовая', mustSeeFilter: 'museum' },
      { name: 'Кунсткамера', desc: 'Петровский кабинет редкостей и глобус. Университетская наб.', mustSeeFilter: 'museum' },
      { name: 'Музей Фаберже', desc: 'Яйца и ювелирка в Шуваловском дворце. наб. Фонтанки', mustSeeFilter: 'museum' },
      { name: 'Эрарта', desc: 'Крупный частный музей современного искусства. Васильевский остров', mustSeeFilter: 'museum' },
      { name: 'Юсуповский дворец', desc: 'Интерьеры и легенда Распутина. Мойка', mustSeeFilter: 'museum' },
      { name: 'Центральный военно-морской музей', desc: 'Флотская история у Синего моста / новый корпус. Центр / ВО', mustSeeFilter: 'museum' },
      { name: 'Музей обороны и блокады Ленинграда', desc: 'Блокадная память без прикрас. Соляной пер.', mustSeeFilter: 'museum' },
      { name: 'Зоологический музей РАН', desc: 'Кит в зале и классическая натуралистика. Университетская наб.', mustSeeFilter: 'museum' },
      { name: 'Музей политической истории (особняк Кшесинской)', desc: 'XX век в модерне у Петропавловки. Кронверкский', mustSeeFilter: 'museum' },
      { name: 'Музей Анны Ахматовой в Фонтанном доме', desc: 'Серебряный век в коммунальной атмосфере. Литейный', mustSeeFilter: 'literature' },
      { name: 'Литературно-мемориальный музей Достоевского', desc: 'Квартира у Кузнечного рынка. Владимирская', mustSeeFilter: 'literature' },
      { name: 'Мраморный дворец', desc: 'Филиал Русского музея, редкий облицованный фасад. Миллионная', mustSeeFilter: 'museum' },
      { name: 'Артиллерийский музей', desc: 'Пушки во дворе у кронверка. Кронверкская наб.', mustSeeFilter: 'museum' },
      { name: 'Дворцовая набережная', desc: 'Фасад Зимнего и зеркало Невы. Дворцовая', mustSeeFilter: 'views' },
      { name: 'Дворцовый мост в развод', desc: 'Ночной ритуал навигации. Нева', mustSeeFilter: 'views' },
      { name: 'Набережная канала Грибоедова', desc: 'Изгибы к Спасу и Казанскому. Центр', mustSeeFilter: 'views' },
      { name: 'Университетская набережная', desc: 'Сфинксы и вид на стрелку с ВО. Васильевский', mustSeeFilter: 'views' },
      { name: 'Английская набережная', desc: 'Парадные особняки к западу от Сенатской. Адмиралтейская', mustSeeFilter: 'views' },
      { name: 'Набережная реки Мойки', desc: 'Камерный маршрут дворцов и мостов. Центр', mustSeeFilter: 'views' },
      { name: 'Набережная Фонтанки', desc: 'Длинный «городской» променад. Центр / Владимирский', mustSeeFilter: 'views' },
      { name: 'Петроградская набережная', desc: 'Аврора и вид на Петропавловку. Петроградка', mustSeeFilter: 'views' },
      { name: 'Колоннада Исаакия', desc: 'Платная смотровая, лучший обзор крыш центра. Исаакий', mustSeeFilter: 'views' },
      { name: 'Смотровая Лахта Центра', desc: 'Современная высота и Финский залив. Лахта', mustSeeFilter: 'views' },
      { name: 'Приморский проспект / парк 300-летия', desc: 'Залив, закаты, небоскрёб в кадре. Приморский', mustSeeFilter: 'views' },
      { name: 'Троицкий мост', desc: 'Ракурс на крепость и ростральные колонны. Нева', mustSeeFilter: 'views' },
      { name: 'Улица Зодчего Росси', desc: 'Идеальная перспектива к Александринке. пл. Островского', mustSeeFilter: 'street' },
      { name: 'Малая Садовая', desc: 'Короткий пешеходный «карман» у Невского. Центр', mustSeeFilter: 'street' },
      { name: 'Большая Морская', desc: 'Банки, особняки, тише Невского. Адмиралтейская', mustSeeFilter: 'street' },
      { name: 'Улица Рубинштейна', desc: 'Вечерняя жизнь и старый доходный фонд. Владимирская', mustSeeFilter: 'street' },
      { name: 'Коломна', desc: 'Тихие каналы и lit-маршрут «Пиковой дамы». Коломна', mustSeeFilter: 'street' },
      { name: 'Линии Васильевского острова', desc: 'Сетка дворов и быт «острова». ВО', mustSeeFilter: 'street' },
      { name: 'Открытые дворы-колодцы (экскурсии по дворам)', desc: 'Классический петербургский код. Центр / Петроградка', mustSeeFilter: 'secret' },
      { name: 'Гостиный двор / Пассаж', desc: 'Торговые пассажи XIX века. Невский', mustSeeFilter: 'street' },
      { name: 'Каменноостровский проспект', desc: 'Модерн и зелень Петроградской стороны. Петроградка', mustSeeFilter: 'street' },
      { name: 'Пешеходная Малая Конюшенная', desc: 'Церковь св. Анны и камерный центр. у Невского', mustSeeFilter: 'street' },
      { name: 'Лофт Проект Этажи', desc: 'Дворик, крыша и независимая культура. Лиговский', mustSeeFilter: 'street' },
      { name: 'Летний сад', desc: 'Петровская ограда и скульптуры у Невы. у Михайловского замка', mustSeeFilter: 'park' },
      { name: 'Михайловский сад', desc: 'Связка Русского музея и Спаса на Крови. пл. Искусств', mustSeeFilter: 'park' },
      { name: 'Таврический сад', desc: 'Тень Таврического дворца, спокойный центр. Чернышевская', mustSeeFilter: 'park' },
      { name: 'Елагин остров (ЦПКиО)', desc: 'Дворец, пруды, «островной» день без суеты. Метро Крестовский остров', mustSeeFilter: 'park' },
      { name: 'Александровский парк', desc: 'У кронверка и зоопарка. Петроградка', mustSeeFilter: 'park' },
      { name: 'Парк 300-летия Санкт-Петербурга', desc: 'Залив и современный променад. Приморский', mustSeeFilter: 'park' },
      { name: 'Ботанический сад Петра Великого', desc: 'Оранжереи и Аптекарский остров. Петроградка', mustSeeFilter: 'park' },
      { name: 'Юсуповский сад', desc: 'Камерный зелёный двор у Садовой. Садовая', mustSeeFilter: 'park' },
      { name: 'Приморский парк Победы', desc: 'Крестовский, аллеи к стадиону. Крестовский', mustSeeFilter: 'park' },
      { name: 'Новая Голландия (парк-остров)', desc: 'Газон, пруд, современный «городской курорт». Адмиралтейский', mustSeeFilter: 'park' },
      { name: 'Заячий остров (территория крепости)', desc: 'Пляж, валы, вид на стрелку. Петропавловка', mustSeeFilter: 'park' },
      { name: 'Смольный собор', desc: 'Голубое барокко Растрелли. Смольная наб.', mustSeeFilter: 'temple' },
      { name: 'Никольский морской собор', desc: '«морской» храм у канала Крюкова. Коломна', mustSeeFilter: 'temple' },
      { name: 'Александро-Невская лавра', desc: 'Монастырь и некрополи у конца Невского. пл. Александра Невского', mustSeeFilter: 'temple' },
      { name: 'Владимирский собор', desc: 'Купола у Достоевского района. Владимирская', mustSeeFilter: 'temple' },
      { name: 'Андреевский собор', desc: 'Доминанта 6-й линии ВО. Васильевский', mustSeeFilter: 'temple' },
      { name: 'Чесменская церковь', desc: 'Псевдоготика у Московского пр. Московский', mustSeeFilter: 'temple' },
      { name: 'Сампсониевский собор', desc: 'Память Полтавы на Выборгской стороне. Выборгская', mustSeeFilter: 'temple' },
      { name: 'Князь-Владимирский собор', desc: 'Купола у Тучкова моста. Петроградка', mustSeeFilter: 'temple' },
      { name: 'Гранд Макет Россия', desc: 'Страна в миниатюре, день легко закрывается здесь. Московский пр. / Цветочная', mustSeeFilter: 'science' },
      { name: 'Музей железных дорог России', desc: 'Поезда под крышей у Балтийского вокзала. Адмиралтейский', mustSeeFilter: 'science' },
      { name: 'Ленинградский зоопарк', desc: 'Компактный классический зоопарк у крепости. Александровский парк', mustSeeFilter: 'science' },
      { name: 'Океанариум', desc: 'Акулы и туннель в ТРК у Парка Победы. Московский', mustSeeFilter: 'science' },
      { name: '«ЛабиринтУм»', desc: 'Интерактивная наука руками для детей. Петроградка', mustSeeFilter: 'science' },
      { name: 'Планетарий №1', desc: 'Крупный крытый купол и научпоп-шоу. Александровский парк', mustSeeFilter: 'science' },
      { name: 'Диво-остров', desc: 'Аттракционы и семейный день на Крестовском. Крестовский остров', mustSeeFilter: 'science' },
      { name: 'Музей кукол', desc: 'Камерная коллекция для детей и взрослых. Каменноостровский', mustSeeFilter: 'science' },
      { name: 'Крейсер «Аврора»', desc: 'Палуба и короткая история для детей и взрослых. Петроградская наб.', mustSeeFilter: 'science' },
      { name: 'Детский музейный центр Эрмитажа', desc: '«вход» в большой музей без перегруза. Дворцовая', mustSeeFilter: 'science' },
      { name: 'Севкабель Порт', desc: 'Бывший кабельный завод у Финского залива, еда и виды. Гавань / ВО', mustSeeFilter: 'creative' },
      { name: 'Музей уличного искусства (МОСИ)', desc: 'Стрит-арт на действующем заводе. пр. Шаумяна', mustSeeFilter: 'creative' },
      { name: 'Центральный выставочный зал «Манеж»', desc: 'Большие временные экспозиции. Исаакиевская пл.', mustSeeFilter: 'creative' },
      { name: 'Ледокол «Красин»', desc: 'Музей-корабль у набережной Лейтенанта Шмидта. ВО', mustSeeFilter: 'creative' },
      { name: 'Подводная лодка Д-2 «Народоволец»', desc: 'Тесный корпус как антипод дворцам. Василеостровская', mustSeeFilter: 'creative' },
      { name: 'Музей воды', desc: 'Инженерия города в водонапорной башне. Шпалерная', mustSeeFilter: 'creative' },
      { name: 'Дом компании «Зингер»', desc: 'Книжный дом и вид на Казанский с угла. Невский, 28', mustSeeFilter: 'literature' },
      { name: 'Мариинский театр (здание / площадь)', desc: 'Якорь вечерней культуры; билет опционален. Театральная', mustSeeFilter: 'creative' },
      { name: 'БДТ имени Товстоногова', desc: 'Фасад на Фонтанке и классика русской сцены. Фонтанка', mustSeeFilter: 'creative' },
      { name: 'Лахта / общественные пространства у башни', desc: 'Новый силуэт города без обязательного подъёма. Приморский', mustSeeFilter: 'creative' },

      { name: 'Двор Капеллы', desc: 'Тихий двор за Певческой капеллой с арками и проходом к Мойке. Центр', mustSeeFilter: 'secret' },
      { name: 'Аптека доктора Пеля', desc: 'Старинная аптека и двор с башней, вокруг которой выросли городские легенды. ВО', mustSeeFilter: 'secret' },
      { name: 'Набережная Макарова', desc: 'Прогулка вдоль Малой Невы с видом на Петроградскую сторону. ВО', mustSeeFilter: 'views' },
      { name: 'Академия художеств', desc: 'Историческое здание академии со сфинксами на Университетской набережной. ВО', mustSeeFilter: 'museum' },
      { name: 'Брусницын', desc: 'Культурный квартал в бывших промышленных корпусах у залива. Кожевенная линия', mustSeeFilter: 'creative' },
      { name: 'Санкт-Петербургская соборная мечеть', desc: 'Северный модерн с бирюзовым куполом у Кронверкского проспекта. Петроградская', mustSeeFilter: 'temple' },
      { name: 'Павловский дом-музей', desc: 'Мемориальный адрес на Петроградской стороне для литературной прогулки. Петроградская', mustSeeFilter: 'literature' },
      { name: 'Семимостье', desc: 'Редкий ракурс, где с одной точки видны семь мостов над каналами Коломны. Коломна', mustSeeFilter: 'secret' },
      { name: 'Бертгольд-центр', desc: 'Двор-колодец и творческие пространства в старом здании на Гражданской улице. Сенная', mustSeeFilter: 'creative' },
      { name: 'Львиный мост', desc: 'Пешеходный мост с белыми львами над каналом Грибоедова. Коломна', mustSeeFilter: 'views' },
      { name: 'Пять углов', desc: 'Знаменитый перекресток доходных домов и литературных маршрутов. Владимирская', mustSeeFilter: 'street' },
      { name: 'Доходный дом Бака', desc: 'Знаменитое здание на Кирочной улице, скрывающее внутри двора-колодца уникальные сквозные подвесные галереи-переходы, соединяющие лицевой и дворовый флигели на уровне второго и четвертого этажей.', mustSeeFilter: 'houses' },
      { name: 'Толстовский дом', desc: 'Монументальный жилой комплекс работы Федора Лидваля, визитной карточкой которого стали три последовательные ренессансные арки, образующие внутреннюю проходную улицу от Рубинштейна до Фонтанки.', mustSeeFilter: 'houses' },
      { name: 'Доходный дом Мурузи', desc: 'Шедевр неомавританского стиля, украшенный арабской вязью, терракотовыми изразцами и подковами арок, ставший главным литературным адресом города, где жили Гиппиус, Гумилев и Иосиф Бродский.', mustSeeFilter: 'houses' },
      ...
      { name: 'Доходный дом Бубыря', desc: 'Эталонный образец сурового северного модерна, фасад которого облицован грубым финским гранитом и украшен загадочными барельефами сказочных птиц, рыб и лесных существ.', mustSeeFilter: 'houses' },
      { name: 'Дом с совами', desc: 'Здание на Карповке, привлекающее внимание массивным угловым эркером и огромными скульптурами полярных сов, которые словно охраняют покой жильцов Петроградской стороны.', mustSeeFilter: 'houses' },
      ...
      { name: 'Парадная «Ромашка» (Дом Елисеева)', desc: 'Уникальный круглый вестибюль на улице Ломоносова, где центральный пилон и радиальные рамы окон создают иллюзию раскрытого цветка. (If same as 109 Eliseevs on Fontanka, merge carefully - owner listed both; prefer distinct addresses if different.)', mustSeeFilter: 'houses' },
      ...
      { name: 'Особняк Кельха', desc: 'Один из самых дорогих частных домов города на улице Чайковского, скрывающий во дворе готический павильон, а внутри - потрясающий Белый зал с гигантским камином.', mustSeeFilter: 'mansions' },
      { name: 'Особняк Брусницыных', desc: 'Загадочное здание на Кожевенной линии, за полузаброшенным фасадом которого скрываются парадные залы в стиле ренессанса и легендарное «зеркало Дракулы», приносящее несчастья.', mustSeeFilter: 'mansions' },
      ...
      { name: 'Дворец Белосельских-Белозерских', desc: 'Роскошный розовый дворец на углу Невского проспекта и Фонтанки, построенный Штакеншнейдером в стиле необарокко и украшенный мощными фигурами атлантов.', mustSeeFilter: 'mansions' },
      ...
      { name: 'Пышечная на Большой Конюшенной', desc: 'Старейшая непрерывно действующая пышечная города (с 1958 года), занесенная в Красную книгу Петербурга, где пышки до сих пор жарят на советских автоматах по неизменному ГОСТу.', mustSeeFilter: 'gastro' },
      { name: 'Литературное кафе (Вольф и Беранже)', desc: 'Историческая кондитерская на Невском проспекте, где Александр Пушкин встретился со своим секундантом Данзасом перед роковой дуэлью на Черной речке.', mustSeeFilter: 'gastro' },
      ...
      { name: 'Арт-кафе «Бродячая собака»', desc: 'Исторический подвал на площади Искусств, бывший в начале XX века главным ночным клубом и трибуной для поэтов Серебряного века.', mustSeeFilter: 'gastro' },
      ...
      { name: 'Ресторан «Корюшка»', desc: 'Панорамный ресторан холдинга Ginza Project прямо у стен Петропавловской крепости, специализирующийся на приготовлении главного гастросимвола города круглый год.', mustSeeFilter: 'gastro' },
      { name: 'Спикизи-бар «El Copitas»', desc: 'Скрытый во дворах Владимирской площади мексиканский бар без вывески, ставший легендой благодаря многократному попаданию в топ-50 лучших баров мира.', mustSeeFilter: 'gastro' },
      ...
      { name: 'Бар «Хроники»', desc: 'Интеллектуальная рюмочная на улице Некрасова, возродившая культуру ленинградских питейных заведений для новой творческой интеллигенции.', mustSeeFilter: 'gastro' },
      ...
      { name: 'Общественное пространство «Двор Гостинки»', desc: 'Внутренний секретный двор Большого Гостиного двора, превращенный в масштабный летний фудкорт под открытым небом с шезлонгами и крафтовыми барами.', mustSeeFilter: 'gastro' },
    ...
    significantSuburbs: [
      {
        name: 'Петергоф',
        desc: 'Пять точек для отдельной загородной поездки.',
        mustSeeFilter: 'main',
        places: [
          { name: 'Нижний парк Петергофа', desc: 'регулярный парадный сад Петра I на берегу Финского залива со знаменитой системой фонтанов, работающей вообще без насосов.' },
          { name: 'Большой каскад', desc: 'монументальное фонтанное сооружение с гротами и позолоченной фигурой Самсона, разрывающего пасть льва, символизирующей победу над Швецией.' },
          { name: 'Парк Александрия', desc: 'уединенная пейзажная резиденция четырех поколений Романовых, оформленная в стиле романтической английской неоготики.' },
          { name: 'Готическая капелла', desc: 'домашняя церковь императорской семьи в Александрии, являющаяся шедевром ложной готики работы архитектора Шинкеля.' },
          { name: 'Дворец Монплезир', desc: 'любимый приморский дворец Петра Великого со старинной голландской плиткой, где царь лично принимал иностранных послов.' },
        ],
      },
      {
        ...
        mustSeeFilter: 'main',
        places: [
          { name: 'Екатерининский дворец', desc: 'грандиозный барочный замок Франческо Растрелли, внутри которого находится знаменитая, полностью восстановленная Янтарная комната.' },
          { name: 'Царскосельский лицей', desc: 'мемориальный музей, сохранивший подлинную обстановку комнат и классов, где учился и писал первые стихи Александр Пушкин.' },
          { name: 'Александровский дворец', desc: 'любимый уединенный дом последнего императора Николая II, откуда вся царская семья была навсегда отправлена в ссылку в Сибирь.' },
          { name: 'Павильон «Эрмитаж»', desc: 'барочный парковый павильон Екатерининского парка, оборудованный потайными подъемными механизмами для обеденных столов.' },
          { name: 'Ратная палата', desc: 'уникальный комплекс в неорусском стиле, где сегодня открыт единственный в России музей истории Первой мировой войны.' },
        ],
      },
      {
        name: 'Кронштадт',
        ...
        mustSeeFilter: 'main',
        places: [
          { name: 'Морской Никольский собор', desc: 'колоссальный ставропигиальный храм на Якорной площади, построенный по образу Софии Константинопольской как мемориал погибшим морякам.' },
          { name: 'Музей военно-морской славы', desc: 'ультрасовременный павильон, главным экспонатом которого стала первая советская атомная подлодка К-3, размещенная прямо внутри здания.' },
          { name: 'Парк «Остров фортов»', desc: 'масштабное общественное пространство, посвященное истории флота, с Аллеей героев, маяком памяти и панорамными качелями.' },
          { name: 'Кронштадтский футшток', desc: 'один из старейших в мире приборов у Синего моста, фиксирующий нулевой уровень Балтийской системы высот и глубин.' },
          { name: 'Шведская крепость (Форт Константин)', desc: 'один из крупнейших артиллерийских фортов Кронштадта, защищавший фарватер Невы и доступный сегодня для берегового осмотра.' },
        ],
      },
      {
        name: 'Гатчина',
        ...
        mustSeeFilter: 'main',
        places: [
          { name: 'Большой Гатчинский дворец', desc: 'суровый охотничий замок Антонио Ринальди из пудостского камня, скрывающий 130-метровый подземный ход к Серебряному озеру.' },
          { name: 'Приоратский дворец', desc: 'уникальный миниатюрный замок Мальтийского ордена на берегу Черного озера, полностью построенный из прессованной земли по технологии землебита.' },
          { name: 'Дворцовый парк в Гатчине', desc: 'старейший пейзажный парк региона с Водным лабиринтом, павильоном Венеры и регулярными Садами на островах.' },
          { name: 'Павильон Орла', desc: 'монументальная каменная колоннада-ротонда на берегу Белого озера, построенная по проекту Бренны для императора Павла I.' },
          { name: 'Гатчинский гейзер (Источник)', desc: 'необычная природно-техногенная аттракция в лесах под Гатчиной, где из старых скважин бьют настоящие водяные фонтаны.' },
        ],
      },
      {
        name: 'Павловск',
        ...
        mustSeeFilter: 'main',
        places: [
          { name: 'Павловский парк', desc: 'один из самых больших пейзажных парков Европы (600 гектаров), славящийся своими живописными районами «Белая береза» и «Старая Сильвия».' },
          { name: 'Павловский дворец', desc: 'золотисто-белый классический дворец Чарльза Камерона, возведенный на высоком холме над извилистой рекой Славянкой.' },
          { name: 'Долина реки Славянки', desc: 'самый поэтичный прогулочный маршрут Павловска со множеством изящных мостиков, Колоннадой Аполлона и павильоном «Храм Дружбы».' },
          { name: 'Павильон «Пиль-башня»', desc: 'необычная парковая постройка в виде замшелой водяной мельницы с соломенной крышей, внутри которой скрывается роскошный парадный салон.' },
          { name: 'Собственный садик императрицы', desc: 'скрытый регулярный мини-сад у южного фасада дворца, украшенный статуями и редкими сортами голландских цветов.' },
        ],
      },
      {
        ...
        mustSeeFilter: 'main',
        places: [
          { name: 'Большой Меншиковский дворец', desc: 'грандиозная барочная резиденция фаворита Петра I, которая по своим масштабам изначально превосходила даже строящийся в то же время Петергоф.' },
          { name: 'Китайский дворец', desc: 'подлинный шедевр стиля рококо архитектора Антонио Ринальди, уцелевший в войну и знаменитый своим уникальным Стеклярусным кабинетом с мерцающими панно.' },
          { name: 'Павильон Катальной горки', desc: 'уцелевшая часть огромного императорского аттракциона XVIII века, откуда царская знать спускалась на специальных колясочках с высоты 20 метров.' },
          { name: 'Дворец Петра III', desc: 'миниатюрный каменный замок-крепость «Петерштадт», построенный для уединенных военных игр и отдыха несчастного императора.' },
          { name: 'Парк Ораниенбаум', desc: 'огромный пейзажный массив с вековыми деревьями, мостиками Ринальди и прудами, разделенный на Верхний и Нижний регулярные сады.' },
        ],
      },
      {
        name: 'Стрельна',
        ...
        mustSeeFilter: 'main',
        places: [
          { name: 'Константиновский дворец', desc: 'величественная парадная резиденция Романовых у самой воды, полностью восстановленная в XXI веке как действующий Государственный комплекс «Дворец конгрессов».' },
          { name: 'Путевой дворец Петра I', desc: 'скромный деревянный дом царя, заложенный у реки Стрелки, где были обустроены первые в России опытные грядки для картофеля и лекарственных трав.' },
          { name: 'Константиновский парк', desc: 'масштабный гидротехнический парк с каналами и разводными мостами, открывающий парадную панораму на Финский залив.' },
          { name: 'Львовский дворец', desc: 'изящная неоготическая усадьба с зубчатыми башнями, построенная для генерал-адъютанта князя Львова прямо на Петергофской дороге.' },
          { name: 'Орловский парк', desc: 'заброшенный романтический парк с прудом, готической башней-руиной и конюшнями, принадлежавший некогда графу Орлову.' },
        ],
      },
      {
        name: 'Выборг',
        ...
        mustSeeFilter: 'main',
        places: [
          { name: 'Выборгский замок', desc: 'единственный в России полностью сохранившийся средневековый шведский рыцарский замок, основанный на скалистом острове в 1293 году.' },
          { name: 'Башня Святого Олафа', desc: 'монументальная замковая доминанта с толщиной стен до четырех метров, служащая главной смотровой площадкой на историческую брусчатку города.' },
          { name: 'Скальный парк Монрепо', desc: 'редкий по красоте скальный пейзажный парк на берегу Выборгского залива с гранитными валунами ледникового периода и Островом мертвых.' },
          { name: 'Часовая башня', desc: 'старинная колокольня разрушенного собора XV века, на которой до сих пор исправно работают тяжелые часовые механизмы часового мастера.' },
          { name: 'Библиотека Алвара Аалто', desc: 'шедевр мирового архитектурного функционализма с уникальным волнообразным деревянным потолком и системой бестеневого освещения.' },
        ],
      },
      {
        ...
        mustSeeFilter: 'main',
        places: [
          { name: 'Сестрорецкий Рубеж', desc: 'выставочный комплекс на месте оборонительного Карельского укрепрайона с подлинным железобетонным ДОТом «Миллионер» внутри.' },
          { name: 'Экотропа «Комаровский берег»', desc: 'пешеходный деревянный маршрут сквозь вековой таежный лес, дюны и муравейники-гиганты прямо к песчаному пляжу залива.' },
          { name: 'Музей-усадьба И. Е. Репина «Пенаты»', desc: 'деревянный дом художника в Репино с уникальной стеклянной крышей-куполом, где он провел последние тридцать лет жизни.' },
          { name: 'Комаровский некрополь', desc: 'тихое лесное мемориальное кладбище, ставшее местом упокоения Анны Ахматовой, Дмитрия Лихачева и других деятелей науки и культуры.' },
          { name: 'Заказник «Сестрорецкое болото»', desc: 'масштабная болотная экосистема с длинной пешеходной тропой на сваях, проложенной через нетронутые дикие топи.' },
        ],
      },
      {
        ...
        mustSeeFilter: 'main',
        places: [
          { name: 'Крепость Орешек', desc: 'древняя новгородская фортеция XIV века на Ореховом острове в истоке Невы, выдержавшая жестокие штурмы шведов и ставшая главной тюрьмой империи.' },
          { name: 'Секретный дом (Старая тюрьма)', desc: 'сохранившийся крепостной корпус, где в одиночных камерах десятилетиями содержались декабристы, народовольцы и полярник шекспировед Морозов.' },
          { name: 'Королевская башня', desc: 'мощная угловая башня крепости, построенная шведами по последнему слову средневековой фортификации во время оккупации острова.' },
          { name: 'Староладожский канал', desc: 'грандиозное гидротехническое сооружение первой половины XVIII века, строившееся по приказу Петра I для безопасного обхода бурной Ладоги.' },
          { name: 'Памятник Петру I в Шлиссельбурге', desc: 'один из немногих советских памятников царю, установленный на пристани, откуда катера отправляются на остров.' },
        ],
      },
      {
        ...
        mustSeeFilter: 'main',
        places: [
          { name: 'Андерсенград', desc: 'уникальный детский игровой городок из камня, построенный к 175-летию Ханса Кристиана Андерсена в стиле средневековой западноевропейской архитектуры с ратушей, подземным ходом и бастионами.' },
          { name: 'Природный парк «Липовский пляж»', desc: 'многокилометровый песчаный берег Финского залива с вековыми соснами и дюнами, обрамляющий уникальное соленое озеро Липово.' },
          { name: 'Парк «Приморский»', desc: 'благоустроенный прибрежный лесопарк с современными деревянными набережными, экотропами на сваях и панорамными смотровыми площадками на залив.' },
          { name: 'Копорская крепость', desc: 'расположенная неподалеку древнерусская каменная фортеция XIII века, возведенная на высокой скале и частично сохранившая средневековые башни и оборонительные стены.' },
          { name: 'Ранчо «Эвелон»', desc: 'популярный загородный эко-комплекс и конный клуб в окрестностях города, предлагающий прогулки по хвойным лесам побережья.' },
        ],
      },
    ],
    dayRoutePresets: [
      {
        ...
        stops: [
          ...
          spbPresetStop('Литературное кафе (Вольф и Беранже)'),
        ],
      },
      {
        id: 'spb-2',
  ...
  kaliningrad: {
    ...
    significantSuburbs: [
      {
        name: 'Куршская коса',
        desc: 'Уникальный природный песчаный заповедник ЮНЕСКО между Балтийским морем и Куршским заливом - отдельный day-trip из города.',
        locationSlug: 'kaliningrad-kurshskaya-kosa',
        places: [
          { name: 'Дюна Эфа', desc: 'Одна из самых высоких песчаных дюн в Европе, оборудованная деревянными эко-тропами и смотровыми площадками с видом на пустынные пейзажи и море', locationSlug: 'kaliningrad-dyuna-efa' },
          { name: 'Танцующий лес', desc: 'Аномальный участок соснового бора, где стволы деревьев причудливо изгибаются, закручиваясь в кольца и спирали', locationSlug: 'kaliningrad-tantsuyuschiy-les' },
          { name: 'Орнитологическая станция «Фрингилла»', desc: 'Полевой стационар первого в мире орнитологического института, где ученые до сих пор вручную кольцуют миллионы мигрирующих птиц' },
          { name: 'Высота Мюллера', desc: 'Живописный пешеходный маршрут, проходящий по самой древней части дюны Брухберг через вековой сосновый лес' },
        ],
      },
      {
        ...
        places: [
          { name: 'Курортный проспект', desc: 'Полностью пешеходная и идеально отреставрированная улица со старинной немецкой застройкой, гирляндами, кошачьими граффити и интерактивными окнами' },
          { name: 'Музей кошек «Мурариум»', desc: 'Расположен в 40-метровой довоенной водонапорной башне, на вершине которой оборудована отличная смотровая площадка', venueSlug: 'kaliningrad-muzey-koshek-murarium' },
          { name: 'Памятник зеленоградским котам', desc: 'Вращающаяся скульптура кота на оконном подоконнике, ставшая главным символом и фото-точкой города' },
          { name: 'Бювет «Королева Луиза»', desc: 'Исторический источник на набережной, где каждый желающий может бесплатно попробовать местную лечебную минеральную воду' },
          { name: 'Музей «Домик Ангелов»', desc: 'Частная арт-коллекция уникальных фигурок, картин и скульптур ангелов, расположенная в колоритном деревянном доме' },
        ],
      },
      {
        ...
        places: [
          { name: 'Водонапорная башня Раушена', desc: '25-метровое здание в стиле немецкого романтизма, обвитое плющом. Визитная карточка и самый узнаваемый силуэт города', locationSlug: 'kaliningrad-vodonapornaya-bashnya-raushena' },
          { name: 'Променад и Солнечные часы «Зодиак»', desc: 'Масштабная набережная, украшенная уникальными мозаичными часами, которые занесены в Книгу рекордов Гиннесса за точность и размеры' },
          { name: 'Канатная дорога', desc: 'Очаровательный ретро-фуникулер с маленькими желтыми кабинками, спускающий туристов со скалистого обрыва прямо к морю' },
          { name: 'Органный зал «Макаров»', desc: 'Концертный зал с потрясающей акустикой, восстановленный на месте разрушенной старинной капеллы «Santa Maria Stella Maris»' },
          { name: 'Вилла Порт', desc: 'Одна из самых роскошных и хорошо сохранившихся немецких вилл начала XX века, окруженная дендропарком' },
        ],
      },
      {
        ...
        places: [
          { name: 'Шведская крепость Пиллау', desc: 'Цитадель XVII века в форме пятиконечной звезды, которая до сих пор является действующим военным объектом, но доступна с экскурсиями', locationSlug: 'kaliningrad-shvedskaya-krepost-pillau' },
          { name: 'Маяк Пиллау', desc: 'Самый западный маяк России (высота 33 метра), построенный знаменитым архитектором Карлом Шинкелем' },
          { name: 'Памятник Елизавете Петровне', desc: 'Грандиозный монумент императрице на коне, установленный на самом молу у Балтийского пролива' },
          { name: 'Пехотные казармы', desc: 'Монументальный комплекс зданий из красного кирпича начала XX века, где сейчас располагается штаб Балтийского флота' },
          { name: 'Немецкий аэродром Нойтиф', desc: 'Заброшенные гигантские авиационные ангары на Балтийской косе, построенные прямо на песке перед Второй мировой войной' },
        ],
      },
      {
        ...
        places: [
          { name: 'Смотровая площадка Янтарного комбината', desc: 'Единственное место, откуда можно вживую увидеть масштабный карьер, где экскаваторы добывают янтарь шагающим способом. К услугам туристов - «янтарная песочница», где можно самостоятельно откопать сувениры',
            locationSlug: 'kaliningrad-smotrovaya-yantarnogo-kombinata',
          },
          { name: 'Пляж «Шахта Анна»', desc: 'Широкий песчаный пляж, регулярно получающий международный «Голубой флаг» за эталонную чистоту' },
          { name: 'Парк Беккера', desc: 'Старинный парк, заложенный янтарным королем Морисом Беккером, где высажены редкие деревья со всего мира, включая уникальное тюльпанное дерево' },
          { name: 'Янтарный замок', desc: 'Историческое здание крепостного замка XIV века, где сегодня находятся музей пыток, выставка оружия и янтарная лавка' },
        ],
      },
    ],
    dayRoutePresets: [
      {
        ...
        stops: [
          ...
          { name: 'Остров Канта (Кнайпхоф)', desc: 'Парк и могила философа' },
          ...
          { name: 'Район Амалиенау', desc: 'Прогулка среди вилл' },
          { name: 'Гастробар «Соль»', desc: 'Вечерняя гастро-пауза' },
        ],
      },
      {
        id: 'kaliningrad-coast-curonian-zelenogradsk',
        title: 'Приморский экспресс - коса и Зеленоградск',
        description: 'Дневной маршрут на Куршскую косу: дюна Эфа, море и прогулка по Зеленоградску.',
        stops: [
          { name: 'Куршская коса', desc: 'Въезд в национальный парк', locationSlug: 'kaliningrad-kurshskaya-kosa' },
          { name: 'Дюна Эфа', desc: 'Дюны и панорама Балтики' },
          { name: 'Зеленоградск (Кранц)', desc: 'Курортный проспект и Мурариум' },
        ],
      },
      {
        id: 'kaliningrad-coast-svetlogorsk-yantarny',
        title: 'Приморский экспресс - Светлогорск и Янтарный',
        description: 'Дневной маршрут по западному побережью: башня Раушена, пляж и янтарный карьер.',
        stops: [
          { name: 'Светлогорск (Раушен)', desc: 'Водонапорная башня и променад' },
          { name: 'Янтарный (Пальмикен)', desc: 'Пляж «Шахта Анна» и поселок' },
          { name: 'Смотровая площадка Янтарного комбината', desc: 'Карьер и янтарная песочница', locationSlug: 'kaliningrad-yantarnyy-kombinat' },
        ],
      },
    ],
    travel:
