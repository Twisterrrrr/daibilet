...
export const CITY_INFO: Record<string, CityInfoEntry> = {
  'saint-petersburg': {
    ...
    mustSee: [
      ...
      { name: 'Эрмитаж', desc: 'Один из крупнейших музеев мира; Зимний дворец и анфилады.', mustSeeFilter: 'main', venueSlug: 'ermitazh' },
      { name: 'Петропавловская крепость', desc: 'Ядро города на Заячьем острове, полуденный выстрел.', mustSeeFilter: 'main', locationSlug: 'saint-petersburg-petropavlovskaya-krepost' },
      { name: 'Дворцовая площадь', desc: 'Главный штаб, Александровская колонна, парадный «открыточный» кадр.', mustSeeFilter: 'main', locationSlug: 'saint-petersburg-dvortsovaya-ploschad' },
      { name: 'Исаакиевский собор', desc: 'Купол и колоннада с круговой панорамой.', mustSeeFilter: 'main', locationSlug: 'saint-petersburg-isaakievskiy-sobor' },
      { name: 'Спас на Крови', desc: 'Храм-мозаика на месте покушения на Александра II.', mustSeeFilter: 'main', locationSlug: 'saint-petersburg-spas-na-krovi' },
      { name: 'Невский проспект', desc: 'Главная ось города от Адмиралтейства к Лавре.', mustSeeFilter: 'main',
        locationSlug: 'saint-petersburg-nevskiy-prospekt',
      },
      { name: 'Адмиралтейство', desc: 'Шпиль-кораблик, точка отсчёта трёх лучей.', mustSeeFilter: 'main',
        locationSlug: 'saint-petersburg-admiralteystvo',
      },
      { name: 'Медный всадник / Сенатская площадь', desc: 'Петровский символ у Невы.', mustSeeFilter: 'main' },
      { name: 'Стрелка Васильевского острова', desc: 'Ростральные колонны и разворот Невы.', mustSeeFilter: 'main',
        locationSlug: 'saint-petersburg-strelka-vasilevskogo-ostrova',
      },
      { name: 'Казанский собор', desc: 'Колоннада на Невском, военная слава 1812.', mustSeeFilter: 'main',
        locationSlug: 'saint-petersburg-kazanskiy-sobor',
      },
      { name: 'Михайловский замок', desc: 'Розовый дворец Павла I у Летнего сада.', mustSeeFilter: 'main',
        locationSlug: 'saint-petersburg-mihaylovskiy-zamok',
      },
      { name: 'Аничков мост', desc: 'Кони Клодта и вид на Фонтанку.', mustSeeFilter: 'main',
      ...
      { name: 'Главный штаб (Эрмитаж)', desc: 'Импрессионисты и панорама площади через арку.', mustSeeFilter: 'museum',
      ...
      { name: 'Музей Фаберже', desc: 'Яйца и ювелирка в Шуваловском дворце.', mustSeeFilter: 'museum',
        venueSlug: 'saint-petersburg-muzey-faberzhe',
      },
      { name: 'Эрарта', desc: 'Крупный частный музей современного искусства.', mustSeeFilter: 'museum',
        locationSlug: 'erarta',
      },
      ...
      { name: 'Центральный военно-морской музей', desc: 'Флотская история у Синего моста / новый корпус.', mustSeeFilter: 'museum',
        venueSlug: 'saint-petersburg-tsentralnyy-voenno-morskoy-muzey',
      },
      { name: 'Музей обороны и блокады Ленинграда', desc: 'Блокадная память без прикрас.', mustSeeFilter: 'museum',
        venueSlug: 'saint-petersburg-muzey-oborony-i-blokady-leningrada',
      },
      { name: 'Зоологический музей РАН', desc: 'Кит в зале и классическая натуралистика.', mustSeeFilter: 'museum',
        venueSlug: 'saint-petersburg-zoologicheskiy-muzey-ran',
      },
      { name: 'Музей политической истории (особняк Кшесинской)', desc: 'XX век в модерне у Петропавловки.', mustSeeFilter: 'museum',
        venueSlug: 'saint-petersburg-muzey-politicheskoy-istorii-osobnyak-kshesinskoy',
      },
      { name: 'Музей Анны Ахматовой в Фонтанном доме', desc: 'Серебряный век в коммунальной атмосфере.', mustSeeFilter: 'literature',
        venueSlug: 'saint-petersburg-muzey-anny-ahmatovoy-v-fontannom-dome',
      },
      { name: 'Литературно-мемориальный музей Достоевского', desc: 'Квартира у Кузнечного рынка.', mustSeeFilter: 'literature',
        locationSlug: 'saint-petersburg-literaturno-memorialnyy-muzey-dostoevskogo',
      },
      { name: 'Мраморный дворец', desc: 'Филиал Русского музея, редкий облицованный фасад.', mustSeeFilter: 'museum',
        locationSlug: 'saint-petersburg-mramornyy-dvorets',
      },
      { name: 'Артиллерийский музей', desc: 'Пушки во дворе у кронверка.', mustSeeFilter: 'museum',
        venueSlug: 'saint-petersburg-artilleriyskiy-muzey',
      },
      { name: 'Дворцовая набережная', desc: 'Фасад Зимнего дворца и истинное зеркало Невы.', mustSeeFilter: 'views',
        locationSlug: 'saint-petersburg-dvortsovaya-naberezhnaya',
      },
      { name: 'Дворцовый мост в развод', desc: 'Ночной ритуал навигации.', mustSeeFilter: 'views',
        locationSlug: 'saint-petersburg-dvortsovyy-most',
      },
      { name: 'Банковский мост', desc: 'Пешеходный мост с золотыми грифонами на канале Грибоедова - один из самых узнаваемых видов города.', mustSeeFilter: 'views',
        locationSlug: 'saint-petersburg-bankovskiy-most',
      },
      { name: 'Набережная канала Грибоедова', desc: 'Изгибы к Спасу и Казанскому.', mustSeeFilter: 'views',
        locationSlug: 'saint-petersburg-naberezhnaya-kanala-griboedova',
      },
      { name: 'Университетская набережная', desc: 'Сфинксы у Академии художеств и широкий вид на стрелку Васильевского острова через Неву.', mustSeeFilter: 'views',
        locationSlug: 'saint-petersburg-universitetskaya-naberezhnaya',
      },
      { name: 'Английская набережная', desc: 'Парадные особняки по соседству с Сенатской площадью.', mustSeeFilter: 'views',
        locationSlug: 'saint-petersburg-angliyskaya-naberezhnaya',
      },
      { name: 'Набережная реки Мойки', desc: 'Камерный маршрут дворцов и мостов.', mustSeeFilter: 'views',
        locationSlug: 'saint-petersburg-naberezhnaya-reki-moyki',
      },
      { name: 'Набережная Фонтанки', desc: 'Длинный городской променад вдоль реки.', mustSeeFilter: 'views',
        locationSlug: 'saint-petersburg-naberezhnaya-fontanki',
      },
      { name: 'Петроградская набережная', desc: 'Аврора и вид на Петропавловку.', mustSeeFilter: 'views',
        locationSlug: 'saint-petersburg-petrogradskaya-naberezhnaya',
      },
      ...
      { name: 'Смотровая Лахта Центра', desc: 'Современная высота и Финский залив.', mustSeeFilter: 'views',
        locationSlug: 'saint-petersburg-smotrovaya-lahta-tsentra',
      },
      ...
      { name: 'Троицкий мост', desc: 'Классический ракурс на Петропавловскую крепость и ростральные колонны со стороны Троицкой площади.', mustSeeFilter: 'views',
        locationSlug: 'saint-petersburg-troitskiy-most',
      },
      { name: 'Улица Зодчего Росси', desc: 'Идеальная театральная перспектива к Александринскому театру, эталон петербургской регулярной застройки.', mustSeeFilter: 'street',
        locationSlug: 'saint-petersburg-ulitsa-zodchego-rossi',
      },
      { name: 'Малая Садовая', desc: 'Короткий пешеходный карман у Невского.', mustSeeFilter: 'street',
        locationSlug: 'saint-petersburg-malaya-sadovaya-ulitsa',
      },
      ...
      { name: 'Улица Рубинштейна', desc: 'Вечерняя жизнь центра: бары, рестораны и старый доходный фонд между Владимирским и Фонтанкой.', mustSeeFilter: 'street',
      ...
      { name: 'Линии Васильевского острова', desc: 'Сетка дворов и повседневная жизнь острова.', mustSeeFilter: 'street',
      ...
      { name: 'Каменноостровский проспект', desc: 'Модерн и зелень Петроградской стороны.', mustSeeFilter: 'street',
      ...
      { name: 'Лофт Проект Этажи', desc: 'Дворик, крыша и независимая культура.', mustSeeFilter: 'street',
        locationSlug: 'saint-petersburg-loft-proekt-etazhi',
      },
      { name: 'Летний сад', desc: 'Петровская ограда и скульптуры у Невы.', mustSeeFilter: 'park',
        locationSlug: 'saint-petersburg-letniy-sad',
      },
      { name: 'Михайловский сад', desc: 'Связка Русского музея и Спаса на Крови.', mustSeeFilter: 'park',
        locationSlug: 'saint-petersburg-mihaylovskiy-sad',
      },
      { name: 'Таврический сад', desc: 'Тень Таврического дворца, спокойный центр.', mustSeeFilter: 'park',
        locationSlug: 'saint-petersburg-tavricheskiy-sad',
      },
      { name: 'Елагин остров (ЦПКиО)', desc: 'Дворец, пруды, «островной» день без суеты.', mustSeeFilter: 'park' },
      { name: 'Александровский парк', desc: 'У кронверка и зоопарка.', mustSeeFilter: 'park',
        locationSlug: 'saint-petersburg-aleksandrovskiy-park',
      },
      { name: 'Парк 300-летия Санкт-Петербурга', desc: 'Залив и современный променад.', mustSeeFilter: 'park' },
      { name: 'Ботанический сад Петра Великого', desc: 'Оранжереи и Аптекарский остров.', mustSeeFilter: 'park',
        locationSlug: 'saint-petersburg-botanicheskiy-sad-petra-velikogo',
      },
      { name: 'Юсуповский сад', desc: 'Камерный зелёный двор у Садовой.', mustSeeFilter: 'park',
        locationSlug: 'saint-petersburg-yusupovskiy-sad',
      },
      { name: 'Приморский парк Победы', desc: 'Крестовский, аллеи к стадиону.', mustSeeFilter: 'park' },
      { name: 'Новая Голландия (парк-остров)', desc: 'Газон, пруд, современный «городской курорт».', mustSeeFilter: 'park' },
      { name: 'Заячий остров (территория крепости)', desc: 'Пляж, валы, вид на стрелку.', mustSeeFilter: 'park' },
      { name: 'Смольный собор', desc: 'Голубое барокко Растрелли.', mustSeeFilter: 'temple',
        locationSlug: 'saint-petersburg-smolnyy-sobor',
      },
      { name: 'Никольский морской собор', desc: '«Морской» храм у канала Крюкова.', mustSeeFilter: 'temple' },
      { name: 'Александро-Невская лавра', desc: 'Монастырь и некрополи у конца Невского.', mustSeeFilter: 'temple',
        locationSlug: 'saint-petersburg-aleksandro-nevskaya-lavra',
      },
      { name: 'Владимирский собор', desc: 'Купола у Достоевского района.', mustSeeFilter: 'temple',
        locationSlug: 'saint-petersburg-vladimirskiy-sobor',
      },
      { name: 'Андреевский собор', desc: 'Доминанта 6-й линии ВО.', mustSeeFilter: 'temple' },
      { name: 'Чесменская церковь', desc: 'Псевдоготика у Московского пр.', mustSeeFilter: 'temple',
        locationSlug: 'saint-petersburg-chesmenskaya-tserkov',
      },
      { name: 'Сампсониевский собор', desc: 'Память Полтавы на Выборгской стороне.', mustSeeFilter: 'temple' },
      { name: 'Князь-Владимирский собор', desc: 'Купола у Тучкова моста.', mustSeeFilter: 'temple' },
      { name: 'Гранд Макет Россия', desc: 'Страна в миниатюре, день легко закрывается здесь.', mustSeeFilter: 'science',
        locationSlug: 'saint-petersburg-grand-maket-rossiya',
      },
      { name: 'Музей железных дорог России', desc: 'Поезда под крышей у Балтийского вокзала.', mustSeeFilter: 'science' },
      { name: 'Ленинградский зоопарк', desc: 'Компактный классический зоопарк у крепости.', mustSeeFilter: 'science',
        locationSlug: 'saint-petersburg-leningradskiy-zoopark',
      },
      { name: 'Океанариум', desc: 'Акулы и туннель в ТРК у Парка Победы.', mustSeeFilter: 'science',
        locationSlug: 'saint-petersburg-okeanarium',
      },
      { name: '«ЛабиринтУм»', desc: 'Интерактивная наука руками для детей.', mustSeeFilter: 'science' },
      { name: 'Планетарий №1', desc: 'Крупный крытый купол и научпоп-шоу.', mustSeeFilter: 'science',
        locationSlug: 'planetarii-1',
      },
      { name: 'Диво-остров', desc: 'Аттракционы и семейный день на Крестовском.', mustSeeFilter: 'science' },
      { name: 'Музей кукол', desc: 'Камерная коллекция для детей и взрослых.', mustSeeFilter: 'science' },
      { name: 'Крейсер «Аврора»', desc: 'Палуба и короткая история для детей и взрослых.', mustSeeFilter: 'science' },
      { name: 'Детский музейный центр Эрмитажа', desc: '«Вход» в большой музей без перегруза.', mustSeeFilter: 'science' },
      { name: 'Севкабель Порт', desc: 'Бывший кабельный завод у Финского залива, еда и виды.', mustSeeFilter: 'creative',
        locationSlug: 'saint-petersburg-sevkabel-port',
      },
      { name: 'Музей уличного искусства (МОСИ)', desc: 'Стрит-арт на действующем заводе.', mustSeeFilter: 'creative' },
      { name: 'Центральный выставочный зал «Манеж»', desc: 'Большие временные экспозиции.', mustSeeFilter: 'creative' },
      { name: 'Ледокол «Красин»', desc: 'Музей-корабль у набережной Лейтенанта Шмидта.', mustSeeFilter: 'creative' },
      { name: 'Подводная лодка Д-2 «Народоволец»', desc: 'Тесный корпус как антипод дворцам.', mustSeeFilter: 'creative' },
      { name: 'Музей воды', desc: 'Инженерия города в водонапорной башне.', mustSeeFilter: 'creative' },
      { name: 'Дом компании «Зингер»', desc: 'Книжный дом и вид на Казанский с угла.', mustSeeFilter: 'literature' },
      { name: 'Мариинский театр (здание / площадь)', desc: 'Якорь вечерней культуры; билет опционален.', mustSeeFilter: 'creative' },
      { name: 'БДТ имени Товстоногова', desc: 'Фасад на Фонтанке и классика русской сцены.', mustSeeFilter: 'creative' },
      { name: 'Лахта / общественные пространства у башни', desc: 'Новый силуэт города без обязательного подъёма.', mustSeeFilter: 'creative' },

      { name: 'Двор Капеллы', desc: 'Тихий двор за Певческой капеллой с арками и проходом к Мойке.', mustSeeFilter: 'secret' },
      { name: 'Аптека доктора Пеля', desc: 'Старинная аптека и двор с башней, вокруг которой выросли городские легенды.', mustSeeFilter: 'secret' },
      { name: 'Набережная Макарова', desc: 'Прогулка вдоль Малой Невы с видом на Петроградскую сторону.', mustSeeFilter: 'views' },
      { name: 'Академия художеств', desc: 'Историческое здание академии со сфинксами на Университетской набережной.', mustSeeFilter: 'museum' },
      { name: 'Брусницын', desc: 'Культурный квартал в бывших промышленных корпусах у залива.', mustSeeFilter: 'creative' },
      {
        name: 'Санкт-Петербургская соборная мечеть',
        desc: 'Северный модерн с бирюзовым куполом у Кронверкского проспекта.',
        mustSeeFilter: 'temple',
        locationSlug: 'saint-petersburg-sobornaya-mechet',
        latitude: 59.9552,
        longitude: 30.3239,
      },
      { name: 'Павловский дом-музей', desc: 'Мемориальный адрес на Петроградской стороне для литературной прогулки.', mustSeeFilter: 'literature' },
      { name: 'Семимостье', desc: 'Редкий ракурс, где с одной точки видны семь мостов над каналами Коломны.', mustSeeFilter: 'secret' },
      { name: 'Бертгольд-центр', desc: 'Двор-колодец и творческие пространства в старом здании на Гражданской улице.', mustSeeFilter: 'creative' },
      { name: 'Львиный мост', desc: 'Пешеходный мост с белыми львами над каналом Грибоедова.', mustSeeFilter: 'views' },
      { name: 'Пять углов', desc: 'Знаменитый перекресток доходных домов и литературных маршрутов.', mustSeeFilter: 'street' },
      { name: 'Доходный дом Бака', desc: 'Знаменитое здание на Кирочной улице, скрывающее внутри двора-колодца уникальные сквозные подвесные галереи-переходы, соединяющие лицевой и дворовый флигели на уровне второго и четвертого этажей.', mustSeeFilter: 'houses',
        locationSlug: 'saint-petersburg-dohodnyy-dom-baka',
      },
      ...
      { name: 'Доходный дом Мурузи', desc: 'Шедевр неомавританского стиля, украшенный арабской вязью, терракотовыми изразцами и подковами арок, ставший главным литературным адресом города, где жили Гиппиус, Гумилев и Иосиф Бродский.', mustSeeFilter: 'houses',
        locationSlug: 'saint-petersburg-dohodnyy-dom-muruzi',
      },
      ...
      { name: 'Особняк Кельха', desc: 'Один из самых дорогих частных домов города на улице Чайковского, скрывающий во дворе готический павильон, а внутри - потрясающий Белый зал с гигантским камином.', mustSeeFilter: 'mansions',
        locationSlug: 'saint-petersburg-osobnyak-kelha',
      },
      ...
      { name: 'Дворец Белосельских-Белозерских', desc: 'Роскошный розовый дворец на углу Невского проспекта и Фонтанки, построенный Штакеншнейдером в стиле необарокко и украшенный мощными фигурами атлантов.', mustSeeFilter: 'mansions',
        locationSlug: 'saint-petersburg-dvorets-beloselskih-belozerskih',
      },
      ...
      { name: 'Литературное кафе (Вольф и Беранже)', desc: 'Историческая кондитерская на Невском проспекте, где Александр Пушкин встретился со своим секундантом Данзасом перед роковой дуэлью на Черной речке.', mustSeeFilter: 'gastro',
        locationSlug: 'saint-petersburg-literaturnoe-kafe-volf-i-beranzhe',
      },
      ...
      { name: 'Ресторан «Корюшка»', desc: 'Панорамный ресторан холдинга Ginza Project прямо у стен Петропавловской крепости, специализирующийся на приготовлении главного гастросимвола города круглый год.', mustSeeFilter: 'gastro',
        locationSlug: 'saint-petersburg-restoran-koryushka',
      },
    ...
    significantSuburbs: [
      {
        ...
        mustSeeFilter: 'main',
        places: [
          { name: 'Нижний парк Петергофа', desc: 'регулярный парадный сад Петра I на берегу Финского залива со знаменитой системой фонтанов, работающей вообще без насосов.', latitude: 59.885112, longitude: 29.908214 },
          { name: 'Большой каскад', desc: 'монументальное фонтанное сооружение с гротами и позолоченной фигурой Самсона, разрывающего пасть льва, символизирующей победу над Швецией.', latitude: 59.88935, longitude: 29.90855 },
          ...
          { name: 'Парк Александрия', desc: 'уединенная пейзажная резиденция четырех поколений Романовых, оформленная в стиле романтической английской неоготики.', latitude: 59.8808, longitude: 29.9212 },
      ...
      },
      {
        ...
        mustSeeFilter: 'main',
        places: [
          { name: 'Екатерининский дворец', desc: 'грандиозный барочный замок Франческо Растрелли, внутри которого находится знаменитая, полностью восстановленная Янтарная комната.', latitude: 59.715911, longitude: 30.395812 },
          ...
          { name: 'Царскосельский лицей', desc: 'мемориальный музей, сохранивший подлинную обстановку комнат и классов, где учился и писал первые стихи Александр Пушкин.', latitude: 59.716912, longitude: 30.397114 },
      ...
      },
      {
        ...
        mustSeeFilter: 'main',
        places: [
          { name: 'Морской Никольский собор', desc: 'колоссальный ставропигиальный храм на Якорной площади, построенный по образу Софии Константинопольской как мемориал погибшим морякам.', latitude: 59.993412, longitude: 29.777414 },
          ...
          { name: 'Музей военно-морской славы', desc: 'ультрасовременный павильон, главным экспонатом которого стала первая советская атомная подлодка К-3, размещенная прямо внутри здания.', latitude: 59.989211, longitude: 29.761512 },
      ...
      },
      {
        ...
        mustSeeFilter: 'main',
        places: [
          { name: 'Большой Гатчинский дворец', desc: 'суровый охотничий замок Антонио Ринальди из пудостского камня, скрывающий 130-метровый подземный ход к Серебряному озеру.', latitude: 59.564112, longitude: 30.108114 },
          { name: 'Приоратский дворец', desc: 'уникальный миниатюрный замок Мальтийского ордена на берегу Черного озера, полностью построенный из прессованной земли по технологии землебита.', latitude: 59.558311, longitude: 30.120812 },
      ...
      },
      {
        ...
        mustSeeFilter: 'main',
        places: [
          { name: 'Павловский парк', desc: 'один из самых больших пейзажных парков Европы (600 гектаров), славящийся своими живописными районами «Белая береза» и «Старая Сильвия».', latitude: 59.6875, longitude: 30.4485 },
          { name: 'Павловский дворец', desc: 'золотисто-белый классический дворец Чарльза Камерона, возведенный на высоком холме над извилистой рекой Славянкой.', latitude: 59.685911, longitude: 30.453912 },
      ...
      },
      {
        ...
        mustSeeFilter: 'main',
        places: [
          { name: 'Выборгский замок', desc: 'единственный в России полностью сохранившийся средневековый шведский рыцарский замок, основанный на скалистом острове в 1293 году.', latitude: 60.7158, longitude: 28.7292 },
          ...
          { name: 'Скальный парк Монрепо', desc: 'редкий по красоте скальный пейзажный парк на берегу Выборгского залива с гранитными валунами ледникового периода и Островом мертвых.', latitude: 60.7321, longitude: 28.7245 },
      ...
      },
      {
        ...
        mustSeeFilter: 'main',
        places: [
          { name: 'Крепость Орешек', desc: 'древняя новгородская фортеция XIV века на Ореховом острове в истоке Невы, выдержавшая жестокие штурмы шведов и ставшая главной тюрьмой империи.', latitude: 59.9535, longitude: 31.0385 },
      ...
      },
      {
        ...
        mustSeeFilter: 'main',
        places: [
          { name: 'Андерсенград', desc: 'уникальный детский игровой городок из камня, построенный к 175-летию Ханса Кристиана Андерсена в стиле средневековой западноевропейской архитектуры с ратушей, подземным ходом и бастионами.', latitude: 59.897811, longitude: 29.086412 },
    ...
    significantSuburbs: [
      {
        ...
        places: [
          { name: 'Дюна Эфа', desc: 'одна из самых высоких песчаных дюн в Европе, оборудованная деревянными эко-тропами и смотровыми площадками с видом на пустынные пейзажи и море', locationSlug: 'kaliningrad-dyuna-efa', latitude: 55.223412, longitude: 20.901412 },
          { name: 'Танцующий лес', desc: 'аномальный участок соснового бора, где стволы деревьев причудливо изгибаются, закручиваясь в кольца и спирали', locationSlug: 'kaliningrad-tantsuyuschiy-les', latitude: 55.181211, longitude: 20.854112 },
          { name: 'Орнитологическая станция «Фрингилла»', desc: 'полевой стационар первого в мире орнитологического института, где ученые до сих пор вручную кольцуют миллионы мигрирующих птиц', latitude: 55.1585, longitude: 20.8255 },
          { name: 'Высота Мюллера', desc: 'живописный пешеходный маршрут, проходящий по самой древней части дюны Брухберг через вековой сосновый лес', latitude: 55.1725, longitude: 20.8415 },
          { name: 'Лебединое озеро', desc: 'пресноводное озеро у посёлка Рыбачий - спокойная пауза между дюнами и заливами', latitude: 55.1535, longitude: 20.8485 },
          { name: 'Королевский бор', desc: 'вековой лесной массив на косе с эко-тропами и типичным ландшафтом национального парка', latitude: 55.2055, longitude: 20.8755 },
          { name: 'Посёлок Рыбачий', desc: 'исторический Rossitten - база орнитологов и удобная точка логистики по косе', latitude: 55.1515, longitude: 20.8235 },
        ],
      },
      {
        ...
        places: [
          { name: 'Курортный проспект', desc: 'полностью пешеходная и идеально отреставрированная улица со старинной немецкой застройкой, гирляндами, кошачьими граффити и интерактивными окнами', latitude: 54.9595, longitude: 20.4765 },
          { name: 'Музей кошек «Мурариум»', desc: 'расположен в 40-метровой довоенной водонапорной башне, на вершине которой оборудована отличная смотровая площадка', venueSlug: 'kaliningrad-muzey-koshek-murarium', latitude: 54.958914, longitude: 20.481211 },
          { name: 'Памятник зеленоградским котам', desc: 'вращающаяся скульптура кота на оконном подоконнике, ставшая главным символом и фото-точкой города', latitude: 54.9598, longitude: 20.4755 },
          { name: 'Бювет «Королева Луиза»', desc: 'исторический источник на набережной, где каждый желающий может бесплатно попробовать местную лечебную минеральную воду', latitude: 54.9615, longitude: 20.4785 },
          { name: 'Музей «Домик Ангелов»', desc: 'частная арт-коллекция уникальных фигурок, картин и скульптур ангелов, расположенная в колоритном деревянном доме', latitude: 54.9582, longitude: 20.4745 },
          { name: 'Променад и волнорез', desc: 'длинный курортный променад у моря с волнорезом - главный «морской» кадр Кранца', latitude: 54.9625, longitude: 20.4795 },
          { name: 'Кирха Святого Адальберта', desc: 'неоготический силуэт курорта, одна из узнаваемых доминант старого Кранца', latitude: 54.9575, longitude: 20.4805 },
        ],
      },
      {
        ...
        places: [
          { name: 'Водонапорная башня Раушена', desc: '25-метровое здание в стиле немецкого романтизма, обвитое плющом. Визитная карточка и самый узнаваемый силуэт города', locationSlug: 'kaliningrad-vodonapornaya-bashnya-raushena', latitude: 54.943112, longitude: 20.151214 },
          { name: 'Променад и Солнечные часы «Зодиак»', desc: 'масштабная набережная, украшенная уникальными мозаичными часами, которые занесены в Книгу рекордов Гиннесса за точность и размеры', latitude: 54.9405, longitude: 20.1485 },
          { name: 'Канатная дорога', desc: 'очаровательный ретро-фуникулер с маленькими желтыми кабинками, спускающий туристов со скалистого обрыва прямо к морю', latitude: 54.9415, longitude: 20.1495 },
          { name: 'Органный зал «Макаров»', desc: 'концертный зал с потрясающей акустикой, восстановленный на месте разрушенной старинной капеллы «Santa Maria Stella Maris»', latitude: 54.9445, longitude: 20.1525 },
          { name: 'Вилла Порт', desc: 'одна из самых роскошных и хорошо сохранившихся немецких вилл начала XX века, окруженная дендропарком', latitude: 54.9455, longitude: 20.1555 },
          { name: 'Скульптура «Нимфея»', desc: 'русалка у променада - популярная фото-точка Светлогорска', latitude: 54.9398, longitude: 20.1475 },
          { name: 'Пляж у фуникулера', desc: 'песчаный пляж у нижней станции канатной дороги - финал спуска к морю', latitude: 54.9408, longitude: 20.1488 },
        ],
      },
      {
        ...
        places: [
          { name: 'Шведская крепость Пиллау', desc: 'цитадель XVII века в форме пятиконечной звезды, которая до сих пор является действующим военным объектом, но доступна с экскурсиями', locationSlug: 'kaliningrad-shvedskaya-krepost-pillau', latitude: 54.639411, longitude: 19.891114 },
          { name: 'Маяк Пиллау', desc: 'самый западный маяк России (высота 33 метра), построенный знаменитым архитектором Карлом Шинкелем', latitude: 54.6415, longitude: 19.8825 },
          { name: 'Памятник Елизавете Петровне', desc: 'грандиозный монумент императрице на коне, установленный на самом молу у Балтийского пролива', latitude: 54.6385, longitude: 19.8855 },
          { name: 'Пехотные казармы', desc: 'монументальный комплекс зданий из красного кирпича начала XX века, где сейчас располагается штаб Балтийского флота', latitude: 54.6405, longitude: 19.8935 },
          { name: 'Немецкий аэродром Нойтиф', desc: 'заброшенные гигантские авиационные ангары на Балтийской косе, построенные прямо на песке перед Второй мировой войной', latitude: 54.6125, longitude: 19.8755 },
        ],
      },
      {
        ...
        places: [
          { name: 'Смотровая площадка Янтарного комбината', desc: 'единственное место, откуда можно вживую увидеть масштабный карьер, где экскаваторы добывают янтарь шагающим способом. К услугам туристов - «янтарная песочница», где можно самостоятельно откопать сувениры',
            locationSlug: 'kaliningrad-smotrovaya-yantarnogo-kombinata', latitude: 54.869212, longitude: 19.94151 },
          { name: 'Пляж «Шахта Анна»', desc: 'широкий песчаный пляж, регулярно получающий международный «Голубой флаг» за эталонную чистоту', latitude: 54.8725, longitude: 19.9355 },
          { name: 'Парк Беккера', desc: 'старинный парк, заложенный янтарным королем Морисом Беккером, где высажены редкие деревья со всего мира, включая уникальное тюльпанное дерево', latitude: 54.8685, longitude: 19.9455 },
          { name: 'Янтарный замок', desc: 'историческое здание крепостного замка XIV века, где сегодня находятся музей пыток, выставка оружия и янтарная лавка', latitude: 54.8675, longitude: 19.9435 },
          { name: 'Музей янтаря / выставка комбината', desc: 'экспозиция о добыче и обработке янтаря рядом с карьером - контекст к смотровой', latitude: 54.8688, longitude: 19.9425 },
        ],
      },
    ],
    dayRoutePresets: [
      {
        ...
        stops: [
          ...
          { name: 'Район Амалиенау', desc: 'Прогулка среди вилл', locationSlug: 'kaliningrad-rayon-vill-amalienau' },
          { name: 'Гастробар «Соль»', desc: 'Вечерняя гастро-пауза', locationSlug: 'kaliningrad-gastrobar-sol' },
        ],
      },
      {
        ...
        timingNote: 'Выезд к 8:00 - коса длинная, Зеленоградск лучше оставить на вторую половину дня.',
        stops: [
      ...
      },
      {
        ...
        timingNote: 'Старт к 9:00 - западный берег тянется, Янтарный удобнее до обеда.',
        stops: [
    ...
    significantSuburbs: [
      {
        ...
        latitude: 56.6448,
        longitude: 43.4723,
        travelVector: 'Северный и Волжский вектор',
        travelVectorBlurb: 'Автобусы и маршрутки от автовокзала Щербинки / ж/д до Городца; удобный насыщенный day-trip без ночёвки.',
        stationHub: 'Автовокзал Щербинки',
        stationName: 'Городец / автостанция',
        logisticsExit: 'Автостанция Городец',
        places: [
          { name: 'Музей самоваров', desc: 'одна из лучших коллекций самоваров в России - визитная карточка Городца', latitude: 56.6455, longitude: 43.4735 },
          { name: 'Музей городецкого пряника', desc: 'пряничная традиция и мастер-классы - сладкий якорь дня', latitude: 56.6442, longitude: 43.4715 },
          { name: 'Музей городецкой росписи', desc: 'классическая роспись по дереву - промысел, с которым ассоциируют город', latitude: 56.6438, longitude: 43.4708 },
          { name: 'Набережная Волги', desc: 'променад с видами на Волгу и купеческую застройку', latitude: 56.6465, longitude: 43.4755 },
          { name: 'Феодоровский монастырь', desc: 'действующая обитель на высоком берегу - тихая духовная пауза', latitude: 56.6505, longitude: 43.4685 },
          { name: 'Детский музейный центр «Город мастеров»', desc: 'интерактив и ремёсла для семьи - удобно совмещать с пряником и росписью', latitude: 56.6445, longitude: 43.4728 },
          { name: 'Торговая площадь / центр', desc: 'историческое ядро с купеческими домами и сувенирными лавками', latitude: 56.644, longitude: 43.472 },
        ],
      },
      {
        name: 'Семёнов',
        ...
        latitude: 56.7889,
        longitude: 44.4917,
        travelVector: 'Северо-Восточный вектор',
        travelVectorBlurb: 'Электрички и автобусы до Семёнова (~1,5-2 часа); день короче Городца, зато сфокусирован на промысле.',
        stationHub: 'Московский вокзал НН / автовокзал',
        stationName: 'Станция Семёнов',
        logisticsExit: 'Станция Семёнов',
        places: [
          { name: 'Музейно-туристический центр «Золотая хохлома»', desc: 'главная экспозиция о промысле и росписи', latitude: 56.7895, longitude: 44.4925 },
          { name: 'Фабрика «Хохломская роспись»', desc: 'действующее производство с экскурсиями и магазином', latitude: 56.7875, longitude: 44.4955 },
          { name: 'Центр Семёнова', desc: 'компактная прогулка по городским улицам после музея', latitude: 56.7885, longitude: 44.491 },
          { name: 'Парк Победы', desc: 'зелёная пауза в центре города', latitude: 56.7905, longitude: 44.4895 },
          { name: 'Хохломские ряды / сувениры', desc: 'лакированные изделия и посуда - сувенирный финал дня', latitude: 56.789, longitude: 44.493 },
        ],
      },
      {
        name: 'Дивеево',
        ...
        longitude: 43.2415,
        travelVector: 'Южный вектор',
        travelVectorBlurb: 'Автобусы через Арзамас (~3-3,5 часа); полный день на монастырь и источники, лучше с ранним выездом.',
        stationHub: 'Автовокзал НН / Арзамас',
        stationName: 'Дивеево / автостанция',
        logisticsExit: 'Автостанция Дивеево',
        places: [
          { name: 'Свято-Троицкий Серафимо-Дивеевский монастырь', desc: 'главный ансамбль обители - ядро паломнического дня', latitude: 55.0485, longitude: 43.2415 },
          { name: 'Троицкий собор', desc: 'главный храм монастыря с мощами преподобного Серафима Саровского', latitude: 55.0488, longitude: 43.2418 },
          { name: 'Канавка Богородицы', desc: 'святая канавка вокруг монастыря - обязательный обход паломников', latitude: 55.0475, longitude: 43.2405 },
          { name: 'Преображенский собор', desc: 'второй крупный собор ансамбля', latitude: 55.0492, longitude: 43.2425 },
          { name: 'Источник преподобного Серафима', desc: 'святые источники у Дивеева - купель и набор воды', latitude: 55.0525, longitude: 43.2355 },
          { name: 'Музей истории Дивеевской обители', desc: 'контекст монастыря и жизни Серафима Саровского', latitude: 55.0482, longitude: 43.2435 },
          { name: 'Благовещенский собор', desc: 'новый крупный храм ансамбля - современный акцент обители', latitude: 55.0495, longitude: 43.2408 },
        ],
      },
      {
        ...
        latitude: 56.0835,
        longitude: 45.0615,
        travelVector: 'Восточный и Волжский вектор',
        travelVectorBlurb: 'Автобус / авто до Лыскова и далее к монастырю; летом удобно совмещать с видами на Волгу.',
        stationHub: 'Автовокзал НН / Лысково',
        stationName: 'Макарьево',
        logisticsExit: 'Макарьево / монастырь',
        places: [
          { name: 'Желтоводский Макариев монастырь', desc: 'укреплённый монастырский ансамбль на берегу Волги', latitude: 56.0835, longitude: 45.0615 },
          { name: 'Троицкий собор', desc: 'главный храм обители внутри стен', latitude: 56.0838, longitude: 45.0618 },
          { name: 'Крепостные стены', desc: 'оборонительный контур монастыря - прогулка по двору', latitude: 56.0832, longitude: 45.0612 },
          { name: 'Волжская смотровая', desc: 'вид на Волгу с монастырского берега', latitude: 56.0842, longitude: 45.0605 },
          { name: 'Посёлок Макарьево', desc: 'тихий посад у стен - короткая прогулка после обители', latitude: 56.0825, longitude: 45.0635 },
        ],
      },
    ],
    dayRoutePresets: [
      ...
      },
      {
        ...
        description: 'Самовары, пряник, роспись и волжская набережная - классический day-trip из Нижнего.',
        timingNote: 'Выезд к 8:30-9:00 - дорога ~1,5 часа; музеи лучше брать до обеда.',
        stops: [
          { name: 'Музей самоваров', desc: 'Старт в Городце' },
          { name: 'Музей городецкого пряника', desc: 'Пряничная традиция' },
          { name: 'Музей городецкой росписи', desc: 'Промысел' },
          { name: 'Набережная Волги', desc: 'Променад' },
          { name: 'Феодоровский монастырь', desc: 'Тихая пауза' },
          { name: 'Торговая площадь / центр', desc: 'Сувениры и финал' },
        ],
      },
      {
        id: 'nn-diveevo-day',
        title: 'Дивеево за день',
        description: 'Серафимо-Дивеевский монастырь, канавка и источники - длинный паломнический день.',
        timingNote: 'Выезд не позже 7:00 - в пути 3+ часа; полный круг обители лучше с запасом до заката.',
        stops: [
          { name: 'Свято-Троицкий Серафимо-Дивеевский монастырь', desc: 'Вход в обитель' },
          { name: 'Троицкий собор', desc: 'Мощи Серафима' },
          { name: 'Канавка Богородицы', desc: 'Обход канавки' },
          { name: 'Источник преподобного Серафима', desc: 'Купель / набор воды' },
    ...
    significantSuburbs: [
      {
        ...
        places: [
          ...
          { name: 'Охотничий дом', desc: 'деревянный охотничий дом в музейной экспозиции - быт промыслов Прикамья', latitude: 58.2605, longitude: 56.2635 },
      ...
      },
      {
        ...
        places: [
          ...
          { name: 'Набережная Сылвы', desc: 'прогулка вдоль реки после пещеры - спокойный финал городского круга', latitude: 57.4295, longitude: 56.9485 },
        ],
      },
      {
        name: 'Белая гора',
      ...
      },
      {
        ...
        places: [
          ...
          { name: 'Полюдов камень', desc: 'скальный останец над долиной - видовая точка рядом с маршрутами Губахи', latitude: 58.8505, longitude: 57.6205 },
          { name: 'Смотровая Усьвинских столбов', desc: 'площадка с видом на отвесные скалы над Усьвой - ключевой кадр дня', latitude: 58.7168, longitude: 57.6145 },
        ],
      },
    ],
    dayRoutePresets: [
      ...
      },
      {
        ...
        description: 'Музей деревянного зодчества на берегу Камы: храмы, солеварня и виды на залив.',
        timingNote: 'Выезд к 9:00 - автобус ~1 час; закладывайте 3-4 часа на территорию музея.',
        stops: [
          { name: 'Хохловка', desc: 'Въезд в музей-заповедник', venueSlug: 'muzej-hohlovka' },
          { name: 'Богородицкая церковь', desc: 'Деревянный храм' },
          { name: 'Усть-Боровский сользавод', desc: 'Солеваренный комплекс' },
          { name: 'Сторожевая башня', desc: 'Вид на залив' },
          { name: 'Смотровая над заливом', desc: 'Панорама Камы' },
        ],
      },
      {
        id: 'perm-kungur-day',
        title: 'Кунгур и ледяная пещера',
        description: 'Карстовая пещера, старый купеческий центр и набережная Сылвы.',
        timingNote: 'Утренний поезд/авто к 8:30 - пещеру лучше брать на первую сессию дня.',
        stops: [
          { name: 'Кунгурская ледяная пещера', desc: 'Ледяные гроты', locationSlug: 'perm-kungurskaya-ledyanaya-peshchera' },
          ...
          { name: 'Вязовская пряничная', desc: 'Сладкий сувенир' },
        ],
      },
    ],
    travel:
