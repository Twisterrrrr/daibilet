    ...
    significantSuburbs: [
      {
        ...
        places: [
          { name: 'Высота Мюллера', desc: '32 км от Зеленоградска, утро - пешеходный маршрут по древней части дюны Брухберг через вековой сосновый лес', latitude: 55.1725, longitude: 20.8415 },
          { name: 'Танцующий лес', desc: '37 км, до полудня - аномальный сосновый бор, где стволы изгибаются кольцами и спиралями', locationSlug: 'kaliningrad-tantsuyuschiy-les', latitude: 55.181211, longitude: 20.854112 },
          { name: 'Дюна Эфа', desc: '42 км, дальняя точка - высокие песчаные дюны с эко-тропами; обед удобно в Морском или Рыбачьем', locationSlug: 'kaliningrad-dyuna-efa', latitude: 55.223412, longitude: 20.901412 },
          { name: 'Королевский бор', desc: 'вековой лесной массив у дальней части косы - пауза между Эфой и разворотом', latitude: 55.2055, longitude: 20.8755 },
          { name: 'Посёлок Рыбачий', desc: 'исторический Rossitten - обед и логистика перед возвратом', latitude: 55.1515, longitude: 20.8235 },
          ...
          { name: 'Орнитологическая станция «Фрингилла»', desc: '23 км на обратном пути - сеанс кольцевания птиц к 15:00-16:00', latitude: 55.1585, longitude: 20.8255 },
        ],
      },
      {
      ...
      },
      {
        ...
        places: [
          ...
          { name: 'Променад и Солнечные часы «Зодиак»', desc: 'спуск к морю - набережная с мозаичными часами из Книги рекордов Гиннесса', latitude: 54.9405, longitude: 20.1485 },
          ...
          { name: 'Канатная дорога', desc: 'финал наверх к вокзалу - ретро-фуникулер с желтыми кабинками от моря к скале', latitude: 54.9415, longitude: 20.1495 },
        ],
      },
      {
        ...
        places: [
          { name: 'Шведская крепость Пиллау', desc: 'экскурсия ~11:00-11:30 - цитадель XVII века в форме звезды, действующий военный объект', locationSlug: 'kaliningrad-shvedskaya-krepost-pillau', latitude: 54.639411, longitude: 19.891114 },
          ...
          { name: 'Немецкий аэродром Нойтиф', desc: 'паром/катер на Балтийскую косу - заброшенные авиационные ангары на песке', latitude: 54.6125, longitude: 19.8755 },
          { name: 'Памятник Елизавете Петровне', desc: 'финал после возврата - монумент на Северном молу у Балтийского пролива', latitude: 54.6385, longitude: 19.8855 },
        ],
      },
      {
    ...
    significantSuburbs: [
      {
        ...
        latitude: 58.26186,
        longitude: 56.26314,
        travelVector: 'Музейный круг против часовой',
        travelVectorBlurb:
          'Идите против часовой от сектора Южное Прикамье к заливу; Усть-Боровский сользавод и смотровая над заливом - финал маршрута.',
        timingNote:
          'Выезд к 9:00 - автобус ~1 час. На территории идите против часовой; сользавод и смотровая - финал.',
        places: [
      ...
      {
        name: 'Кунгур',
        desc: 'Город купечества и ледяной пещеры в 90 км от Перми - центр пешком, пещера и пряники авто.',
        address: 'г. Кунгур, Пермский край',
        locationSlug: 'perm-kungur',
        latitude: 57.4333,
        longitude: 56.95,
        travelVector: 'Центр пешком + пещера авто',
        travelVectorBlurb:
          'Сначала пешком старый центр Кунгура, потом авто к ледяной пещере; Вязовская пряничная - на обратном пути в Пермь.',
        timingNote: 'Сначала центр пешком, потом пещера авто; пряники на выезде в Пермь.',
        places: [
          ...
          { name: 'Кунгурская ледяная пещера', desc: 'одна из самых известных карстовых пещер Урала с ледяными гротами - авто-блок дня.', locationSlug: 'perm-kungurskaya-ledyanaya-peshchera', latitude: 57.4409, longitude: 57.006 },
          { name: 'Вязовская пряничная', desc: 'местная пряничная традиция - сладкий сувенир на выезде обратно в Пермь.', latitude: 57.4322, longitude: 56.9442 },
        ],
      },
      {
        ...
        travelVectorBlurb:
          'Трасса Р-242 / Суксун: монастырь - Царский крест - купель/источник у горы - Плакун. Не совмещать с камнем Ермак за один день - Сылва без моста даёт крюк 80-100+ км.',
        timingNote:
        ...
        places: [
          ...
          { name: 'Купель / источник', desc: 'святой источник и купель у подножия монастырской горы - в связке с обителью.', latitude: 57.3906, longitude: 56.2278 },
          { name: 'Водопад Плакун', desc: 'живописный известняковый водопад в Суксунском районе - финал православного дня.', latitude: 57.3481, longitude: 57.0506 },
        ],
      },
      {
        name: 'Кунгурский экстрим',
        desc: 'Камень Ермак на Сылве - отдельный день или стык с кунгурским маршрутом, без Белой горы и Плакуна.',
        address: 'р. Сылва, Кунгурский район',
        latitude: 57.3736,
        longitude: 57.0667,
        travelVector: 'Стык с Кунгуром',
        travelVectorBlurb:
          'Камень Ермак - отдельно от Белой горы: удобно стыковать с днём в Кунгуре. Не смешивать с монастырём и Плакуном за один выезд.',
        timingNote: 'Не смешивать с Белой горой и Плакуном. Опционально - стык с кунгурским днём.',
        places: [
          { name: 'Камень Ермак', desc: 'скальный останец на Сылве, связанный с маршрутами Ермака - якорь «кунгурского экстрима».', latitude: 57.3736, longitude: 57.0667 },
        ],
      },
      {
        name: 'Усьва (день 1)',
        desc: 'Усьвинские столбы и смотровая; декорации «Сердце Пармы» (Загубашка) - после трека. Первый из двух дней в горнозаводском крае.',
        address: 'Усьва, Пермский край',
        locationSlug: 'perm-usvinskie-stolby',
        latitude: 58.7175,
        longitude: 57.6152,
        travelVector: 'День 1 из 2 - Усьва',
        travelVectorBlurb:
          'День 1 из 2: столбы + смотровая, затем Загубашка («Сердце Пармы»). Каменный город и Крестовую оставьте на день 2 - не валиться с ног.',
        timingNote: 'День 1 из 2. После столбов - Загубашка; Каменный город не пихать в этот же день.',
        places: [
          ...
          { name: 'Сердце Пармы (Загубашка)', desc: 'декорации и виды фильма/книги о Парме - после трека к столбам, без спешки.', latitude: 58.705, longitude: 57.602 },
        ],
      },
      {
        name: 'Губаха (день 2)',
        desc: 'Каменный город, пещера Российская и Гора Крестовая на закат - второй день после Усьвы.',
        address: 'Губаха, Пермский край',
        locationSlug: 'perm-kamennyy-gorod',
        latitude: 58.72359,
        longitude: 57.63404,
        travelVector: 'День 2 из 2 - Губаха',
        travelVectorBlurb:
          'День 2 из 2: Каменный город - пещера Российская (осторожно / вход) - Гора Крестовая на закат. Полюдов камень (~250 км) в этот день не брать.',
        timingNote: 'День 2 из 2. Пещера - осторожно на входе; Крестовая на закат. Полюд (~250 км) не брать.',
        places: [
          ...
          { name: 'Пещера Российская', desc: 'карстовая пещера у Каменного города - осторожно на входе, без лишней авантюры.', latitude: 58.7245, longitude: 57.636 },
          { name: 'Гора Крестовая', desc: 'горнолыжный и видовой склон над Губахой - лучше на закат.', latitude: 58.82861, longitude: 57.585 },
        ],
      },
    ],
    dayRoutePresets: [
      ...
      },
      {
        ...
        description: 'Круг против часовой: усадьба, мельница, храмы, башня, заимка; сользавод и панорама - финал.',
        timingNote:
          'Выезд к 9:00 - автобус ~1 час. На территории идите против часовой от Южного Прикамья к заливу; сользавод и смотровая - финал.',
        travelVector: 'Музейный круг против часовой',
        travelVectorBlurb:
          'Идите против часовой от сектора Южное Прикамье к заливу; Усть-Боровский сользавод и смотровая - финал.',
        stops: [
      ...
      {
        id: 'perm-kungur-day',
        title: 'Кунгур: центр и пещера',
        description: 'Пешком старый центр, затем авто к ледяной пещере; пряники на выезде в Пермь.',
        timingNote: 'Сначала центр пешком, потом пещера авто; Вязовская пряничная - на обратном пути в Пермь.',
        travelVector: 'Центр пешком + пещера авто',
        travelVectorBlurb:
          'Сначала пешком старый центр, потом авто к пещере; пряники на выезде обратно в Пермь.',
        stops: [
          ...
          { name: 'Вязовская пряничная', desc: 'Сувенир на выезде в Пермь' },
        ],
      },
      {
        ...
        timingNote:
          'Выезд по Р-242 / Суксун. Купель держите в связке с монастырём; Ермак и Плакун с Белой горой в один день - невозможно (крюк 80-100+ км).',
        travelVector: 'Р-242 / Суксун',
        travelVectorBlurb:
          'Монастырь - Царский крест - купель - Плакун. Камень Ермак - в отдельный день / стык с Кунгуром.',
        stops: [
      ...
      {
        id: 'perm-kungur-extrem-day',
        title: 'Кунгурский экстрим',
        description: 'Камень Ермак - отдельно от Белой горы; удобно стыковать с кунгурским днём.',
        timingNote: 'Не смешивать с Белой горой и Плакуном. Опционально - стык после/вместо части кунгурского дня.',
        travelVector: 'Стык с Кунгуром',
        stops: [
          { name: 'Камень Ермак', desc: 'Скала на Сылве' },
        ],
      },
      {
        id: 'perm-usva-day1',
        title: 'Усьва - день 1',
        description: 'Усьвинские столбы, смотровая и Загубашка после трека.',
        timingNote: 'День 1 из 2. После столбов - Загубашка; Каменный город не пихать в этот же день.',
        travelVector: 'День 1 из 2 - Усьва',
        stops: [
          { name: 'Усьвинские столбы', desc: 'Скалы над Усьвой', locationSlug: 'perm-usvinskie-stolby' },
          { name: 'Смотровая Усьвинских столбов', desc: 'Ключевой кадр' },
          { name: 'Сердце Пармы (Загубашка)', desc: 'После трека' },
        ],
      },
      {
        id: 'perm-gubakha-day2',
        title: 'Губаха - день 2',
        description: 'Каменный город, пещера Российская и Крестовая на закат.',
        timingNote: 'День 2 из 2. Пещера - осторожно на входе; Крестовая на закат. Полюд (~250 км) не брать.',
        travelVector: 'День 2 из 2 - Губаха',
        stops: [
          { name: 'Каменный город', desc: 'Скальный город', locationSlug: 'perm-kamennyy-gorod' },
          { name: 'Пещера Российская', desc: 'Осторожно / вход' },
          { name: 'Гора Крестовая', desc: 'Закат' },
        ],
      },
    ],
    travel:
