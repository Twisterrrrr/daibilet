  ...
  'saint-petersburg': {
    ...
    significantSuburbs: [
      ...
      },
      {
        ...
        mustSeeFilter: 'main',
        places: [
          { name: 'Сестрорецкий Рубеж', desc: 'выставочный комплекс на месте оборонительного Карельского укрепрайона с подлинным железобетонным ДОТом «Миллионер» внутри.', latitude: 60.0925, longitude: 29.9595 },
          { name: 'Экотропа «Комаровский берег»', desc: 'пешеходный деревянный маршрут сквозь вековой таежный лес, дюны и муравейники-гиганты прямо к песчаному пляжу залива.', latitude: 60.1865, longitude: 29.7965 },
          { name: 'Музей-усадьба И. Е. Репина «Пенаты»', desc: 'деревянный дом художника в Репино с уникальной стеклянной крышей-куполом, где он провел последние тридцать лет жизни.', latitude: 60.1565, longitude: 29.8625 },
          { name: 'Комаровский некрополь', desc: 'тихое лесное мемориальное кладбище, ставшее местом упокоения Анны Ахматовой, Дмитрия Лихачева и других деятелей науки и культуры.', latitude: 60.1845, longitude: 29.8085 },
