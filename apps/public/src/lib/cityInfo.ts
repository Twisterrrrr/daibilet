    ...
    significantSuburbs: [
      {
        ...
        places: [
          { name: 'Дюна Эфа', desc: 'Одна из самых высоких песчаных дюн в Европе, оборудованная деревянными эко-тропами и смотровыми площадками с видом на пустынные пейзажи и море' },
          { name: 'Танцующий лес', desc: 'Аномальный участок соснового бора, где стволы деревьев причудливо изгибаются, закручиваясь в кольца и спирали' },
      ...
      },
      {
        ...
        places: [
          ...
          { name: 'Музей кошек «Мурариум»', desc: 'Расположен в 40-метровой довоенной водонапорной башне, на вершине которой оборудована отличная смотровая площадка' },
      ...
      },
      {
        ...
        places: [
          { name: 'Водонапорная башня Раушена', desc: '25-метровое здание в стиле немецкого романтизма, обвитое плющом. Визитная карточка и самый узнаваемый силуэт города' },
      ...
      },
      {
        ...
        places: [
          { name: 'Шведская крепость Пиллау', desc: 'Цитадель XVII века в форме пятиконечной звезды, которая до сих пор является действующим военным объектом, но доступна с экскурсиями' },
