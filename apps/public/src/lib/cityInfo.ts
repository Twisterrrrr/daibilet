...
export const CITY_INFO: Record<string, CityInfoEntry> = {
  'saint-petersburg': {
    ...
    mustSee: [
      ...
      { name: 'Юсуповский дворец', desc: 'Интерьеры и легенда Распутина.', mustSeeFilter: 'museum' },
      ...
      { name: 'Университетская набережная', desc: 'Сфинксы и вид на стрелку с ВО.', mustSeeFilter: 'views' },
      ...
      { name: 'Троицкий мост', desc: 'Ракурс на крепость и ростральные колонны.', mustSeeFilter: 'views' },
      { name: 'Улица Зодчего Росси', desc: 'Идеальная перспектива к Александринке.', mustSeeFilter: 'street' },
      ...
      { name: 'Улица Рубинштейна', desc: 'Вечерняя жизнь и старый доходный фонд.', mustSeeFilter: 'street' },
      ...
      { name: 'Санкт-Петербургская соборная мечеть', desc: 'Северный модерн с бирюзовым куполом у Кронверкского проспекта.', mustSeeFilter: 'temple' },
