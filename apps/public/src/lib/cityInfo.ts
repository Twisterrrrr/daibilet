...
export const CITY_INFO: Record<string, CityInfoEntry> = {
  'saint-petersburg': {
    ...
    mustSee: [
      ...
      { name: 'Литературное кафе (Вольф и Беранже)', desc: 'Культовая кондитерская, откуда Александр Пушкин отправлялся на роковую дуэль с Дантесом. Невский', mustSeeFilter: 'gastro' },
      { name: 'Пышечная на Большой Конюшенной', desc: 'Легендарное кафе 1958 года из «Красной книги» города, где пышки жарят по советскому ГОСТу. Центр', mustSeeFilter: 'gastro' },
      { name: 'Ресторан «Метрополь»', desc: 'Старейший действующий ресторан города, где проходили парадные обеды в честь визитов мировых лидеров и звезд. Садовая', mustSeeFilter: 'gastro' },
      { name: 'Кафе «Бродячая собака»', desc: 'Историческое подвальное арт-кафе, главный штаб поэтов Серебряного века - Ахматовой, Мандельштама, Гумилева. Площадь Искусств', mustSeeFilter: 'gastro' },
      { name: 'Гранд Отель Европа (Лобби-бар)', desc: 'Роскошные интерьеры модерна, где ужинали Чайковский, Бернард Шоу и Элтон Джон. Михайловская', mustSeeFilter: 'gastro' },
      { name: 'Василеостровский рынок', desc: 'Первый масштабный гастромаркет города в историческом здании Андреевского рынка с кухнями со всего мира. ВО', mustSeeFilter: 'gastro' },
      { name: 'Фудмолл «Vokzal 1853»', desc: 'Огромное гастрономическое пространство в интерьерах Варшавского вокзала с эстетикой XIX века. Балтийская', mustSeeFilter: 'gastro' },
      { name: 'Двор Гостинки', desc: 'Скрытый внутренний двор Большого Гостиного двора с фудтраками, шезлонгами и концертной сценой. Невский', mustSeeFilter: 'gastro' },
      { name: 'Московский рынок', desc: 'Модернизированный гастрономический хаб у метро «Электросила» под монументальным сталинским куполом. Московский проспект', mustSeeFilter: 'gastro' },
      { name: 'Ресторан «Палкинъ»', desc: 'Историческая русская кухня высокого уровня с дворянскими традициями фламбе и подачи блюд. Невский', mustSeeFilter: 'gastro' },
      { name: 'Birch', desc: 'Хит петербургской гастрономии: авторская кухня в формате гастрономического театра с открытым шеф-тейблом. Кирочная', mustSeeFilter: 'gastro' },
      { name: 'Harvest', desc: 'Концептуальный ресторан Дмитрия Блинова, сфокусированный на высокой кухне из овощей и локальных продуктов. ВО', mustSeeFilter: 'gastro' },
      { name: 'Коктейльный бар «El Copitas»', desc: 'Скрытый во дворе мексиканский спикизи-бар, многократно входивший в мировой топ-50 лучших баров. Достоевская', mustSeeFilter: 'gastro' },
      { name: 'Ресторан «Блок»', desc: 'Главный мясной ресторан города от Александра Раппопорта на крыше «Ленинград Центра» с видом на Таврический сад. Потемкинская', mustSeeFilter: 'gastro' },
      { name: 'Кафе «Рубинштейн»', desc: 'Интеллектуальное заведение у Малого драматического театра, место встреч театральной и литературной элиты. Фонтанка', mustSeeFilter: 'gastro' },
      { name: 'Ресторан «Строганов Стейк Хаус»', desc: 'Большой мясной ресторан в аутентичном здании казарм Конногвардейского полка. Конногвардейский бульвар', mustSeeFilter: 'gastro' },
      { name: 'Хачапури и Вино', desc: 'Городская гастрономическая аттракция, сделавшая грузинскую кухню и домашнее вино молодежным трендом. Центр', mustSeeFilter: 'gastro' },
      { name: 'Бар «Хроники»', desc: 'Культовая рюмочная на Некрасова, переосмыслившая формат ленинградских интеллигентных питейных заведений. Центр', mustSeeFilter: 'gastro' },
      { name: 'Ресторан «Корюшка»', desc: 'Заведение у стен Петропавловской крепости с видом на Неву и Дворцовую набережную. Заячий остров', mustSeeFilter: 'gastro' },
      { name: 'Кафе-кондитерская «Север-Метрополь»', desc: 'Главный кондитерский бренд города на Невском, знаменитый тортами и пирожными со времен СССР. Невский', mustSeeFilter: 'gastro' },
      ...
      { name: 'Толстовский дом', desc: 'Доходный дом с проходными дворами и северным модерном. Фонтанка', mustSeeFilter: 'secret' },
    ],
    significantSuburbs: [
      {
        name: 'Петергоф',
        desc: 'Дворцово-парковый ансамбль с фонтанами - главный day-trip из центра.',
        mustSeeFilter: 'main', locationSlug: 'saint-petersburg-petergof',
        places: [
          { name: 'Большой каскад', desc: 'Большой каскад - точка для загородного маршрута.' },
          { name: 'Нижний парк', desc: 'Нижний парк - точка для загородного маршрута.' },
          { name: 'Фонтан «Самсон»', desc: 'Фонтан «Самсон» - точка для загородного маршрута.' },
          { name: 'Большой Петергофский дворец', desc: 'Большой Петергофский дворец - точка для загородного маршрута.' },
          { name: 'Дворец Монплезир', desc: 'Дворец Монплезир - точка для загородного маршрута.' },
          { name: 'Дворец Марли', desc: 'Дворец Марли - точка для загородного маршрута.' },
          { name: 'Парк Александрия', desc: 'Парк Александрия - точка для загородного маршрута.' },
        ],
      },
      {
        name: 'Царское Село',
        ...
        mustSeeFilter: 'main',
        places: [
          { name: 'Екатерининский дворец', desc: 'Екатерининский дворец - точка для загородного маршрута.' },
          { name: 'Янтарная комната', desc: 'Янтарная комната - точка для загородного маршрута.' },
          { name: 'Екатерининский парк', desc: 'Екатерининский парк - точка для загородного маршрута.' },
          { name: 'Камеронова галерея', desc: 'Камеронова галерея - точка для загородного маршрута.' },
          { name: 'Александровский дворец', desc: 'Александровский дворец - точка для загородного маршрута.' },
          { name: 'Александровский парк', desc: 'Александровский парк - точка для загородного маршрута.' },
          { name: 'Белая башня', desc: 'Белая башня - точка для загородного маршрута.' },
        ],
      },
      {
        name: 'Кронштадт',
        ...
        mustSeeFilter: 'main',
        places: [
          { name: 'Морской Никольский собор', desc: 'Морской Никольский собор - точка для загородного маршрута.' },
          { name: 'Форт Константин', desc: 'Форт Константин - точка для загородного маршрута.' },
          { name: 'Кронштадтские форты', desc: 'Кронштадтские форты - точка для загородного маршрута.' },
          { name: 'Петровский парк', desc: 'Петровский парк - точка для загородного маршрута.' },
          { name: 'Итальянский пруд', desc: 'Итальянский пруд - точка для загородного маршрута.' },
          { name: 'Кронштадтский доковый бассейн', desc: 'Кронштадтский доковый бассейн - точка для загородного маршрута.' },
        ],
      },
      {
        name: 'Гатчина',
        desc: 'Дворцово-парковый ансамбль на озерах, куда удобно уехать на целый день.',
        mustSeeFilter: 'main',
        places: [
          { name: 'Гатчинский дворец', desc: 'Гатчинский дворец - точка для загородного маршрута.' },
          { name: 'Гатчинский парк', desc: 'Гатчинский парк - точка для загородного маршрута.' },
          { name: 'Приоратский дворец', desc: 'Приоратский дворец - точка для загородного маршрута.' },
        ],
      },
      {
        name: 'Павловск',
        desc: 'Пейзажный парк и дворец Павла I для спокойной загородной прогулки.',
        mustSeeFilter: 'main',
        places: [
          { name: 'Павловский дворец', desc: 'Павловский дворец - точка для загородного маршрута.' },
          { name: 'Павловский парк', desc: 'Павловский парк - точка для загородного маршрута.' },
        ],
      },
    ],
    dayRoutePresets: [
