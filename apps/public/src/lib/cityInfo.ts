...
export const CITY_INFO: Record<string, CityInfoEntry> = {
  'saint-petersburg': {
    ...
    mustSee: [
      ...
      { name: 'Дворцовая набережная', desc: 'Фасад Зимнего и зеркало Невы.', mustSeeFilter: 'views',
      ...
      { name: 'Английская набережная', desc: 'Парадные особняки к западу от Сенатской.', mustSeeFilter: 'views',
      ...
      { name: 'Набережная Фонтанки', desc: 'Длинный «городской» променад.', mustSeeFilter: 'views',
      ...
      { name: 'Коломна', desc: 'Тихие каналы и lit-маршрут «Пиковой дамы».', mustSeeFilter: 'street',
        locationSlug: 'saint-petersburg-kolomna',
      },
      { name: 'Линии Васильевского острова', desc: 'Сетка дворов и быт «острова».', mustSeeFilter: 'street',
