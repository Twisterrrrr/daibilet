...
export const CITY_INFO: Record<string, CityInfoEntry> = {
  'saint-petersburg': {
    ...
    mustSee: [
      ...
      { name: 'Государственный Эрмитаж', desc: 'Один из величайших художественных музеев планеты, чья колоссальная коллекция из трех миллионов экспонатов охраняется официальной штатной службой эрмитажных котов со времен императрицы Елизаветы Петровны.', mustSeeFilter: 'main', venueSlug: 'ermitazh' },
      { name: 'Петропавловская крепость', desc: 'Историческое военное ядро города на Заячьем острове, которое ни разу не участвовало в реальных боях, став главной политической тюрьмой империи и местом традиционного ежедневного полуденного выстрела.', mustSeeFilter: 'main', locationSlug: 'saint-petersburg-petropavlovskaya-krepost' },
      ...
      { name: 'Казанский собор', desc: 'Величественный ампирный собор с грандиозной полукруглой колоннадой, ставший главным мемориалом отечественной войны 1812 года, где хранятся трофейные французские ключи и покоится прах фельдмаршала Михаила Кутузова.', mustSeeFilter: 'main', locationSlug: 'saint-petersburg-kazanskiy-sobor' },
      { name: 'Невский проспект', desc: 'Главная четырехкилометровая артерия города, получившая свой знаменитый излом из-за навигационной ошибки строителей, шедших навстречу друг другу с двух сторон сквозь глухие болота.', mustSeeFilter: 'main' , seasonLabel: 'Зимний эксклюзив: иллюминация - ноябрь-апрель', locationSlug: 'saint-petersburg-nevskiy-prospekt' },
      { name: 'Адмиралтейство', desc: 'Историческая корабельная верфь в стиле ампир, чей знаменитый золоченый шпиль с 65-килограммовым корабликом-флюгером служит точкой отсчета для трех главных лучей-улиц городского центра.', mustSeeFilter: 'main', locationSlug: 'saint-petersburg-admiralteystvo' },
      { name: 'Медный всадник (Сенатская площадь)', desc: 'Легендарный памятник Петру Великому, отлитый из бронзы и установленный на гигантском монолитном Гром-камне, который тащили к побережью Невы на специальных металлических шарах более девяти месяцев.', mustSeeFilter: 'main', locationSlug: 'saint-petersburg-mednyy-vsadnik' },
      { name: 'Стрелка Васильевского острова', desc: 'Один из самых узнаваемых водных фасадов мира, где величественные Ростральные колонны в XIX веке выполняли роль портовых маяков, освещая путь заходящим в Неву торговым судам огнем из чаш с конопляным маслом.', mustSeeFilter: 'main', locationSlug: 'saint-petersburg-strelka-vasilevskogo-ostrova' },
      ...
      { name: 'Зоологический музей РАН', desc: 'Кит в зале и классическая натуралистика.', mustSeeFilter: 'museum', venueSlug: 'saint-petersburg-zoologicheskiy-muzey-ran' },
      { name: 'Музей политической истории (особняк Кшесинской)', desc: 'XX век в модерне у Петропавловки.', mustSeeFilter: 'museum' , themeTags: ['Северный модерн'], venueSlug: 'saint-petersburg-muzey-politicheskoy-istorii-osobnyak-kshesinskoy' },
      ...
      { name: 'Литературно-мемориальный музей Достоевского', desc: 'Угловая квартира на Кузнечном переулке, в которой писатель провел свои последние годы и создал финальный литературный шедевр - роман «Братья Карамазовы».', mustSeeFilter: 'museum', venueSlug: 'saint-petersburg-literaturno-memorialnyy-muzey-dostoevskogo' },
      { name: 'Мраморный дворец', desc: 'Филиал Русского музея, редкий облицованный фасад.', mustSeeFilter: 'museum', locationSlug: 'saint-petersburg-mramornyy-dvorets' },
      { name: 'Артиллерийский музей', desc: 'Пушки во дворе у кронверка.', mustSeeFilter: 'museum', venueSlug: 'saint-petersburg-artilleriyskiy-muzey' },
      { name: 'Дворцовая набережная', desc: 'Фасад Зимнего дворца и истинное зеркало Невы.', mustSeeFilter: 'views', locationSlug: 'saint-petersburg-dvortsovaya-naberezhnaya' },
      { name: 'Дворцовый мост в развод', desc: 'Ночной ритуал навигации.', mustSeeFilter: 'views' , seasonLabel: 'Летняя навигация - май-октябрь', locationSlug: 'saint-petersburg-dvortsovyy-most' },
      { name: 'Банковский мост', desc: 'Пешеходный мост с золотыми грифонами на канале Грибоедова - один из самых узнаваемых видов города.', mustSeeFilter: 'views', locationSlug: 'saint-petersburg-bankovskiy-most' },
      { name: 'Набережная канала Грибоедова', desc: 'Изгибы к Спасу и Казанскому.', mustSeeFilter: 'views', locationSlug: 'saint-petersburg-naberezhnaya-kanala-griboedova' },
      { name: 'Университетская набережная', desc: 'Сфинксы у Академии художеств и широкий вид на стрелку Васильевского острова через Неву.', mustSeeFilter: 'views', locationSlug: 'saint-petersburg-universitetskaya-naberezhnaya' },
      { name: 'Английская набережная', desc: 'Парадные особняки по соседству с Сенатской площадью.', mustSeeFilter: 'views', locationSlug: 'saint-petersburg-angliyskaya-naberezhnaya' },
      { name: 'Набережная реки Мойки', desc: 'Камерный маршрут дворцов и мостов.', mustSeeFilter: 'views', locationSlug: 'saint-petersburg-naberezhnaya-reki-moyki' },
  ...
  moscow: {
    ...
    mustSee: [
      {
        ...
        desc: "Древняя каменная цитадель и главная общественно-политическая и историко-художественная резиденция страны.",
        address: "Ивановская площадь",
        latitude: 55.752,
        longitude: 37.6175,
        mustSeeFilter: "main",
      ...
      },
      {
        ...
        desc: "Главное парадное пространство России, вымощенное крымским габбро-диабазом и обрамленное культовыми памятниками архитектуры.",
      ...
      {
        name: "Большой театр",
        desc: "Главная историческая оперно-балетная сцена страны, увенчанная знаменитой квадригой Аполлона работы Петра Клодта.",
      ...
      },
      {
        ...
        desc: "Ультрасовременный квартал футуристических небоскребов из стекла и стали - главный символ нового делового облика Москвы.",
        address: "Пресненская набережная, 6-12",
        latitude: 55.7472,
        longitude: 37.5392,
        mustSeeFilter: "main",
      ...
      {
        name: "ГУМ",
        desc: "Роскошный трехъярусный пассаж в псевдорусском стиле с ажурными стеклянными сводами инженера Шухова на Красной площади.",
      ...
      {
        name: "Парк «Зарядье»",
        desc: "Уникальный урбанистический парк у стен Кремля, воссоздающий природные зоны России и оборудованный знаменитым Парящим мостом.",
        address: "ул. Варварка, домовладение 6, стр. 1",
        latitude: 55.7513,
        longitude: 37.6281,
        mustSeeFilter: "main",
      ...
      {
        name: "ВДНХ",
        desc: "Колоссальный выставочный город-ансамбль с монументальными советскими павильонами, фонтанами «Дружба народов» и «Каменный цветок».",
      ...
      },
      {
        ...
        desc: "Высотная доминанта севера Москвы со смотровой и историей советского телевидения.",
      ...
      },
      {
        ...
        desc: "Главное мировое хранилище шедевров русского национального искусства от древних икон до полотен передвижников.",
      ...
      },
      {
        ...
        desc: "Научно-технический музей в массивном стилобате монумента «Покорителям космоса» у подножия ВДНХ.",
      ...
      },
      {
        ...
        desc: "Интерактивная история евреев России в бывшем Бахметьевском гараже Мельникова и Шухова.",
      ...
      },
      {
        ...
        desc: "Бывший секретный подземный противоатомный командный пункт СССР на глубине 65 метров под жилым кварталом.",
      ...
      },
      {
        ...
        desc: "Единственный в России интерактивный музей шифров, секретных технологий связи и истории математики.",
        address: "ул. Ботаническая, 25, стр. 4",
        latitude: 55.8292,
        longitude: 37.5925,
        mustSeeFilter: "museum",
      ...
      },
      {
        ...
        desc: "Костюмы, кинокамеры, эскизы и личные вещи великих режиссеров отечественного кинематографа в павильоне №36.",
        address: "проспект Мира, 119, павильон №36",
        latitude: 55.8356,
        longitude: 37.6253,
        mustSeeFilter: "museum",
      ...
      {
        name: "Нескучный сад",
        desc: "Старейший пейзажный парк Москвы на берегу реки с мостиками Казакова и атмосферой дворянских усадеб.",
      ...
      },
      {
        ...
        desc: "Один из старейших зоологических садов Европы XIX века примерно с 10 тысячами обитателей в вольерах открытого типа.",
        address: "ул. Большая Грузинская, 1, стр. 1",
        latitude: 55.7618,
        longitude: 37.5772,
      ...
      },
      {
        ...
        desc: "Один из крупнейших научно-просветительских центров мира с гигантским куполом-экраном и музеем «Урания».",
      ...
      },
      {
        ...
        desc: "Самый высокий аттракцион подобного типа в Европе с панорамой столицы с высоты 140 метров из прозрачных кабин.",
      ...
      },
      {
        ...
        desc: "Музей занимательных наук, где экспонаты физики и механики можно и нужно трогать руками.",
      ...
      },
      {
        ...
        desc: "Пешеходная ландшафтная набережная-парк с волнообразными скамейками, сухими фонтанами и открытым вернисажем художников.",
        address: "ул. Крымский Вал, 2",
        latitude: 55.735,
        longitude: 37.6074,
        mustSeeFilter: "views",
      ...
      },
      {
        ...
        desc: "Уникальная 70-метровая V-образная консоль без опоры над Москворецкой набережной и рекой.",
      ...
      },
      {
        ...
        desc: "Самая высокая крытая смотровая Европы на 89-м этаже башни «Федерация-Восток» с фабрикой мороженого.",
      ...
      },
      {
        ...
        desc: "Безопасная открытая смотровая в сердце города с видом на Лубянскую площадь и Кремль.",
      ...
      {
        name: "Мост Багратион",
        desc: "Крытый торгово-пешеходный мост из стекла и стали между Кутузовским проспектом и «Москва-Сити».",
        address: "Краснопресненская набережная, 16А",
        latitude: 55.7461,
        longitude: 37.5442,
        mustSeeFilter: "views",
      ...
      },
      {
        ...
        desc: "Старинная нарядная улица Китай-города - пешеходный центр ночной иллюминации и праздничных гуляний.",
      ...
      {
        name: "Улица Варварка",
        desc: "Одна из старейших улиц столицы с ожерельем древнерусских белокаменных храмов и палат XVI-XVII веков.",
        address: "ул. Варварка",
        latitude: 55.7523,
        longitude: 37.6269,
        mustSeeFilter: "street",
      ...
      },
      {
        ...
        desc: "Элегантный исторический квартал с живописным прудом - эпицентр модной ресторанной и светской жизни.",
        address: "Большой Патриарший переулок",
        latitude: 55.7634,
        longitude: 37.5925,
        mustSeeFilter: "street",
      ...
      },
      {
        ...
        desc: "Замоскворечье: храмы, низкая застройка и путь к Третьяковке.",
      ...
      },
      {
        ...
        desc: "Интеллигентная ресторанная миля центра с упором на высокую авторскую кухню.",
        address: "ул. Большая Никитская",
        latitude: 55.7558,
        longitude: 37.6053,
        mustSeeFilter: "street",
      ...
      },
      {
        ...
        desc: "Грандиозный пятиглавый храм в Замоскворечье - эталон пышного петербургского барокко эпохи Елизаветы Петровны.",
      ...
      },
      {
        ...
        desc: "Строгая викторианская церковь из неоштукатуренного кирпича - уголок подлинного Лондона в Москве.",
        address: "Вознесенский переулок, 8/5, стр. 3",
        latitude: 55.7583,
        longitude: 37.6061,
        mustSeeFilter: "temple",
      ...
      },
      {
        ...
        desc: "Шедевр раннего модерна Шехтеля со знаменитой тающей лестницей-волной из мрамора (Музей Горького).",
        address: "ул. Малая Никитская, 6/2, стр. 5",
        latitude: 55.7594,
        longitude: 37.5964,
        mustSeeFilter: "mansions",
      ...
      },
      {
        ...
        desc: "Небесно-голубой барочный дворец на Мясницкой, уцелевший в пожаре 1812 года и принимавший Пушкина и Толстого.",
        address: "ул. Мясницкая, 7, стр. 2",
        latitude: 55.7597,
        longitude: 37.6297,
        mustSeeFilter: "mansions",
      ...
      },
      {
        ...
        desc: "Чешуйчатый асимметричный замок в Замоскворечье фиолетового цвета с кариатидами.",
      ...
      {
        name: "Палаты Мазепы",
        desc: "Каменные Г-образные жилые палаты XVII века со сложным узором наличников в тихих дворах Маросейки.",
        address: "Колпачный переулок, 10/7, стр. 2",
        latitude: 55.7561,
        longitude: 37.6417,
        mustSeeFilter: "mansions",
      ...
      },
      {
        ...
        desc: "Сказочный терем в псевдорусском стиле, который в 1939 году передвинули вглубь квартала на 50 метров за одну ночь.",
        address: "Тверская ул., 6, стр. 6",
        latitude: 55.7594,
        longitude: 37.6125,
      ...
      },
      {
        ...
        desc: "Уединенный средневековый внутренний двор в стиле итальянского Ренессанса с атмосферой старой Флоренции.",
      ...
      },
      {
        ...
        desc: "Амфитеатр под открытым небом с законсервированным фрагментом каменной стены Белого города XVI века.",
      ...
      },
      {
        ...
        desc: "Белокаменные палаты XV века - представительство английских купцов при Иване Грозном.",
      ...
      },
      {
        ...
        desc: "Аутентичный закоулок бывшей криминальной площади Москвы из рассказов Гиляровского.",
        address: "Подколокольный переулок, 11/11/1с2",
        latitude: 55.7512,
        longitude: 37.6429,
        mustSeeFilter: "secret",
      ...
      },
      {
        ...
        desc: "Первый масштабный арт-кластер России на территории бывшего пивоваренного завода.",
        address: "4-й Сыромятнический переулок, 1, стр. 6",
        latitude: 55.7569,
        longitude: 37.6653,
      ...
      },
      {
        ...
        desc: "Творческий квартал в зданиях бывшего приборостроительного завода у Яузы.",
      ...
      },
      {
        ...
        desc: "Крупнейший дворец культуры Москвы братьев Весниных в стиле конструктивизма с обсерваторией и зимним садом.",
      ...
      },
      {
        ...
        desc: "Бывший газовый завод, где круглые кирпичные газгольдеры превращены в ультрамодные офисы и лофты.",
        address: "Нижний Сусальный переулок, 5",
        latitude: 55.7603,
        longitude: 37.6625,
        mustSeeFilter: "creative",
      ...
      {
        name: "Суперметалл",
        desc: "Деловой кластер в цеху НИИ металлургии, где сталинский ампир соединен с минимализмом и живыми растениями.",
      ...
      },
      {
        ...
        desc: "Мультиформатный культурный центр на комбинате «Правда»: галерея, студия, бистро и ночной клуб.",
        address: "3-я улица Ямского Поля, 2, корп. 25",
        latitude: 55.7814,
        longitude: 37.5819,
        mustSeeFilter: "creative",
      ...
      {
        name: "Дом Наркомфина",
        desc: "Легендарный памятник конструктивизма - дом-коммуна с экспериментальными двухъярусными ячейками.",
        address: "Новинский бульвар, 25, корп. 1",
        latitude: 55.7547,
        longitude: 37.5808,
        mustSeeFilter: "creative",
      ...
      {
        name: "Дом Мельникова",
        desc: "Всемирно известный авангардный дом из двух врезанных цилиндров с шестигранными окнами.",
      ...
      },
      {
        ...
        desc: "Шедевр Мельникова-фасад-шестеренка с тремя выступающими бетонными зубьями балконов-амфитеатров.",
        address: "ул. Стромынка, 6",
        latitude: 55.7914,
        longitude: 37.6917,
        mustSeeFilter: "creative",
      ...
      },
      {
        ...
        desc: "Памятник промышленного конструктивизма Мельникова и Шухова с уникальной «косой» парковкой (ныне Еврейский музей).",
        address: "ул. Образцова, 11, стр. 1А",
        latitude: 55.7892,
        longitude: 37.6083,
        mustSeeFilter: "creative",
      ...
      },
      {
        ...
        desc: "Крупнейший в России фуд-холл в отреставрированном корпусе Миусского трамвайного депо.",
      ...
      },
      {
        ...
        desc: "Культовый гастрономический ресторан с дворянскими интерьерами XIX века и эталонной русской кухней.",
      ...
      },
      {
        ...
        desc: "Бывшее фабричное пространство из красного кирпича на стрелке острова - клубы, галереи и кафе.",
        address: "Берсеневская набережная, 6",
        latitude: 55.7423,
        longitude: 37.6083,
        mustSeeFilter: "gastro",
      ...
      },
      {
        ...
        desc: "Ностальгическая столовая на третьей линии ГУМа с советскими рецептами по ГОСТу.",
        address: "Красная площадь, 3",
        latitude: 55.7547,
        longitude: 37.6214,
        mustSeeFilter: "gastro",
      ...
      },
      {
        ...
        desc: "Флагман высокой кухни под стеклянным куполом Смоленского пассажа с панорамой 360 градусов.",
      ...
      },
      {
        ...
        desc: "Атмосферный темный ресторан с парящими свечами и авторскими блюдами из традиционной русской печи; знаменитые завтраки.",
        address: "Большая Никитская ул., 12, стр. 1",
        latitude: 55.7558,
        longitude: 37.6053,
        mustSeeFilter: "gastro",
    ...
    significantSuburbs: [
      ...
      {
        name: "Архангельское",
        desc: "«Подмосковный Версаль»: дворцово-парковый ансамбль Юсуповых с террасными садами и античными скульптурами.",
        address: "Московская обл., г.о. Красногорск, п. Архангельское",
        latitude: 55.7844,
        longitude: 37.2831,
  ...
  perm: {
    ...
    mustSee: [
      ...
      { name: 'Набережная Камы', desc: 'Главный променад вдоль реки с амфитеатром, причалами и панорамой на Каму.', address: 'ул. Монастырская, 1Б', locationSlug: 'naberezhnaya-kamy', mustSeeFilter: 'main', latitude: 58.01825, longitude: 56.2466 },
      { name: 'Арт-объект «Счастье не за горами»', desc: 'Красные буквы у Речного вокзала - самый узнаваемый фото-символ Перми.', address: 'ул. Берег Камы (у Речного вокзала)', locationSlug: 'perm-schaste-ne-za-gorami', mustSeeFilter: 'main', latitude: 58.01835, longitude: 56.25055 },
    ...
    significantSuburbs: [
      ...
      },
      {
        ...
        places: [
          { name: 'Белогорский Свято-Николаевский монастырь', desc: '«Уральский Афон» - белокаменный собор на вершине Белой горы.', locationSlug: 'perm-belogorskiy-monastyr', latitude: 57.39202, longitude: 56.229, transitTip: 'Авто по Р-242 / Суксун к монастырю' },
        ...
        places: [
          {
            ...
            desc: 'вертикальные скалы над рекой Усьвой - визитная карточка района.',
          ...
          },
          {
            ...
            desc: 'площадка с видом на отвесные скалы над Усьвой - ключевой кадр дня.',
            latitude: 58.7168,
            longitude: 57.6145
          },
          {
            name: 'Сердце Пармы (Загубашка)',
            desc: 'декорации и виды фильма/книги о Парме - после трека к столбам, без спешки.',
            latitude: 58.705,
            longitude: 57.602,
          ...
          {
            name: 'Каменный город',
            desc: 'скальный «город» останцев среди тайги у Губахи.',
          ...
          },
          {
            ...
            desc: 'карстовая пещера у Каменного города - осторожно на входе, без лишней авантюры.',
            latitude: 58.7245,
            longitude: 57.636
          },
          {
    ...
    dayRoutePresets: [
      ...
      },
      {
        ...
        travelVectorBlurb:
          'Трасса Р-242 / Суксун: монастырь - Царский крест - купель/источник у горы - Плакун. Не совмещать с камнем Ермак за один день - крюк под 100 км.',
        stops: [
          { name: 'Белогорский Свято-Николаевский монастырь', desc: 'Уральский Афон', locationSlug: 'perm-belogorskiy-monastyr' },
      ...
      },
      {
        ...
        travelVectorBlurb:
          'День 1 - Усьва (столбы, смотровая, Загубашка); день 2 - Губаха (Каменный город, пещера Российская, Крестовая на закат). Полюд (~250 км) с этой поездкой не совмещать.',
        stops: [
          { name: 'Усьвинские столбы', desc: 'День 1 - скалы над Усьвой', locationSlug: 'perm-usvinskie-stolby' },
          { name: 'Смотровая Усьвинских столбов', desc: 'День 1 - ключевой кадр' },
          { name: 'Сердце Пармы (Загубашка)', desc: 'День 1 - после трека' },
          ...
          { name: 'Гора Крестовая', desc: 'отличный вид на закате.', transitTip: 'К смотровой площадке' },
        ]
      },
    ],
    travel:
