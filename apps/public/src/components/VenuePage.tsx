...
import { InstitutionVenueLayout } from '@/components/InstitutionVenueLayout';
import { LocationVenueLayout } from '@/components/LocationVenueLayout';
import {
...
export function VenuePage({ slug }: VenuePageProps) {
  ...
  const pageTemplate = venue ? venue.template || venuePageTemplate(venue.type) : 'location';
