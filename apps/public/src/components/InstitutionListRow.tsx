...
export function InstitutionListRow({
  ...
  return (
    <a
      href={href}
      className="group flex items-center gap-3 px-4 py-3 transition hover:bg-slate-50 sm:gap-4 sm:px-5 sm:py-3.5"
    >
...
export function InstitutionList({
  ...
  venues: Array<Pick<PublicVenue, 'id' | 'name' | 'city' | 'events' | 'type' | 'address'>>;
  hrefFor: (venue: Pick<PublicVenue, 'id' | 'name' | 'city' | 'events' | 'type' | 'address'>) => string;
  className?: string;
}) {
