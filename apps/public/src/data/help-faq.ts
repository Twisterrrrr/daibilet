...
export const HELP_FAQ_CATEGORIES: HelpFaqCategory[] = [
  {
    ...
    items: [
      ...
      },
      {
        ...
        a: 'Электронный билет отправляет билетная система организатора на email, указанный в виджете при оплате. Если письмо не пришло в течение 15 минут - проверьте «Спам» или воспользуйтесь «Проверить заказ» на нашем сайте.',
      },
      {
