...
export const SERGIEV_POSAD_SUBURB_CARD: CitySuburbItem = {
    ...
    places: [
      ...
      },
      {
        ...
        locationSlug: "moscow-troitskiy-sobor-lavra",
        latitude: 56.3106,
        longitude: 38.1307,
      },
      {
        ...
        locationSlug: "moscow-uspenskiy-sobor-lavra",
        latitude: 56.3108,
        longitude: 38.131,
      },
      {
        ...
        locationSlug: "moscow-lavrskaya-kolokolnya",
        latitude: 56.3109,
        longitude: 38.1312,
      },
      {
        ...
        locationSlug: "moscow-svyatoy-istochnik-lavra",
        latitude: 56.3108,
        longitude: 38.1315,
      },
      {
        ...
        locationSlug: "moscow-kelarskiy-prud",
        latitude: 56.3095,
        longitude: 38.1285,
      },
      {
        ...
        locationSlug: "moscow-muzey-igrushki-sergiev",
        latitude: 56.3085,
        longitude: 38.1355,
      },
      {
        ...
        locationSlug: "moscow-chernigovskiy-skit",
...
export const ISTRA_SUBURB_CARD: CitySuburbItem = {
    ...
    places: [
      ...
      },
      {
        ...
        locationSlug: "moscow-voskresenskiy-sobor-novoierusalim",
        latitude: 55.9218,
        longitude: 36.8458,
      },
      {
        ...
        locationSlug: "moscow-tserkov-konstantina-eleny",
        latitude: 55.9217,
        longitude: 36.8456,
      },
      {
        ...
        locationSlug: "moscow-steny-novoierusalim",
        latitude: 55.9212,
        longitude: 36.845,
      },
      {
        ...
        locationSlug: "moscow-skit-nikona",
        latitude: 55.9225,
        longitude: 36.8445,
      },
      {
        ...
        locationSlug: "moscow-muzey-novyy-ierusalim",
        latitude: 55.9195,
        longitude: 36.8485,
      },
      {
        ...
        locationSlug: "moscow-muzey-derevyannogo-zodchestva-istra",
        latitude: 55.92,
        longitude: 36.847,
      }
    ],
...
export const KOLOMNA_SUBURB_CARD: CitySuburbItem = {
    ...
    places: [
      ...
      },
      {
        ...
        locationSlug: "moscow-marinkina-bashnya",
        latitude: 55.1038,
        longitude: 38.7528,
      },
      {
        ...
        locationSlug: "moscow-sobornaya-ploschad-kolomna",
        latitude: 55.104,
        longitude: 38.7535,
      },
      {
        ...
        locationSlug: "moscow-muzey-kolomenskaya-pastila",
        latitude: 55.1045,
        longitude: 38.7555,
      },
      {
        ...
        locationSlug: "moscow-muzey-kalachnaya",
        latitude: 55.1042,
        longitude: 38.754,
      },
      {
        ...
        locationSlug: "moscow-pyatnitskie-vorota-kolomna",
        latitude: 55.103,
        longitude: 38.7515,
      },
      {
        ...
        locationSlug: "moscow-staro-golutvin-monastyr",
...
export const ZVENIGOROD_SUBURB_CARD: CitySuburbItem = {
    ...
    places: [
      ...
      },
      {
        ...
        locationSlug: "moscow-rozhdestvenskiy-sobor-zvenigorod",
        latitude: 55.7288,
        longitude: 36.8158,
      },
      {
        ...
        locationSlug: "moscow-dvorets-alekseya-mihaylovicha",
        latitude: 55.7287,
        longitude: 36.816,
      },
      {
        ...
        locationSlug: "moscow-tsaritsyny-palaty",
        latitude: 55.7286,
        longitude: 36.8157,
      },
      {
        ...
        locationSlug: "moscow-zvenigorodskiy-gorodok",
        latitude: 55.7295,
        longitude: 36.8545,
      },
      {
        ...
        locationSlug: "moscow-skit-savvy",
        latitude: 55.727,
        longitude: 36.812,
      },
      {
        ...
        locationSlug: "moscow-dom-muzey-prishvina-dunino",
...
export const ARHANGELSKOE_SUBURB_CARD: CitySuburbItem = {
    ...
    places: [
      ...
      },
      {
        ...
        locationSlug: "moscow-hram-arhangela-mihaila-arhangelskoe",
        latitude: 55.7855,
        longitude: 37.2825,
      },
      {
        ...
        locationSlug: "moscow-park-arhangelskoe",
        latitude: 55.7875,
        longitude: 37.2845,
      },
      {
        ...
        locationSlug: "moscow-kolonnada-arhangelskoe",
        latitude: 55.7868,
        longitude: 37.2838,
      }
    ],
...
export const ABRAMTSEVO_SUBURB_CARD: CitySuburbItem = {
    ...
    places: [
      ...
      },
      {
        ...
        locationSlug: "moscow-tserkov-spasa-abramtsevo",
        latitude: 56.2345,
        longitude: 37.9685,
      },
      {
        ...
        locationSlug: "moscow-izbushka-na-kurih-nozhkah",
        latitude: 56.234,
        longitude: 37.967,
      },
      {
        ...
        locationSlug: "moscow-park-abramtsevo",
        latitude: 56.233,
        longitude: 37.9665,
      }
    ],
...
export const BORODINO_SUBURB_CARD: CitySuburbItem = {
    ...
    places: [
      ...
      },
      {
        ...
        locationSlug: "moscow-glavnyy-monument-borodino",
        latitude: 55.5265,
        longitude: 35.8225,
      },
      {
        ...
        locationSlug: "moscow-spaso-borodinskiy-monastyr",
        latitude: 55.5185,
        longitude: 35.8155,
      },
      {
        ...
        locationSlug: "moscow-muzey-borodino",
        latitude: 55.5275,
        longitude: 35.8205,
      }
    ],
...
export const MELIHOVO_SUBURB_CARD: CitySuburbItem = {
    ...
    places: [
      ...
      },
      {
        ...
        locationSlug: "moscow-chehovskaya-apteka",
        latitude: 55.1188,
        longitude: 37.6488,
      },
      {
        ...
        locationSlug: "moscow-sad-melihova",
        latitude: 55.1182,
        longitude: 37.6475,
      },
      {
        ...
        locationSlug: "moscow-shkola-chehova",
        latitude: 55.1195,
        longitude: 37.6495,
      }
    ],
