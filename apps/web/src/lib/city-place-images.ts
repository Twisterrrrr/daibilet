...
const LOCATION_PACK_IMAGES: Record<string, string> = {
  ...
  'moscow-gmii-imeni-pushkina': '/images/venues/moscow/gmii-imeni-pushkina.jpg',
  ...
  'moscow-krasnaya-ploschad-i-kreml': '/images/venues/moscow/krasnaya-ploschad-i-kreml.jpg',
