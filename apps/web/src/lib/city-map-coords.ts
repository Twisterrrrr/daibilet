...
const CITY_CENTER_BY_SLUG: Record<string, CityMapCoords> = {
  ...
  'hanty-mansiysk': { latitude: 61.0042, longitude: 69.022 },
  'khanty-mansiysk': { latitude: 61.0042, longitude: 69.022 },
  ...
  novokuznetsk: { latitude: 53.7557, longitude: 87.1099 },
  novokuzneck: { latitude: 53.7557, longitude: 87.1099 },
...
const CITY_CENTER_BY_NAME: Record<string, CityMapCoords> = {
  ...
  'ханты-мансийск': CITY_CENTER_BY_SLUG['hanty-mansiysk'],
  ...
  новокузнецк: CITY_CENTER_BY_SLUG.novokuznetsk,
