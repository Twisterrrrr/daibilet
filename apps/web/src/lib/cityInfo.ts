...
export const CITY_INFO: Record<string, CityInfoEntry> = {
  'saint-petersburg': {
    ...
    mustSee: [
      ...
      { name: 'Невский проспект', desc: 'Главная четырехкилометровая артерия города, получившая свой знаменитый излом из-за навигационной ошибки строителей, шедших навстречу друг другу с двух сторон сквозь глухие болота.', mustSeeFilter: 'main' , seasonLabel: 'Зимний эксклюзив: иллюминация - ноябрь-апрель'},
      { name: 'Адмиралтейство', desc: 'Историческая корабельная верфь в стиле ампир, чей знаменитый золоченый шпиль с 65-килограммовым корабликом-флюгером служит точкой отсчета для трех главных лучей-улиц городского центра.', mustSeeFilter: 'main' },
      { name: 'Медный всадник (Сенатская площадь)', desc: 'Легендарный памятник Петру Великому, отлитый из бронзы и установленный на гигантском монолитном Гром-камне, который тащили к побережью Невы на специальных металлических шарах более девяти месяцев.', mustSeeFilter: 'main' },
      { name: 'Стрелка Васильевского острова', desc: 'Один из самых узнаваемых водных фасадов мира, где величественные Ростральные колонны в XIX веке выполняли роль портовых маяков, освещая путь заходящим в Неву торговым судам огнем из чаш с конопляным маслом.', mustSeeFilter: 'main' },
      { name: 'Михайловский замок', desc: 'Мрачный розовый дворец-крепость, окруженный оборонительными рвами, который не смог спасти своего параноидального создателя императора Павла I, задушенного заговорщиками в собственной спальне спустя сорок дней после новоселья.', mustSeeFilter: 'main' },
      { name: 'Аничков мост', desc: 'Историческая переправа через реку Фонтанку, получившая мировую известность благодаря четырем бронзовым скульптурным группам Петра Клодта, наглядно показывающим последовательные стадии укрощения дикого коня человеком.', mustSeeFilter: 'main' },
      ...
      { name: 'Музей политической истории (особняк Кшесинской)', desc: 'XX век в модерне у Петропавловки. Кронверкский', mustSeeFilter: 'museum' , themeTags: ['Северный модерн']},
      { name: 'Музей Анны Ахматовой в Фонтанном доме', desc: 'Уютная, но трагичная квартира-коммуналка в южном флигеле Шереметевского дворца, сохранившая атмосферу Серебряного века и зафиксировавшая тридцать лет жизни великой поэтессы.', mustSeeFilter: 'museum' },
      { name: 'Литературно-мемориальный музей Достоевского', desc: 'Угловая квартира на Кузнечном переулке, в которой писатель провел свои последние годы и создал финальный литературный шедевр - роман «Братья Карамазовы».', mustSeeFilter: 'museum' },
      ...
      { name: 'Дворцовый мост в развод', desc: 'Ночной ритуал навигации. Нева', mustSeeFilter: 'views' , seasonLabel: 'Летняя навигация - май-октябрь'},
      ...
      { name: 'Каменноостровский проспект', desc: 'Модерн и зелень Петроградской стороны. Петроградка', mustSeeFilter: 'street' , themeTags: ['Северный модерн']},
      ...
      { name: 'Марсово поле', desc: 'Бывший военный плац и «Петербургская Сахара», ставшая сквером с парком сирени и первым в СССР мемориалом с Вечным огнем.', mustSeeFilter: 'park' },
      ...
      { name: 'Санкт-Петербургская соборная мечеть', desc: 'Монументальное здание с лазурным майоликовым куполом, повторяющим контуры усыпальницы Тамерлана.', mustSeeFilter: 'temple' },
      ...
      { name: 'Севкабель Порт', desc: 'Главное культурное пространство на Васильевском острове, развернувшееся в цехах исторического кабельного завода Siemens & Halske прямо у кромки Финского залива.', mustSeeFilter: 'creative' , places: [{ name: 'Набережная у залива', desc: 'Вид на ЗСД и Финский залив.' }, { name: 'Выставочный цех «Кабель»', desc: 'Площадка временных выставок.' }, { name: 'Культурный квартал «Брусницын»', desc: 'Соседний творческий квартал.' }]},
      { name: 'Бертгольд Центр', desc: 'Творческий квартал в зданиях бывшей словолитни, знаменитый своим внутренним двориком с подвесными зонтиками и винтовой металлической лестницей на крышу.', mustSeeFilter: 'creative' },
      ...
      { name: 'Ротонда на Гороховой', desc: 'Мистический круглый подъезд доходного дома конца XVIII века с шестью колоннами и винтовой лестницей, ставший центром питерского рок-андеграунда 1980-х.', mustSeeFilter: 'creative' , themeTags: ['Ленинградский рок и андеграунд']},
      { name: 'Мозаичный дворик', desc: 'Сказочная уличная инсталляция на Фонтанке, где стены, поребрики и скульптуры вручную покрыты цветной смальтовой мозаикой художником Владимиром Лубенко.', mustSeeFilter: 'creative' },
    ...
    significantSuburbs: [
      {
        ...
        mustSeeFilter: 'main',
        places: [
          { name: 'Нижний парк Петергофа', seasonLabel: 'Летняя навигация - май-октябрь', desc: 'регулярный парадный сад Петра I на берегу Финского залива со знаменитой системой фонтанов, работающей вообще без насосов.' },
        ...
        travelVector: 'Морской Юго-Западный', stationHub: 'Балтийский вокзал / Метеоры' },
      {
        ...
        travelVector: 'Южный вектор', stationHub: 'Витебский вокзал', gastroHint: 'Павловск удобно объединить с Пушкиным в двухдневную поездку.' },
      {
        name: 'Кронштадт',
        desc: 'Пять точек для отдельной загородной поездки.',
        mustSeeFilter: 'main',
        ...
        travelVector: 'Островной', stationHub: 'Катера / Дамба' },
      {
        name: 'Гатчина',
        desc: 'Пять точек для отдельной загородной поездки.',
        mustSeeFilter: 'main',
        ...
        travelVector: 'Юго-Западный вектор', stationHub: 'Балтийский вокзал' },
      {
        name: 'Павловск',
        desc: 'Пять точек для отдельной загородной поездки.',
        mustSeeFilter: 'main',
        ...
        travelVector: 'Южный вектор', stationHub: 'Витебский вокзал', gastroHint: 'Ресторан «Подворье».' },
      {
        ...
        travelVector: 'Морской Юго-Западный', stationHub: 'Балтийский вокзал / Метеоры' },
      {
        ...
        travelVector: 'Морской Юго-Западный', stationHub: 'Балтийский вокзал / Метеоры', gastroHint: 'Метеоры - летняя навигация, май-октябрь.' },
      {
        name: 'Выборг',
        desc: 'Пять точек для отдельной загородной поездки.',
        mustSeeFilter: 'main',
        ...
        travelVector: 'Северный и Финский', stationHub: 'Финляндский вокзал', gastroHint: 'Выборгский крендель - местная гастрономическая легенда.' },
      {
        ...
        travelVector: 'Северный и Финский', stationHub: 'Финляндский вокзал', gastroHint: 'Ресторан «Русская рыбалка».' },
      {
        ...
        travelVector: 'Островной', stationHub: 'Катера / Дамба' },
      {
        ...
        travelVector: 'Северный и Финский', stationHub: 'Финляндский вокзал' },
    ],
    dayRoutePresets: [
      {
        id: 'spb-1',
