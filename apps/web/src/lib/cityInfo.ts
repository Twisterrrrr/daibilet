...
export const CITY_INFO: Record<string, CityInfoEntry> = {
  'saint-petersburg': {
    ...
    mustSee: [
      ...
      { name: 'Невский проспект', desc: 'Главная четырехкилометровая артерия города, получившая свой знаменитый излом из-за навигационной ошибки строителей, шедших навстречу друг другу с двух сторон сквозь глухие болота.', mustSeeFilter: 'main' },
      ...
      { name: 'Новая Голландия', desc: 'Рукотворный остров-парк внутри бывших складов корабельного леса, превращенный в самое стильное общественное пространство города.', mustSeeFilter: 'park' },
      ...
      { name: 'Чесменская церковь', desc: 'Уникальный розовый «пряничный» храм в стиле ложной готики, построенный в честь морской победы над турками.', mustSeeFilter: 'temple' },
      ...
      { name: 'Севкабель Порт', desc: 'Главное культурное пространство на Васильевском острове, развернувшееся в цехах исторического кабельного завода Siemens & Halske прямо у кромки Финского залива.', mustSeeFilter: 'creative' },
      ...
      { name: 'Ротонда на Гороховой', desc: 'Мистический круглый подъезд доходного дома конца XVIII века с шестью колоннами и винтовой лестницей, ставший центром питерского рок-андеграунда 1980-х.', mustSeeFilter: 'creative' },
      ...
      { name: 'Витебский вокзал', desc: 'Шедевр стиля модерн с коваными дебаркадерами и старинными интерьерами, полностью сохранивший атмосферу вокзалов начала XX века.', mustSeeFilter: 'creative' },
      { name: 'Смоленское лютеранское кладбище', desc: 'Исторический немецкий некрополь на Васильевском острове, известный старинными склепами и беседой из культового фильма «Брат».', mustSeeFilter: 'creative' },
      { name: 'Дом Бака', desc: 'Знаменитый доходный дом на Кирочной улице со сквозными подвесными галереями-переходами внутри двора-колодца.', mustSeeFilter: 'creative' },
      { name: 'Толстовский дом', desc: 'Огромный жилой комплекс со знаменитой тройной анфиладой парадных арок, формирующих внутреннюю улицу.', mustSeeFilter: 'creative' },
    ...
    significantSuburbs: [
      {
        name: 'Петергоф',
        desc: 'Дворцово-парковый ансамбль с фонтанами на берегу Финского залива.',
        mustSeeFilter: 'main', locationSlug: 'saint-petersburg-petergof',
        places: [
          { name: 'Нижний парк Петергофа', desc: 'Блистательная загородная резиденция Петра I на берегу Финского залива, созданная как русский Версаль с идеальной регулярной планировкой.' },
          { name: 'Большой Петергофский дворец', desc: 'Парадная загородная резиденция, связывающая Верхний регулярный сад и Нижний парк.' },
          { name: 'Парк Александрия', desc: 'Пейзажная императорская усадьба Николая I, оформленная в стиле романтической английской готики.' },
        ],
      },
      {
        name: 'Царское Село',
        ...
        mustSeeFilter: 'main',
        places: [
          { name: 'Екатерининский дворец', desc: 'Грандиозный барочный замок Растрелли в Царском Селе, внутри которого находится воссозданная Янтарная комната.' },
          { name: 'Екатерининский парк', desc: 'Огромный сад с Камероновой галереей, Холодной баней, Большим прудом и павильонами Грот и Эрмитаж.' },
          { name: 'Александровский дворец', desc: 'Последний особняк Николая II, откуда императорская семья была отправлена в ссылку в Тобольск.' },
        ],
      },
      {
        name: 'Павловск и Гатчина',
        desc: 'Дворцы и пейзажные парки для отдельной загородной поездки.',
        mustSeeFilter: 'main',
        places: [
          { name: 'Павловский дворец и парк', desc: 'Один из самых больших и поэтичных пейзажных парков Европы, раскинувшийся в долине извилистой реки Славянки вокруг строгого классического дворца императора Павла I.' },
          { name: 'Большой Гатчинский дворец', desc: 'Суровый замок Антонио Ринальди из пудостского камня с подземным ходом к Серебряному озеру.' },
          { name: 'Приоратский дворец', desc: 'Уникальный замок Мальтийского ордена на берегу Черного озера, построенный из прессованной земли.' },
        ],
      },
      {
        name: 'Кронштадт',
        ...
        mustSeeFilter: 'main',
        places: [
          { name: 'Морской Никольский собор', desc: 'Грандиозный ставропигиальный собор на Якорной площади в Кронштадте, построенный как копия собора Святой Софии.' },
          { name: 'Музейно-исторический парк «Остров фортов»', desc: 'Современный музейно-исторический комплекс с Аллеей героев флота, маяком памяти и детскими зонами.' },
          { name: 'Музей военно-морской славы', desc: 'Масштабный павильон в Кронштадте, внутри которого размещена первая советская атомная подлодка К-3 «Ленинский комсомол».' },
        ],
      },
    ],
    dayRoutePresets: [
