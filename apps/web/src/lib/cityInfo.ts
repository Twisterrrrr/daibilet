...
export const CITY_INFO: Record<string, CityInfoEntry> = {
  'saint-petersburg': {
    ...
    significantSuburbs: [
      ...
      },
      {
        ...
        mustSeeFilter: 'main',
        places: [
          { name: 'Выборгский замок', desc: 'единственный в России полностью сохранившийся средневековый шведский рыцарский замок, основанный на скалистом острове в 1293 году.', locationSlug: 'vyborg-vyborgskiy-zamok', latitude: 60.7158, longitude: 28.7292 },
          { name: 'Башня Святого Олафа', desc: 'монументальная замковая доминанта с толщиной стен до четырех метров, служащая главной смотровой площадкой на историческую брусчатку города.', locationSlug: 'vyborg-bashnya-svyatogo-olafa', latitude: 60.71595, longitude: 28.72855 },
          { name: 'Скальный парк Монрепо', desc: 'редкий по красоте скальный пейзажный парк на берегу Выборгского залива с гранитными валунами ледникового периода и Островом мертвых.', locationSlug: 'vyborg-skalnyy-park-monrepo', latitude: 60.7321, longitude: 28.7245 },
          { name: 'Часовая башня', desc: 'старинная колокольня разрушенного собора XV века, на которой до сих пор исправно работают тяжелые часовые механизмы часового мастера.', locationSlug: 'vyborg-chasovaya-bashnya', latitude: 60.71285, longitude: 28.73145 },
          { name: 'Круглая башня', desc: 'мощная средневековая башня на Рыночной площади, сохранившаяся часть городских укреплений XVI века.', locationSlug: 'vyborg-kruglaya-bashnya', latitude: 60.71355, longitude: 28.73285 },
          { name: 'Анненские укрепления', desc: 'бастионный пояс XVIII века на мысе, откуда открывается вид на замок и Выборгский залив.', locationSlug: 'vyborg-annenskie-ukrepleniya', latitude: 60.71785, longitude: 28.72655 },
          { name: 'Ратуша (Старая ратуша)', desc: 'историческое здание городского самоуправления на площади Старой Ратуши в сердце средневекового Выборга.', locationSlug: 'vyborg-staraya-ratusha', latitude: 60.71235, longitude: 28.73055 },
          { name: 'Библиотека Алвара Аалто', desc: 'шедевр мирового архитектурного функционализма с уникальным волнообразным деревянным потолком и системой бестеневого освещения.', locationSlug: 'vyborg-biblioteka-alvara-aalto', latitude: 60.709, longitude: 28.7478 },
        ],
  ...
  'nizhny-novgorod': {
    ...
    mustSee: [
      ...
      { name: 'Нижне-Волжская набережная', desc: 'Главный променад у воды', locationSlug: 'nizhny-novgorod-nizhne-volzhskaya-naberezhnaya', mustSeeFilter: 'views', visitMinutes: 40 },
      ...
      { name: 'Рождественская улица', desc: 'Гастрономический и исторический квартал', locationSlug: 'nizhny-novgorod-rozhdestvenskaya-ulitsa', mustSeeFilter: 'street', visitMinutes: 60 },
      ...
      { name: 'Почаинский бульвар', desc: 'Тихий променад над оврагом', locationSlug: 'nizhny-novgorod-pochainskiy-bulvar', mustSeeFilter: 'views', visitMinutes: 45 },
      ...
      { name: 'Музей истории ГАЗ', desc: 'Легендарные советские автомобили', venueSlug: 'nizhny-novgorod-muzey-istorii-gaz', mustSeeFilter: 'museum', visitMinutes: 90 },
      ...
      { name: 'Лепи Тесто', desc: 'Авторские пельмени у Грузинской / Покровки', venueSlug: 'nizhny-novgorod-lepi-testo', mustSeeFilter: 'gastro', visitMinutes: 60 },
      ...
      { name: 'Mitrich', desc: 'Стейкхаус премиум-класса', venueSlug: 'nizhny-novgorod-mitrich-restaurant', mustSeeFilter: 'gastro', visitMinutes: 90 },
      { name: 'РИБС', desc: 'Стейки и волжская рыба на Семашко', venueSlug: 'nizhny-novgorod-ribs-restaurant', mustSeeFilter: 'gastro', visitMinutes: 90 },
      { name: 'Медные Трубы', desc: 'Секретный камерный коктейльный бар на Суетинской', venueSlug: 'nizhny-novgorod-mednye-truby-bar', mustSeeFilter: 'gastro', visitMinutes: 60 },
      ...
      { name: 'Фонотека', desc: 'Арт-бар с винилом и уличным артом на Большой Покровской', venueSlug: 'nizhny-novgorod-fonoteca-bar', mustSeeFilter: 'gastro', visitMinutes: 40 },
      {
  ...
  perm: {
    ...
    significantSuburbs: [
      ...
      },
      {
        ...
        places: [
          { name: 'Пуп Земли', desc: 'Необычный малый архитектурный памятник на набережной Кунгура, установленный в точке пересечения важнейших исторических дорог.', address: 'Пермский край, Кунгур, ул. Карла Маркса (на набережной реки Сылвы)', visitMinutes: 15, latitude: 57.428588, longitude: 56.938883 },
          { name: 'Набережная Сылвы', desc: 'прогулка вдоль реки в центре - часть пешеходного круга до авто-блока.', visitMinutes: 30, latitude: 57.4295, longitude: 56.9485 },
      ...
      },
      {
        ...
        places: [
          ...
          { name: 'Царский крест', desc: 'Огромный памятный крест в Белогорском монастыре, установленный в память о спасении цесаревича Николая Александровича после покушения в Японии.', address: 'Пермский край, Кунгурский округ, д. Белая Гора (у монастыря)', visitMinutes: 15, latitude: 57.391745, longitude: 56.22905 },
          { name: 'Купель / источник', desc: 'святой источник и купель у подножия монастырской горы - в связке с обителью.', visitMinutes: 20, latitude: 57.3906, longitude: 56.2278, transitTip: 'Спуск к купели у подножия - в связке с монастырём' },
          { name: 'Водопад Плакун', desc: 'живописный известняковый водопад в Суксунском районе - финал православного дня.', visitMinutes: 30, latitude: 57.3481, longitude: 57.0506, transitTip: 'Авто к Плакуну (Суксун); Ермак - в день Кунгура' },
        ]
      },
      {
