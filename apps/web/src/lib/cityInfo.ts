...
export const CITY_INFO: Record<string, CityInfoEntry> = {
  'saint-petersburg': {
    ...
    mustSee: [
      ...
      { name: 'Русский музей', desc: 'Главное собрание русского искусства в Михайловском дворце. пл. Искусств', mustSeeFilter: 'museum', venueSlug: 'saint-petersburg-russkiy-muzey' },
      { name: 'Главный штаб (Эрмитаж)', desc: 'Импрессионисты и панорама площади через арку. Дворцовая', mustSeeFilter: 'museum', venueSlug: 'saint-petersburg-glavnyy-shtab-ermitazh' },
      { name: 'Кунсткамера', desc: 'Петровский кабинет редкостей и глобус. Университетская наб.', mustSeeFilter: 'museum', locationSlug: 'saint-petersburg-kunstkamera' },
      { name: 'Музей Фаберже', desc: 'Яйца и ювелирка в Шуваловском дворце. наб. Фонтанки', mustSeeFilter: 'museum', venueSlug: 'saint-petersburg-muzey-faberzhe' },
      { name: 'Эрарта', desc: 'Крупный частный музей современного искусства. Васильевский остров', mustSeeFilter: 'museum', locationSlug: 'saint-petersburg-erarta' },
      { name: 'Юсуповский дворец', desc: 'Интерьеры и легенда Распутина. Мойка', mustSeeFilter: 'museum', locationSlug: 'saint-petersburg-yusupovskiy-dvorets' },
      { name: 'Центральный военно-морской музей', desc: 'Флотская история у Синего моста / новый корпус. Центр / ВО', mustSeeFilter: 'museum', venueSlug: 'saint-petersburg-tsentralnyy-voenno-morskoy-muzey' },
      { name: 'Музей обороны и блокады Ленинграда', desc: 'Блокадная память без прикрас. Соляной пер.', mustSeeFilter: 'museum', venueSlug: 'saint-petersburg-muzey-oborony-i-blokady-leningrada' },
      { name: 'Зоологический музей РАН', desc: 'Кит в зале и классическая натуралистика. Университетская наб.', mustSeeFilter: 'museum', venueSlug: 'saint-petersburg-zoologicheskiy-muzey-ran' },
      { name: 'Музей политической истории (особняк Кшесинской)', desc: 'XX век в модерне у Петропавловки. Кронверкский', mustSeeFilter: 'museum' , themeTags: ['Северный модерн'], venueSlug: 'saint-petersburg-muzey-politicheskoy-istorii-osobnyak-kshesinskoy' },
      ...
      { name: 'Мраморный дворец', desc: 'Филиал Русского музея, редкий облицованный фасад. Миллионная', mustSeeFilter: 'museum', locationSlug: 'saint-petersburg-mramornyy-dvorets' },
      { name: 'Артиллерийский музей', desc: 'Пушки во дворе у кронверка. Кронверкская наб.', mustSeeFilter: 'museum', venueSlug: 'saint-petersburg-artilleriyskiy-muzey' },
      { name: 'Дворцовая набережная', desc: 'Фасад Зимнего и зеркало Невы. Дворцовая', mustSeeFilter: 'views', locationSlug: 'saint-petersburg-dvortsovaya-naberezhnaya' },
      { name: 'Дворцовый мост в развод', desc: 'Ночной ритуал навигации. Нева', mustSeeFilter: 'views' , seasonLabel: 'Летняя навигация - май-октябрь', locationSlug: 'saint-petersburg-dvortsovyy-most' },
      { name: 'Набережная канала Грибоедова', desc: 'Изгибы к Спасу и Казанскому. Центр', mustSeeFilter: 'views', locationSlug: 'saint-petersburg-naberezhnaya-kanala-griboedova' },
      { name: 'Университетская набережная', desc: 'Сфинксы и вид на стрелку с ВО. Васильевский', mustSeeFilter: 'views', locationSlug: 'saint-petersburg-universitetskaya-naberezhnaya' },
      { name: 'Английская набережная', desc: 'Парадные особняки к западу от Сенатской. Адмиралтейская', mustSeeFilter: 'views', locationSlug: 'saint-petersburg-angliyskaya-naberezhnaya' },
      { name: 'Набережная реки Мойки', desc: 'Камерный маршрут дворцов и мостов. Центр', mustSeeFilter: 'views', locationSlug: 'saint-petersburg-naberezhnaya-reki-moyki' },
      { name: 'Набережная Фонтанки', desc: 'Длинный «городской» променад. Центр / Владимирский', mustSeeFilter: 'views', locationSlug: 'saint-petersburg-naberezhnaya-fontanki' },
      { name: 'Петроградская набережная', desc: 'Аврора и вид на Петропавловку. Петроградка', mustSeeFilter: 'views', locationSlug: 'saint-petersburg-petrogradskaya-naberezhnaya' },
      { name: 'Колоннада Исаакия', desc: 'Платная смотровая, лучший обзор крыш центра. Исаакий', mustSeeFilter: 'views' },
      { name: 'Смотровая Лахта Центра', desc: 'Современная высота и Финский залив. Лахта', mustSeeFilter: 'views', locationSlug: 'saint-petersburg-smotrovaya-lahta-tsentra' },
      { name: 'Приморский проспект / парк 300-летия', desc: 'Залив, закаты, небоскрёб в кадре. Приморский', mustSeeFilter: 'views' },
      { name: 'Троицкий мост', desc: 'Ракурс на крепость и ростральные колонны. Нева', mustSeeFilter: 'views', locationSlug: 'saint-petersburg-troitskiy-most' },
      { name: 'Улица Зодчего Росси', desc: 'Идеальная перспектива к Александринке. пл. Островского', mustSeeFilter: 'street', locationSlug: 'saint-petersburg-ulitsa-zodchego-rossi' },
      { name: 'Малая Садовая', desc: 'Короткий пешеходный «карман» у Невского. Центр', mustSeeFilter: 'street', locationSlug: 'saint-petersburg-malaya-sadovaya-ulitsa' },
      { name: 'Большая Морская', desc: 'Банки, особняки, тише Невского. Адмиралтейская', mustSeeFilter: 'street' },
      { name: 'Улица Рубинштейна', desc: 'Вечерняя жизнь и старый доходный фонд. Владимирская', mustSeeFilter: 'street', locationSlug: 'saint-petersburg-ulitsa-rubinshteyna' },
      { name: 'Коломна', desc: 'Тихие каналы и lit-маршрут «Пиковой дамы». Коломна', mustSeeFilter: 'street' },
      { name: 'Линии Васильевского острова', desc: 'Сетка дворов и быт «острова». ВО', mustSeeFilter: 'street', locationSlug: 'saint-petersburg-linii-vasilevskogo-ostrova' },
      ...
      { name: 'Лофт Проект Этажи', desc: 'Дворик, крыша и независимая культура. Лиговский', mustSeeFilter: 'street', locationSlug: 'saint-petersburg-loft-proekt-etazhi' },
      ...
      { name: 'Литературное кафе (Вольф и Беранже)', desc: 'Историческая кондитерская на Невском проспекте, где Александр Пушкин встретился со своим секундантом Данзасом перед роковой дуэлью на Черной речке.', mustSeeFilter: 'gastro', venueSlug: 'saint-petersburg-literaturnoe-kafe-volf-i-beranzhe' },
      ...
      { name: 'Арт-кафе «Бродячая собака»', desc: 'Исторический подвал на площади Искусств, бывший в начале XX века главным ночным клубом и трибуной для поэтов Серебряного века.', mustSeeFilter: 'gastro', venueSlug: 'saint-petersburg-art-kafe-brodyachaya-sobaka' },
      ...
      { name: 'Ресторан «Корюшка»', desc: 'Панорамный ресторан холдинга Ginza Project прямо у стен Петропавловской крепости, специализирующийся на приготовлении главного гастросимвола города круглый год.', mustSeeFilter: 'gastro', venueSlug: 'saint-petersburg-restoran-koryushka' },
      { name: 'Спикизи-бар «El Copitas»', desc: 'Скрытый во дворах Владимирской площади мексиканский бар без вывески, ставший легендой благодаря многократному попаданию в топ-50 лучших баров мира.', mustSeeFilter: 'gastro', venueSlug: 'saint-petersburg-spikizi-bar-el-copitas' },
    ...
    dayRoutePresets: [
      ...
      },
      {
        ...
        stops: [
          ...
          spbPresetStop('El Copitas', { dayRouteId: 'spb-el-copitas', latitude: 59.927114, longitude: 30.347112, venueSlug: 'saint-petersburg-spikizi-bar-el-copitas' }),
