...
} from './city-destination-registry';
import {
...
import {
  CHELYABINSK_DAY_ROUTE_PRESETS,
  CHELYABINSK_FAQ,
  CHELYABINSK_MUST_SEE,
  CHELYABINSK_SUBURBS,
  CHELYABINSK_TRAVEL,
} from './chelyabinsk-hub';
import {
  TYUMEN_DAY_ROUTE_PRESETS,
  TYUMEN_FAQ,
  TYUMEN_MUST_SEE,
  TYUMEN_SUBURBS,
  TYUMEN_TRAVEL,
...
import {
  ROSTOV_NA_DONU_DAY_ROUTE_PRESETS,
  ROSTOV_NA_DONU_FAQ,
  ROSTOV_NA_DONU_MUST_SEE,
  ROSTOV_NA_DONU_SUBURBS,
  ROSTOV_NA_DONU_TRAVEL,
} from './rostov-na-donu-hub';
import {
  PENZA_DAY_ROUTE_PRESETS,
  PENZA_FAQ,
  PENZA_MUST_SEE,
  PENZA_SUBURBS,
  PENZA_TRAVEL,
...
export type CityMustSeeItem = CityPlaceLinkFields & {
  ...
  mustSeeFilter?:
    ...
    | 'mansions';
  /**
   * Curated top-city anchor: show in «Главные места» too,
   * while preserving the primary thematic tab.
   */
  alsoMain?: boolean;
  themeTags?: string[];
  seasonLabel?: string;
...
export interface CityInfoEntry {
  ...
  hookFact?: string;
  /** Короткая практическая ремарка под фактом (CityBrief). */
  hookFactTip?: string;
...
export const CITY_INFO: Record<string, CityInfoEntry> = {
  'saint-petersburg': {
    ...
    faq: [
      {
        q: 'Как выгоднее всего оплачивать проезд в общественном транспорте Петербурга?',
        a: 'Для экономии на метро и наземном транспорте туристам рекомендуется сразу приобрести в кассе метрополитена пополняемую карту «Подорожник».',
      },
      {
        q: 'Смогу ли я перебраться на другой берег Невы ночью во время разводки мостов?',
        a: 'Да, но заложите время и бюджет. В черте города есть один абсолютно неразводной мост - Большой Обуховский (Вантовый) на КАД; такси из центра выйдет дорогим. Через центр работают «ночные окна»: Дворцовый, Благовещенский и Володарский обычно сводят обратно примерно на 15-20 минут (часто между 02:45 и 03:10). Полностью движение восстанавливается к утру около 05:00. Актуальный график лучше сверить перед поездкой.',
      },
      {
        q: 'Нужно ли покупать билеты в Эрмитаж заранее?',
        a: 'Чтобы гарантированно попасть в музей в высокий летний сезон и не стоять часами в кассах, билеты с фиксированным временем входа необходимо приобретать онлайн на официальном сайте.',
      },
      {
        q: 'Как работают знаменитые метеоры и куда на них можно уплыть?',
        a: 'Скоростные теплоходы «Метеор» на подводных крыльях - самый быстрый путь к Нижнему парку Петергофа или крепости Орешек в Шлиссельбурге. Они отправляются каждые 15-30 минут от центральных причалов у Эрмитажа и Сенатской площади. Сезон навигации - с мая по октябрь.',
      },
      {
        q: 'Как легально и безопасно попасть на крыши Петербурга?',
        a: 'Самостоятельные прогулки по закрытым чердакам опасны и незаконны. Для безопасной панорамы выбирайте легальные смотровые с настилами и ограждениями: колоннада Исаакиевского собора, крыша лофт-проекта «Этажи» или открытая терраса в Новой Голландии.',
      },
      {
        q: 'Что такое «Севкабель Порт» и «Новая Голландия» и как туда добраться?',
        a: 'Это главные креативные пространства на месте бывших заводов и военных складов. «Новая Голландия» - в центре, пешком от метро «Адмиралтейская». «Севкабель Порт» - на Васильевском острове у моря, удобнее автобусом от метро «Приморская». Внутри набережные, инди-бары, выставки и сильные закаты.',
      },
      {
        q: 'Как проще всего добраться из Петербурга в пригороды (Петергоф, Пушкин, Выборг)?',
        a: 'В Пушкин (Царское Село) и Павловск удобнее электричка от Витебского вокзала - около 30 минут. В Выборг ходит «Ласточка» с Финляндского вокзала - примерно 1 час 15 минут. В Петергоф, кроме метеоров по воде, ходят регулярные маршрутки от метро «Автово».',
      },
    ]
  },
  moscow: {
    ...
    faq: [
      {
        ...
        a: 'Самый быстрый и экономный способ - московское метро, МЦК и МЦД; для оплаты поездок лучше сразу взять карту «Тройка» и при желании записать безлимитный тариф на 1 или 3 суток.',
      },
      {
        q: 'Что такое МЦК и МЦД и можно ли по ним ездить по обычной карте «Тройка»?',
        a: 'МЦК и МЦД - наземное метро между районами города и ближним Подмосковьем. По ним ездят по «Тройке». Лайфхак: при пересадке с подземного метро на МЦК или МЦД в течение 90 минут с первого входа пересадка бесплатна.',
      },
      {
      ...
      {
        q: 'Как работает «Московская музейная неделя» и как попасть в музеи бесплатно?',
        a: 'Каждую третью неделю месяца главные музеи Москвы (более 40 площадок, включая музей Булгакова, Царицыно, Космонавтики) работают бесплатно. У каждого музея свой день бесплатного входа. Важно: бесплатный билет на конкретный сеанс всё равно оформляют заранее на сайте музея или на mos.ru.',
      },
      {
        q: 'Как быстрее всего и без пробок добраться из аэропортов в центр Москвы?',
        a: 'Надёжный вариант - «Аэроэкспресс» каждые 30-60 минут: Шереметьево - Белорусский, Домодедово - Павелецкий, Внуково - Киевский. В пути около 35-45 минут. До Внуково также есть прямая ветка метро (Солнцевская линия) по цене обычной поездки.',
      },
      {
        q: 'Стоит ли подниматься на смотровую площадку «Москва-Сити» и какую выбрать?',
        a: 'Да, это лучший способ увидеть хайтек-панораму столицы. Закрытая PANORAMA360 в башне «Федерация» (89 этаж) - с безлимитным мороженым и шоколадом «Чистая линия» в билете. Открытая High Accessibility на крыше «ОКО» (92 этаж) считается самой высокой открытой точкой в Европе. Бесплатные виды - также с Воробьёвых гор и парящего моста в «Зарядье».',
      },
      {
        q: 'Нужен ли билет, чтобы просто погулять по территории ВДНХ, Зарядья или Коломенского?',
        a: 'Нет: вход на территорию ВДНХ, парка «Зарядье», Парка Горького, усадеб Коломенское и Царицыно бесплатный. Билеты нужны только внутрь павильонов, музеев, оранжерей, аттракционов или платных смотровых.',
      },
    ],
  },
  kazan: {
  ...
  kaliningrad: {
    ...
    faq: [
      {
        q: 'Правда ли, что билеты на органные концерты в Кафедральном соборе нужно покупать сильно заранее?',
        a: 'Да, особенно на дневные мини-концерты. Под сводами собора на острове Канта - самый большой органный комплекс в России. Концерты идут ежедневно, но удобные слоты часто разбирают за 2-4 дня. Электронный билет можно взять в афише Дайбилет.',
      },
      {
        q: 'Кто такие хомлины, сколько их и где их искать?',
        a: 'Хомлины - семь крошечных бронзовых фигурок-хранителей по центру города. Дедушка Карл сидит на Медовом мосту, бабушка Марта - у Музея янтаря, малыш Витек - в бумажном кораблике у Музея Мирового океана. Карту всех семи бесплатно дают в инфоцентре.',
      },
      {
        q: 'Что такое клопсы и где их попробовать?',
        a: 'Калининградские клопсы - восточнопрусские мясные тефтели в белом соусе с каперсами. Их подают почти во всех ресторанах немецкой и балтийской кухни города.',
      },
      {
        q: 'Как проще и дешевле всего добраться из Калининграда на Куршскую косу?',
        a: 'Бюджетный вариант - прямой автобус № 593 от Южного автовокзала или автобусы из Зеленоградска (№ 210, 596). Компанией выгоднее каршеринг или такси. Важно: при въезде на косу на любом транспорте, кроме рейсового автобуса, берут экологический сбор с человека и автомобиля.',
      },
      {
        q: 'В какой приморский город уехать за лучшим пляжем и променадом?',
        a: 'За тишиной и широким песчаным пляжем с «Голубым флагом» - в Янтарный. За оживлённым променадом, курортной архитектурой и стритфудом - в Зеленоградск или Светлогорск. До всех городов ходят «Ласточки».',
      },
      {
        q: 'Пустят ли меня в Калининград по обычному российскому паспорту и нужен ли загранпаспорт?',
        a: 'На самолёте достаточно паспорта гражданина РФ: рейс идёт над нейтральными водами, визы не нужны. Загранпаспорт и шенген (или УПД-ЖД) потребуются только если едете поездом через Литву.',
      },
    ]
  },
  vladimir: {
...
'Официальная столица Золотого кольца - великолепный тысячелетний город на Волге, чей исторический центр целиком включен в список всемирного наследия ЮНЕСКО. Город уникальных изразцовых церквей XVII века, красивейшей Стрелки и старейшего драматического театра страны.',
    ...
    mustSee: YAROSLAVL_MUST_SEE as CityMustSeeItem[],
    significantSuburbs: YAROSLAVL_SUBURBS as CitySuburbItem[],
    dayRoutePresets: YAROSLAVL_DAY_ROUTE_PRESETS as CityDayRoutePreset[],
    travel: YAROSLAVL_TRAVEL,
    faq: YAROSLAVL_FAQ,
  },
  ekaterinburg: {
    brief:
  ...
  'nizhny-novgorod': {
    ...
    mustSee: [
      ...
      { name: 'Набережная Фёдоровского', desc: 'Лучшая смотровая площадка города с благоустроенными террасами для встречи закатов',
        locationSlug: 'nizhny-novgorod-naberezhnaya-fedorovskogo', mustSeeFilter: 'views', visitMinutes: 90,
        latitude: 56.326887,
        longitude: 43.980644,
      },
      { name: 'Нижегородская ярмарка', desc: 'Главный ярмарочный дом - символ купеческого Нижнего', locationSlug: 'nizhny-novgorod-nizhegorodskaya-yarmarka', mustSeeFilter: 'main', visitMinutes: 60 , latitude: 56.3275, longitude: 43.962222 },
      { name: 'Усадьба Рукавишниковых', desc: 'Купеческий дворец-музей на Верхне-Волжской', locationSlug: 'nizhny-novgorod-usadba-rukavishnikovyh', mustSeeFilter: 'museum', visitMinutes: '1-2 ч' , latitude: 56.329864, longitude: 44.017772 },
      { name: 'Государственный банк', desc: 'Сказочный терем неорусского стиля на Покровке', locationSlug: 'nizhny-novgorod-gosudarstvennyy-bank', mustSeeFilter: 'houses', visitMinutes: 20 , latitude: 56.322301, longitude: 44.002875 },
      { name: 'Площадь Минина и Пожарского', desc: 'Сердце города у стен Кремля', locationSlug: 'nizhny-novgorod-ploschad-minina-i-pozharskogo', mustSeeFilter: 'main', visitMinutes: 20 , latitude: 56.326759, longitude: 44.00624 },
      { name: 'Палаты Строгановых', desc: 'Белокаменные купеческие палаты XVII века', locationSlug: 'nizhny-novgorod-palaty-stroganovyh', mustSeeFilter: 'houses', visitMinutes: 30 , latitude: 56.327521, longitude: 43.985906 },
      { name: 'Ромодановский вокзал', desc: 'Возрожденный вокзал у Оки', locationSlug: 'nizhny-novgorod-romodanovskiy-vokzal', mustSeeFilter: 'houses', visitMinutes: 20 , latitude: 56.32174, longitude: 43.97825 },
      { name: 'Площадь Лядова', desc: 'Исторический транспортный узел', locationSlug: 'nizhny-novgorod-ploschad-lyadova', mustSeeFilter: 'main', visitMinutes: 15 , latitude: 56.312953, longitude: 43.987786 },
      { name: 'Домик Петра I', desc: 'Палаты купца Чатыгина XVII века', locationSlug: 'nizhny-novgorod-domik-petra-i', mustSeeFilter: 'museum', visitMinutes: 60 , latitude: 56.326269, longitude: 43.999658 },
      { name: 'Нижне-Волжская набережная', desc: 'Главный променад у воды', locationSlug: 'nizhny-novgorod-nizhne-volzhskaya-naberezhnaya', mustSeeFilter: 'views', visitMinutes: 40 , latitude: 56.330441, longitude: 43.996112 },
      { name: 'Верхне-Волжская набережная', desc: 'Аристократический променад над Волгой', locationSlug: 'nizhny-novgorod-verhne-volzhskaya-naberezhnaya', mustSeeFilter: 'views', visitMinutes: 45 , latitude: 56.331601, longitude: 44.010651 },
      { name: 'Рождественская улица', desc: 'Гастрономический и исторический квартал', locationSlug: 'nizhny-novgorod-rozhdestvenskaya-ulitsa', mustSeeFilter: 'street', visitMinutes: 60 , latitude: 56.328328, longitude: 43.990471 },
      { name: 'Парк «Швейцария»', desc: 'Самый большой зеленый парк города', locationSlug: 'nizhny-novgorod-park-shveytsariya', mustSeeFilter: 'park', visitMinutes: '1-2 ч' , latitude: 56.279883, longitude: 43.978183 },
      { name: 'Сормовский парк', desc: 'Сосновый бор, аттракционы и озера', locationSlug: 'nizhny-novgorod-sormovskiy-park', mustSeeFilter: 'park', visitMinutes: '1-2 ч' , latitude: 56.277744, longitude: 43.974052 },
      { name: 'Почаинский бульвар', desc: 'Тихий променад над оврагом', locationSlug: 'nizhny-novgorod-pochainskiy-bulvar', mustSeeFilter: 'views', visitMinutes: 45 , latitude: 56.326305, longitude: 43.997233 },
      { name: 'Александровский сад', desc: 'Исторический парк на склоне', locationSlug: 'nizhny-novgorod-aleksandrovskiy-sad', mustSeeFilter: 'park', visitMinutes: 60 , latitude: 56.330556, longitude: 44.022222 },
      { name: 'Пакгаузы на Стрелке', desc: 'Индустриальная архитектура и концертный зал', locationSlug: 'nizhny-novgorod-pakgauzy-na-strelke', mustSeeFilter: 'creative', visitMinutes: 60 , latitude: 56.328133, longitude: 44.025337 },
      { name: 'Щёлоковский хутор', desc: 'Заповедный лес и три озера', locationSlug: 'nizhny-novgorod-schelokovskiy-hutor', mustSeeFilter: 'park', visitMinutes: '1-2 ч' , latitude: 56.280145, longitude: 44.032644 },
      { name: 'Собор Александра Невского', desc: 'Грандиозный храм у слияния рек', locationSlug: 'nizhny-novgorod-sobor-aleksandra-nevskogo', mustSeeFilter: 'temple', visitMinutes: 30 , latitude: 56.333019, longitude: 43.975412 },
      { name: 'Строгановская церковь', desc: 'Вершина русского барокко', locationSlug: 'nizhny-novgorod-stroganovskaya-tserkov', mustSeeFilter: 'temple', visitMinutes: 30 , latitude: 56.333695, longitude: 43.971411 },
      { name: 'Печерский монастырь', desc: 'Древняя обитель с наклонной колокольней', locationSlug: 'nizhny-novgorod-pecherskiy-monastyr', mustSeeFilter: 'temple', visitMinutes: 45 , latitude: 56.322964, longitude: 44.050419 },
      { name: 'Благовещенский монастырь', desc: 'Древнейшая обитель Поволжья', locationSlug: 'nizhny-novgorod-blagoveschenskiy-monastyr', mustSeeFilter: 'temple', visitMinutes: 45 , latitude: 56.323136, longitude: 44.049347 },
      { name: 'Михайло-Архангельский собор', desc: 'Древнейший храм Кремля', locationSlug: 'nizhny-novgorod-mihailo-arhangelskiy-sobor', mustSeeFilter: 'temple', visitMinutes: 30 , latitude: 56.328461, longitude: 44.002241 },
      { name: 'Староярмарочный собор', desc: 'Классический шедевр Монферрана', locationSlug: 'nizhny-novgorod-staroyarmarochnyy-sobor', mustSeeFilter: 'temple', visitMinutes: 30 , latitude: 56.333333, longitude: 43.961944 },
      { name: 'Арсенал ГЦСИ', desc: 'Центр современного искусства в Кремле', venueSlug: 'nizhny-novgorod-arsenal-gtsisi', mustSeeFilter: 'museum', visitMinutes: '1-2 ч' , latitude: 56.331403, longitude: 43.953977 },
      { name: 'Музей истории ГАЗ', desc: 'Легендарные советские автомобили', venueSlug: 'nizhny-novgorod-muzey-istorii-gaz', mustSeeFilter: 'museum', visitMinutes: 90 , latitude: 56.251919, longitude: 43.890692 },
      { name: 'Домик Каширина', desc: 'Музей детства Максима Горького', venueSlug: 'nizhny-novgorod-domik-kashirina', mustSeeFilter: 'museum', visitMinutes: 60 , latitude: 56.326317, longitude: 43.993742 },
      ...
      { name: 'Yale', desc: 'Высокая кухня в усадьбе XIX века', venueSlug: 'nizhny-novgorod-yale-restaurant', mustSeeFilter: 'gastro', visitMinutes: 60 , latitude: 56.326884, longitude: 43.984534 },
      { name: 'Red Wall', desc: 'Гастрономия у подножия Кремля', venueSlug: 'nizhny-novgorod-red-wall-restaurant', mustSeeFilter: 'gastro', visitMinutes: 60 , latitude: 56.330312, longitude: 43.99845 },
      { name: 'Пяткинъ', desc: 'Купеческий обед в старинной усадьбе', venueSlug: 'nizhny-novgorod-pyatkin-traktir', mustSeeFilter: 'gastro', visitMinutes: 60 , latitude: 56.327645, longitude: 43.986259 },
      { name: 'Mitrich', desc: 'Стейкхаус премиум-класса', venueSlug: 'nizhny-novgorod-mitrich-restaurant', mustSeeFilter: 'gastro', visitMinutes: 90 , latitude: 56.324541, longitude: 44.020114 },
      { name: 'РИБС', desc: 'Стейки и волжская рыба на Семашко', venueSlug: 'nizhny-novgorod-ribs-restaurant', mustSeeFilter: 'gastro', visitMinutes: 90 , latitude: 56.329499, longitude: 43.992368 },
      { name: 'Медные Трубы', desc: 'Секретный камерный коктейльный бар на Суетинской', venueSlug: 'nizhny-novgorod-mednye-truby-bar', mustSeeFilter: 'gastro', visitMinutes: 60 , latitude: 56.326102, longitude: 43.983115 },
      { name: 'Юла Pizza', desc: 'Неаполитанская пицца во дворе Покровки', venueSlug: 'nizhny-novgorod-yula-pizza', mustSeeFilter: 'gastro', visitMinutes: 60 , latitude: 56.322998, longitude: 44.004512 },
      { name: 'Фонотека', desc: 'Арт-бар с винилом и уличным артом на Большой Покровской', venueSlug: 'nizhny-novgorod-fonoteca-bar', mustSeeFilter: 'gastro', visitMinutes: 40 , latitude: 56.32181, longitude: 44.002143 },
      {
    ...
    faq: [
      {
        q: 'Правда ли, что Нижегородский кремль можно обойти целиком по стене?',
        a: 'Да, это единственный кремль в России, у которого полностью сохранился и доступен для туристов сквозной круговой пешеходный маршрут по боевому ходу стены протяженностью более 2 километров.',
      },
      {
        q: 'Как работает знаменитая Нижегородская канатная дорога?',
        a: 'Она связывает Нижний Новгород с городом-спутником Бор через Волгу, выполняя роль общественного транспорта, и одновременно служит популярным аттракционом с панорамными видами.',
      },
      {
        q: 'Сколько ступеней на Чкаловской лестнице и сложно ли по ней подняться?',
        a: 'Лестница насчитывает 560 ступеней в виде гигантской восьмерки; неспешный подъём от набережной к памятнику Чкалову занимает около 10-15 минут и требует базовой физической формы.',
      },
      {
        q: 'Где в Нижнем Новгороде лучше всего встречать те самые закаты?',
        a: 'Официально лучшие точки с амфитеатрами и панорамой - Набережная Федоровского и площадь у памятника Чкалову. Для заката у воды выбирайте Нижне-Волжскую набережную или Стрелку у Пакгаузов, где солнце садится прямо в слияние Волги и Оки.',
      },
      {
        q: 'Как найти знаменитый нижегородский стрит-арт и деревянные кварталы?',
        a: 'Главный эпицентр деревянного зодчества и легального уличного искусства - Квартал Трёх Святителей (улицы Новая, Короленко, Славянская). Секретные дворы с муралами часто спрятаны за фасадами Большой Покровской и Рождественской - просто сворачивайте в арки.',
      },
      {
        q: 'Что такое Пакгаузы на Стрелке и как туда попасть?',
        a: 'Это ажурные металлические каркасы XIX века с перенесённой в Нижний всероссийской выставки. Сейчас внутри - современный концертный зал и стеклянная галерея. Попасть можно по билетам на концерты классики или текущие выставки современного искусства.',
      },
      {
        q: 'Работает ли речной вокзал и как покататься на теплоходе по Волге?',
        a: 'Да: прогулочные теплоходы и скоростные «Валдаи» отходят от причалов на Нижне-Волжской набережной рядом с Речным вокзалом. Билеты на обычные 1,5-часовые экскурсии или вечерние рейсы с живой музыкой под закат ищите в афише Дайбилет.',
      },
      {
        q: 'Какую шаверму в Нижнем все называют легендарной и где её искать?',
        a: '«Шаверма на Средном» (ул. Костина, 13) - гастро-феномен города: огромная сытная порция по секретному рецепту, ради которой стоят в круглосуточной очереди. Вторая культовая точка - купеческие пирожки на Рождественской.',
      },
    ]
  },
  novosibirsk: {
  ...
  tula: {
    ...
    hookFact:
      'Знаете ли вы, что в Туле выпекают самый большой печатный пряник в мире? Местные кондитеры попали в Книгу рекордов, создав пряничного гиганта весом рекордные 143 килограмма и длиной почти три метра.',
    mustSee: TULA_MUST_SEE as CityMustSeeItem[],
    significantSuburbs: TULA_SUBURBS as CitySuburbItem[],
    dayRoutePresets: TULA_DAY_ROUTE_PRESETS as CityDayRoutePreset[],
    travel: TULA_TRAVEL,
    faq: TULA_FAQ,
  },
  samara: {
  ...
  omsk: {
    ...
    hookFact:
      'Знаете ли вы, что Федор Достоевский провел в Омском остроге четыре года каторги? Именно этот суровый сибирский опыт лег в основу его знаменитого романа «Записки из Мертвого дома», полностью изменив писателя.',
    mustSee: OMSK_MUST_SEE as CityMustSeeItem[],
    significantSuburbs: OMSK_SUBURBS as CitySuburbItem[],
    dayRoutePresets: OMSK_DAY_ROUTE_PRESETS as CityDayRoutePreset[],
    travel: OMSK_TRAVEL,
    faq: OMSK_FAQ,
  },
  ufa: {
    ...
    mustSee: UFA_MUST_SEE as CityMustSeeItem[],
    significantSuburbs: UFA_SUBURBS as CitySuburbItem[],
    dayRoutePresets: UFA_DAY_ROUTE_PRESETS as CityDayRoutePreset[],
    travel: UFA_TRAVEL,
    faq: UFA_FAQ,
  },
  'veliky-novgorod': {
  ...
  tver: {
    brief:
      'Старинный город на Волге между Москвой и Петербургом: императорский трезубец улиц, Путевой дворец и купеческий фасад, который веками спорил со столицей за масштаб.',
    hookFact:
      'Именно тверской купец Афанасий Никитин совершил «хождение за три моря» и описал Индию примерно за 25 лет до Васко да Гамы.',
    mustSee: TVER_MUST_SEE as CityMustSeeItem[],
    significantSuburbs: TVER_SUBURBS as CitySuburbItem[],
    dayRoutePresets: TVER_DAY_ROUTE_PRESETS as CityDayRoutePreset[],
    travel: TVER_TRAVEL,
    faq: TVER_FAQ,
  },
  krasnodar: {
...
'Главный курортный локомотив страны, где субтропические пальмы и теплое Черное море соседствуют с заснеженными вершинами Кавказских гор. Город олимпийского триумфа, грандиозных развлечений, сочных хачапури и вечного лета.',
    ...
    mustSee: SOCHI_MUST_SEE as CityMustSeeItem[],
    significantSuburbs: SOCHI_SUBURBS as CitySuburbItem[],
    dayRoutePresets: SOCHI_DAY_ROUTE_PRESETS as CityDayRoutePreset[],
    travel: SOCHI_TRAVEL,
    faq: SOCHI_FAQ,
  },
  tyumen: {
    ...
    mustSee: TYUMEN_MUST_SEE as CityMustSeeItem[],
    significantSuburbs: TYUMEN_SUBURBS as CitySuburbItem[],
    dayRoutePresets: TYUMEN_DAY_ROUTE_PRESETS as CityDayRoutePreset[],
    travel: TYUMEN_TRAVEL,
    faq: TYUMEN_FAQ,
  },
  voronezh: {
    brief:
    ...
    mustSee: VORONEZH_MUST_SEE as CityMustSeeItem[],
    significantSuburbs: VORONEZH_SUBURBS as CitySuburbItem[],
    dayRoutePresets: VORONEZH_DAY_ROUTE_PRESETS as CityDayRoutePreset[],
    travel: VORONEZH_TRAVEL,
    faq: VORONEZH_FAQ,
  },
  'rostov-na-donu': {
    brief:
      'Харизматичная южная столица с донской набережной, купеческими фасадами, сильной гастро-сценой и одним из главных памятников конструктивизма в России.',
    hookFact:
      'Ростовский театр драмы имени Горького построен в виде гигантского гусеничного трактора. Его макет хранится в Британском музее как эталон авангардной архитектуры XX века.',
    mustSee: ROSTOV_NA_DONU_MUST_SEE as CityMustSeeItem[],
    significantSuburbs: ROSTOV_NA_DONU_SUBURBS as CitySuburbItem[],
    dayRoutePresets: ROSTOV_NA_DONU_DAY_ROUTE_PRESETS as CityDayRoutePreset[],
    travel: ROSTOV_NA_DONU_TRAVEL,
    faq: ROSTOV_NA_DONU_FAQ,
  },
  vladivostok: {
    brief:
  ...
  perm: {
    ...
    hookFact:
      'Пермь - родина «реальных пацанов», но местный Театр оперы и балета считается одним из лучших в России, а пермская балетная школа ценится наравне с петербургской.',
    ...
    mustSee: [
      ...
      { name: 'Музей истории Мотовилихинских заводов', desc: 'Промышленная история Мотовилихи и оружейного производства: Царь-пушка, «Смерч» и открытая экспозиция техники.', address: 'ул. 1905 года, 20', venueSlug: 'perm-muzey-motovilihinskih-zavodov', mustSeeFilter: 'museum', visitMinutes: 90, latitude: 58.0339, longitude: 56.3155 },
      { name: 'Пермский музей кукол', desc: 'Тысячи кукол от антикварного фарфора до театральных и авторских работ.', address: 'ул. Пермская, 82А', venueSlug: 'perm-muzey-kukol', mustSeeFilter: 'museum', visitMinutes: 60, latitude: 58.0109, longitude: 56.2426 },
      { name: 'Музей истории связи', desc: 'Телеграф, дисковые телефоны и коммутаторы, которые можно трогать руками.', address: 'ул. Крупской, 2', venueSlug: 'perm-muzey-istorii-svyazi', mustSeeFilter: 'museum', visitMinutes: 45, latitude: 58.0232, longitude: 56.2711 },
      { name: 'Музей истории Пермского университета', desc: 'Египетские мумии и античные вазы в научной коллекции Пермского университета.', address: 'ул. Букирева, 15', venueSlug: 'perm-muzey-istorii-pgniu', mustSeeFilter: 'museum', visitMinutes: 45, latitude: 58.0086, longitude: 56.1878 },
      { name: 'Музей-диорама на горе Вышка', desc: 'Панорама Мотовилихи и диорама боевых действий Гражданской войны.', address: 'ул. Огородникова, 2', venueSlug: 'perm-muzey-diorama-vyshka', mustSeeFilter: 'museum', visitMinutes: 45, latitude: 58.0345, longitude: 56.3216 },
      { name: 'Центр городской культуры (ЦГК)', desc: 'Главное независимое пространство: выставки, лекции, кино и маркеты.', address: 'ул. Пушкина, 15', venueSlug: 'perm-cgk', mustSeeFilter: 'creative', visitMinutes: 60, latitude: 58.0108, longitude: 56.2494 },
      { name: 'Частная галерея «Марис-Арт»', desc: 'Камерная галерея: живопись, графика и скульптура мастеров Урала.', address: 'ул. Восстания, 35', venueSlug: 'perm-maris-art', mustSeeFilter: 'museum', visitMinutes: 30, latitude: 58.0305, longitude: 56.3023 },
      { name: 'Галерея «25\'17»', desc: 'Современная выставочная площадка: персональные и сборные экспозиции, аукционы.', address: 'ул. 25-го Октября, 17', venueSlug: 'perm-galereya-2517', mustSeeFilter: 'museum', visitMinutes: 30, latitude: 58.0138, longitude: 56.2497 },
      { name: 'Парк науки «НьюТон»', desc: 'Интерактивный научно-развлекательный центр для семьи.', address: 'ул. Чернышевского, 28', venueSlug: 'perm-park-nauki-nyuton', mustSeeFilter: 'science', visitMinutes: 120, latitude: 57.9995, longitude: 56.2625 },
      { name: 'Завод Шпагина', desc: 'Бывший метизно-ремонтный завод - главный фестивальный кластер Перми.', address: 'ул. Советская, 1Б', locationSlug: 'perm-zavod-shpagina', mustSeeFilter: 'creative', visitMinutes: 60, latitude: 58.0202, longitude: 56.2554 },
...
'Старинный купеческий город на Волге с богатейшей музыкальной и театральной историей, славящийся своей консерваторией, похожей на средневековый замок. Место, где узкие исторические улочки круто спускаются к реке, открывая вид на один из самых длинных мостов Европы.',
    ...
    mustSee: SARATOV_MUST_SEE as CityMustSeeItem[],
    significantSuburbs: SARATOV_SUBURBS as CitySuburbItem[],
    dayRoutePresets: SARATOV_DAY_ROUTE_PRESETS as CityDayRoutePreset[],
    travel: SARATOV_TRAVEL,
    faq: SARATOV_FAQ,
  },
  'ulan-ude': {
    brief:
  ...
  chelyabinsk: {
    brief:
      'Уральский мегаполис железного характера: космический бренд метеорита 2013 года, Танкоград и купеческая Кировка. Индустриальный авангард соседствует с пельменями трех мяс и выездами на Таганай.',
    hookFact:
      'Знаете ли вы, что в 2013 году Челябинск стал единственным мегаполисом в современной истории, который принял удар настоящего космического пришельца? Крупнейший осколок весом больше 500 кг хранится в Историческом музее Южного Урала.',
    mustSee: CHELYABINSK_MUST_SEE as CityMustSeeItem[],
    significantSuburbs: CHELYABINSK_SUBURBS as CitySuburbItem[],
    dayRoutePresets: CHELYABINSK_DAY_ROUTE_PRESETS as CityDayRoutePreset[],
    travel: CHELYABINSK_TRAVEL,
    faq: CHELYABINSK_FAQ,
  },
  ryazan: {
    brief:
    ...
    hookFact:
      'А вы знали, откуда пошла знаменитая поговорка «А в Рязани - грибы с глазами: их едят, они глядят»? В древности рязанские пограничники по срезанным или сбитым грибам в приграничных лесах узнавали следы разведчиков: грибы служили метками на тропах, будто «глядели» на врага.',
    mustSee: RYAZAN_MUST_SEE as CityMustSeeItem[],
    significantSuburbs: RYAZAN_SUBURBS as CitySuburbItem[],
    dayRoutePresets: RYAZAN_DAY_ROUTE_PRESETS as CityDayRoutePreset[],
    travel: RYAZAN_TRAVEL,
    faq: RYAZAN_FAQ,
  },
  stavropol: {
    brief:
  ...
  penza: {
    brief:
      'Зеленый и литературный город в Поволжье с тихим губернским центром, сильным театральным наследием и редким набором нестоличных музеев.',
    hookFact:
      'Пенза считает себя родиной русского стационарного цирка: именно здесь в 1873 году братья Никитины открыли первый постоянный цирк в Российской империи.',
    mustSee: PENZA_MUST_SEE as CityMustSeeItem[],
    significantSuburbs: PENZA_SUBURBS as CitySuburbItem[],
    dayRoutePresets: PENZA_DAY_ROUTE_PRESETS as CityDayRoutePreset[],
    travel: PENZA_TRAVEL,
    faq: PENZA_FAQ,
  },
  volgograd: {
...
'Великий и монументальный город-герой, растянувшийся почти на 100 километров вдоль Волги. Место грандиозных исторических событий, где каждый мемориал и каждая улица пропитаны памятью о величайшем переломе в истории Второй мировой войны.',
    ...
    mustSee: VOLGOGRAD_MUST_SEE as CityMustSeeItem[],
    significantSuburbs: VOLGOGRAD_SUBURBS as CitySuburbItem[],
    dayRoutePresets: VOLGOGRAD_DAY_ROUTE_PRESETS as CityDayRoutePreset[],
    travel: VOLGOGRAD_TRAVEL,
    faq: VOLGOGRAD_FAQ,
  },
  smolensk: {
    brief:
    ...
    hookFact:
      'Знаете ли вы, что Смоленская крепостная стена - это самая большая кирпичная крепость в мире, сохранившаяся до наших дней? Борис Годунов ласково называл её «ожерельем всея Руси», а её стены протяженностью изначально 6,5 км строила буквально вся страна.',
    mustSee: SMOLENSK_MUST_SEE as CityMustSeeItem[],
    significantSuburbs: SMOLENSK_SUBURBS as CitySuburbItem[],
    dayRoutePresets: SMOLENSK_DAY_ROUTE_PRESETS as CityDayRoutePreset[],
    sights: [
      { title: 'Смоленская крепостная стена', text: 'Грандиозное оборонительное сооружение начала XVII века, за свой масштаб названное Борисом Годуновым «ожерельем всея Руси».' },
      { title: 'Свято-Успенский кафедральный собор', text: 'Величественный храм на Соборной горе, переживший войны и хранящий Смоленскую икону Божией Матери.' },
      { title: 'Громовая башня', text: 'Одна из лучших отреставрированных башен крепости с военно-исторической экспозицией.' },
      { title: 'Лопатинский сад', text: 'Старейший парк внутри оборонительного рва с Королевским бастионом и прудом.' },
      { title: 'Памятник «Благодарная Россия героям 1812 года»', text: 'Монумент с орлами в сквере Памяти Героев - символ смоленского мужества.' },
      { title: 'Историко-архитектурный комплекс «Теремок» (Флёново)', text: 'Усадьба Тенишевой со сказочным «Теремком» и мозаиками Рериха.' },
    ],
    travel: SMOLENSK_TRAVEL,
    faq: SMOLENSK_FAQ,
  },
  syktyvkar: {
    brief:
  ...
  barnaul: {
    brief:
      'Крупный сибирский центр, основанный как секретный горнозаводской поселок во времена императрицы Елизаветы. Сегодня город манит туристов сибирской деревянной архитектурой, уютным старым центром и статусом главных «ворот» к ледникам Алтая.',
    hookFact:
      'Знаете ли вы, что в XIX веке Барнаул называли «Сибирским Эльдорадо»? На местном заводе выплавляли 90% всего серебра Российской империи, из которого чеканили монеты для царской казны.',
    mustSee: BARNAUL_MUST_SEE as CityMustSeeItem[],
    significantSuburbs: BARNAUL_SUBURBS as CitySuburbItem[],
    dayRoutePresets: BARNAUL_DAY_ROUTE_PRESETS as CityDayRoutePreset[],
    sights: [
      { title: 'Нагорный парк и буквы «БАРНАУЛ»', text: 'Смотровая доминанта на холме у слияния Оби и Барнаулки с белыми буквами и храмом Иоанна Предтечи.' },
      { title: 'Мало-Тобольская улица (Барнаульский Арбат)', text: 'Первая полностью пешеходная улица города с купеческими рядами и деревянным Медведем.' },
      { title: 'Комплекс Сереброплавильного завода', text: 'Памятник промышленной архитектуры Демидова XVIII века - колыбель барнаульского серебра.' },
      { title: 'Туристический центр «Горная аптека»', text: 'Музей аптечного дела 1793 года с винтажной лабораторией и рестораном сибирской кухни.' },
      { title: 'Реликтовый Ленточный бор', text: 'Уникальный сосновый массив прямо в черте города - лыжня зимой и веломаршруты летом.' },
      { title: 'Художественный музей Алтайского края', text: 'Крупнейшая сокровищница изобразительного искусства региона с классикой и старинной иконой.' },
    ],
...
applyDestinationRegistryToCityInfo(CITY_INFO);
