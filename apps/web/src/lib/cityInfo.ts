...
export const CITY_INFO: Record<string, CityInfoEntry> = {
  'saint-petersburg': {
    ...
    mustSee: [
      ...
      { name: 'Русский музей', desc: 'Главное собрание русского искусства в Михайловском дворце.', mustSeeFilter: 'museum', venueSlug: 'saint-petersburg-russkiy-muzey' },
      ...
      { name: 'Кунсткамера', desc: 'Петровский кабинет редкостей и глобус.', mustSeeFilter: 'museum', locationSlug: 'saint-petersburg-kunstkamera' },
      ...
      { name: 'Юсуповский дворец', desc: 'Один из самых пышных частных дворцов Петербурга, известный парадными интерьерами и легендой о Распутине.', mustSeeFilter: 'museum', locationSlug: 'saint-petersburg-yusupovskiy-dvorets' },
      ...
      { name: 'Дворцовая набережная', desc: 'Фасад Зимнего и зеркало Невы.', mustSeeFilter: 'views', locationSlug: 'saint-petersburg-dvortsovaya-naberezhnaya' },
      ...
      { name: 'Английская набережная', desc: 'Парадные особняки к западу от Сенатской.', mustSeeFilter: 'views', locationSlug: 'saint-petersburg-angliyskaya-naberezhnaya' },
      ...
      { name: 'Набережная Фонтанки', desc: 'Длинный «городской» променад.', mustSeeFilter: 'views', locationSlug: 'saint-petersburg-naberezhnaya-fontanki' },
      ...
      { name: 'Колоннада Исаакия', desc: 'Платная смотровая, лучший обзор крыш центра.', mustSeeFilter: 'views', locationSlug: 'saint-petersburg-kolonnada-isaakiya' },
      ...
      { name: 'Линии Васильевского острова', desc: 'Сетка дворов и быт «острова».', mustSeeFilter: 'street', locationSlug: 'saint-petersburg-linii-vasilevskogo-ostrova' },
      ...
      { name: 'Летний сад', desc: 'Старейший регулярный ансамбль города, заложенный Петром I, со знаменитой кованой решеткой Фельтена, фонтанами и венецианскими мраморными статуями.', mustSeeFilter: 'park', locationSlug: 'saint-petersburg-letniy-sad' },
      { name: 'Михайловский сад', desc: 'Уникальный парк-трансформер, сочетающий черты строгого французского и пейзажного английского садоводства.', mustSeeFilter: 'park', locationSlug: 'saint-petersburg-mihaylovskiy-sad' },
      ...
      { name: 'Таврический сад', desc: 'Исторический парк вокруг резиденции Потемкина со знаменитой кирпичной теплой оранжереей.', mustSeeFilter: 'park', locationSlug: 'saint-petersburg-tavricheskiy-sad' },
      ...
      { name: 'Марсово поле', desc: 'Бывший военный плац и «Петербургская Сахара», ставшая сквером с парком сирени и первым в СССР мемориалом с Вечным огнем.', mustSeeFilter: 'park', locationSlug: 'saint-petersburg-marsovo-pole' },
      { name: 'Юсуповский сад', desc: 'Небольшой парк с извилистыми прудами, ставший колыбелью и школой советского фигурного катания.', mustSeeFilter: 'park', locationSlug: 'saint-petersburg-yusupovskiy-sad' },
      ...
      { name: 'Александровский парк', desc: 'Первый публичный парк города, проложенный на месте гласиса Петропавловской крепости.', mustSeeFilter: 'park', locationSlug: 'saint-petersburg-aleksandrovskiy-park' },
      { name: 'Смольный собор', desc: 'Праздничный бело-голубой шедевр барокко работы Франческо Бартоломео Растрелли с колокольней, служащей самой высокой обзорной точкой центра.', mustSeeFilter: 'temple', locationSlug: 'saint-petersburg-smolnyy-sobor' },
      { name: 'Александро-Невская лавра', desc: 'Первый и крупнейший мужской монастырь города, основанный Петром Великим, с историческими некрополями мастеров искусств.', mustSeeFilter: 'temple', locationSlug: 'saint-petersburg-aleksandro-nevskaya-lavra' },
      { name: 'Николо-Богоявленский морской собор', desc: 'Изящный двухэтажный барочный храм в Коломне, традиционное место молебнов и памяти российских моряков.', mustSeeFilter: 'temple', locationSlug: 'saint-petersburg-nikolo-bogoyavlenskiy-morskoy-sobor' },
      { name: 'Владимирский собор', desc: 'Барочно-классический собор, постоянным прихожанином которого в конце жизни был Ф. М. Достоевский.', mustSeeFilter: 'temple', locationSlug: 'saint-petersburg-vladimirskiy-sobor' },
      { name: 'Чесменская церковь', desc: 'Уникальный розовый «пряничный» храм в стиле ложной готики, построенный в честь морской победы над турками.', mustSeeFilter: 'temple' , themeTags: ['Неоготика и псевдоготика'], locationSlug: 'saint-petersburg-chesmenskaya-tserkov'},
      ...
      { name: 'Гранд Макет Россия', desc: 'Гигантский интерактивный шоу-макет всей страны в масштабе 1:87, где на площади 800 кв. м живут тысячи крошечных персонажей и циклично меняются день и ночь.', mustSeeFilter: 'science', locationSlug: 'saint-petersburg-grand-maket-rossiya' },
      { name: 'Петровская Акватория', desc: 'Большой исторический макет Петербурга и его пригородов XVIII века, воссозданный по архивным чертежам, с настоящей водной системой, по которой ходят миниатюрные корабли.', mustSeeFilter: 'science', locationSlug: 'saint-petersburg-petrovskaya-akvatoriya' },
      { name: 'Музей Железных Дорог России', desc: 'Масштабный европейский хаб с поворотным кругом и подлинными дореволюционными паровозами.', mustSeeFilter: 'science', locationSlug: 'saint-petersburg-muzey-zheleznyh-dorog-rossii' },
      { name: 'Планетарий №1', desc: 'Проекционный купол диаметром 37 метров, вмонтированный внутрь огромного кирпичного газгольдера XIX века.', mustSeeFilter: 'science' },
      ...
      { name: 'Витебский вокзал', desc: 'Шедевр стиля модерн с коваными дебаркадерами и старинными интерьерами, полностью сохранивший атмосферу вокзалов начала XX века.', mustSeeFilter: 'creative' , themeTags: ['Северный модерн'], locationSlug: 'saint-petersburg-vitebskiy-vokzal'},
      ...
      { name: 'Доходный дом Бубыря', desc: 'Эталонный образец сурового северного модерна, фасад которого облицован грубым финским гранитом и украшен загадочными барельефами сказочных птиц, рыб и лесных существ.', mustSeeFilter: 'houses' , themeTags: ['Северный модерн'], locationSlug: 'saint-petersburg-dom-bubyrya'},
      ...
      { name: 'Доходный дом Иоффа (Пять углов)', desc: 'Архитектурная доминанта знаменитого перекрестка, чей узкий, похожий на нос корабля фасад увенчан изящной круглой башней с куполом.', mustSeeFilter: 'houses', locationSlug: 'saint-petersburg-dom-ioffa' },
      ...
      { name: 'Парадная «Ромашка» (Дом Елисеева)', desc: 'Уникальный круглый вестибюль на улице Ломоносова, где центральный пилон и радиальные рамы окон создают иллюзию раскрытого цветка. (If same as 109 Eliseevs on Fontanka, merge carefully - owner listed both; prefer distinct addresses if different.)', mustSeeFilter: 'houses', locationSlug: 'saint-petersburg-paradnaya-romashka' },
      ...
      { name: 'Особняк Половцова (Дом архитектора)', desc: 'Строгое снаружи здание на Большой Морской, поражающее своими скрытыми интерьерами: Бронзовым залом без окон со световым фонарем и Белым залом в стиле Людовика XVI.', mustSeeFilter: 'mansions', locationSlug: 'saint-petersburg-osobnyak-polovtsova' },
      ...
      { name: 'Особняк Мясникова', desc: 'Отреставрированный необарокко-особняк на Восстания с нарядным белым фасадом, ставший популярным частным культурным пространством.', mustSeeFilter: 'mansions', locationSlug: 'saint-petersburg-osobnyak-myasnikova' },
      ...
      { name: 'Василеостровский рынок', desc: 'Масштабное гастрономическое пространство в реконструированных каменных корпусах Андреевского рынка XVIII века, объединившее кухни со всего мира.', mustSeeFilter: 'gastro', locationSlug: 'saint-petersburg-vasileostrovskiy-rynok' },
      ...
      { name: 'Кондитерская «Север-Метрополь»', desc: 'Главный сладкий бренд города на Невском проспекте, чьи пирожные «Буше» и торты ручной работы являлись главным сувениром из Ленинграда.', mustSeeFilter: 'gastro', locationSlug: 'saint-petersburg-sever-metropol' },
      ...
      { name: 'Бар «Хроники»', desc: 'Интеллектуальная рюмочная на улице Некрасова, возродившая культуру ленинградских питейных заведений для новой творческой интеллигенции.', mustSeeFilter: 'gastro' , themeTags: ['Ленинградский рок и андеграунд'], locationSlug: 'saint-petersburg-hronika'},
      ...
      { name: 'Гастробар «Harvest»', desc: 'Проект Дмитрия Блинова, признанный одним из лучших ресторанов страны за уникальный фокус на высокую кухню из локальных овощей и экологичное потребление.', mustSeeFilter: 'gastro', locationSlug: 'saint-petersburg-harvest' },
      ...
      { name: 'Рюмочная «Маяк»', desc: 'Культовое заведение на улице Маяковского, сохранившее аутентичную советскую атмосферу с бюстами Ленина и бутербродами со шпротами.', mustSeeFilter: 'gastro', locationSlug: 'saint-petersburg-mayak' },
      ...
      { name: 'Ресторан «Кококо»', desc: 'Знаменитый проект Матильды Шнуровой, ставший пионером русского нью-вейва в кулинарии благодаря переосмыслению фермерских продуктов региона.', mustSeeFilter: 'gastro', locationSlug: 'saint-petersburg-kokoko' },
      ...
      { name: 'Московский рынок', desc: 'Модернизированный по образцу Даниловского исторический рынок у метро «Электросила» под массивным сталинским неоклассическим куполом.', mustSeeFilter: 'gastro', locationSlug: 'saint-petersburg-moskovskiy-rynok' },
      ...
      { name: 'Пушкинская 10', desc: 'Культовый арт-центр и музыкальный адрес ленинградского андеграунда.', mustSeeFilter: 'creative', themeTags: ['Ленинградский рок и андеграунд'] locationSlug: 'saint-petersburg-pushkinskaya-10' },
    ...
    significantSuburbs: [
      {
        ...
        mustSeeFilter: 'main',
        places: [
          { name: 'Нижний парк Петергофа', seasonLabel: 'Летняя навигация - май-октябрь', desc: 'Регулярный парадный сад Петра I на берегу Финского залива со знаменитой системой фонтанов, работающей вообще без насосов.', locationSlug: 'saint-petersburg-nizhniy-park-petergofa' },
          { name: 'Большой каскад', seasonLabel: 'Летняя навигация - май-октябрь', desc: 'Монументальное фонтанное сооружение с гротами и позолоченной фигурой Самсона, разрывающего пасть льва, символизирующей победу над Швецией.' },
        ...
        gastroHint: 'Кафе-кондитерская «Оранжерея» (Петергоф) - Уютное заведение в историческом здании придворных оранжерей, знаменитое своими десертами ручной работы и возможностью выпить кофе с видом на парадные императорские конюшни.' },
      {
        ...
        mustSeeFilter: 'main',
        places: [
          { name: 'Екатерининский дворец', desc: 'Грандиозный барочный замок Франческо Растрелли, внутри которого находится знаменитая, полностью восстановленная Янтарная комната.', locationSlug: 'saint-petersburg-ekaterininskiy-dvorets' },
          { name: 'Царскосельский лицей', desc: 'Мемориальный музей, сохранивший подлинную обстановку комнат и классов, где учился и писал первые стихи Александр Пушкин.', locationSlug: 'saint-petersburg-tsarskoselskiy-litsey' },
        ...
        stationName: 'Станция Царское Село' },
      {
        ...
        mustSeeFilter: 'main',
        places: [
          { name: 'Морской Никольский собор', desc: 'Колоссальный ставропигиальный храм на Якорной площади, построенный по образу Софии Константинопольской как мемориал погибшим морякам.', locationSlug: 'saint-petersburg-morskoy-nikolskiy-sobor' },
          { name: 'Якорная площадь', desc: 'Главная площадь Кронштадта с исторической чугунной мостовой, Морским Никольским собором и памятником адмиралу Макарову.' },
          ...
          { name: 'Музей военно-морской славы', desc: 'Ультрасовременный павильон, главным экспонатом которого стала первая советская атомная подлодка К-3, размещенная прямо внутри здания.', venueSlug: 'saint-petersburg-muzey-voenno-morskoy-slavy' },
          { name: 'Петровский док', desc: 'Исторический сухой док петровской эпохи, один из ключевых инженерных памятников острова Котлин.' },
        ],
        ...
        gastroHint: '«Голландская кухня» (Кронштадт, у Петровского дока) - Историческое заведение, переосмыслившее кулинарные традиции голландских мастеров верфей Петра.' },
      {
        ...
        mustSeeFilter: 'main',
        places: [
          { name: 'Большой Гатчинский дворец', desc: 'Суровый охотничий замок Антонио Ринальди из пудостского камня, скрывающий 130-метровый подземный ход к Серебряному озеру.', locationSlug: 'saint-petersburg-bolshoy-gatchinskiy-dvorets' },
          { name: 'Приоратский дворец', desc: 'Уникальный миниатюрный замок Мальтийского ордена на берегу Черного озера, полностью построенный из прессованной земли по технологии землебита.', locationSlug: 'saint-petersburg-prioratskiy-dvorets' },
        ...
        stationName: 'Станция Гатчина-Балтийская' },
      {
        ...
        mustSeeFilter: 'main',
        places: [
          { name: 'Павловский парк', seasonLabel: 'Зимний эксклюзив: заснеженный парк', desc: 'Один из самых больших пейзажных парков Европы (600 гектаров), славящийся своими живописными районами «Белая береза» и «Старая Сильвия».' },
          { name: 'Павловский дворец', desc: 'Золотисто-белый классический дворец Чарльза Камерона, возведенный на высоком холме над извилистой рекой Славянкой.', locationSlug: 'saint-petersburg-pavlovskiy-dvorets' },
        ...
        stationName: 'Станция Стрельна' },
      {
        ...
        mustSeeFilter: 'main',
        places: [
          { name: 'Выборгский замок', desc: 'Единственный в России полностью сохранившийся средневековый шведский рыцарский замок, основанный на скалистом острове в 1293 году.', locationSlug: 'saint-petersburg-vyborgskiy-zamok' },
          ...
          { name: 'Скальный парк Монрепо', desc: 'Редкий по красоте скальный пейзажный парк на берегу Выборгского залива с гранитными валунами ледникового периода и Островом мертвых.', locationSlug: 'saint-petersburg-skalnyy-park-monrepo' },
        ...
        stationName: 'Станции Сестрорецк, Репино, Комарово' },
      {
        ...
        mustSeeFilter: 'main',
        places: [
          { name: 'Крепость Орешек', seasonLabel: 'Летняя навигация - май-октябрь', desc: 'Древняя новгородская фортеция XIV века на Ореховом острове в истоке Невы, выдержавшая жестокие штурмы шведов и ставшая главной тюрьмой империи.' },
        ...
        stationName: 'Катера от Невы' },
      {
        ...
        mustSeeFilter: 'main',
        places: [
          { name: 'Андерсенград', desc: 'Уникальный детский игровой городок из камня, построенный к 175-летию Ханса Кристиана Андерсена в стиле средневековой западноевропейской архитектуры с ратушей, подземным ходом и бастионами.', locationSlug: 'saint-petersburg-andersengrad-sosnovyy-bor' },
    ...
    dayRoutePresets: [
      ...
      },
      {
        ...
        description: 'Рубинштейна, Некрасова, рюмочные и финал в баре у Новой Голландии.',
        blogSlug: 'spb-barnyy-peterburg-ryumochnye-spikizi',
        stops: [
          spbPresetStop('Улица Рубинштейна', { dayRouteId: 'spb-rubinshteyna', latitude: 59.931211, longitude: 30.342914, locationSlug: 'saint-petersburg-ulitsa-rubinshteyna' }),
          spbPresetStop('Евгенич', { dayRouteId: 'spb-evgenich', latitude: 59.931811, longitude: 30.342112, venueSlug: 'evgenich-na-rubinshteina-6930909cfc27bb700696490f' }),
          spbPresetStop('Новая Голландия', { dayRouteId: 'spb-novaya-gollandiya', latitude: 59.929112, longitude: 30.289214, locationSlug: 'saint-petersburg-novaya-gollandiya' }),
          spbPresetStop('El Copitas', { dayRouteId: 'spb-el-copitas', latitude: 59.927114, longitude: 30.347112, locationSlug: 'saint-petersburg-spikizi-bar-el-copitas' }),
    ...
    dayRoutePresets: [
      ...
      },
      {
        ...
        stops: [
          ...
          { name: 'Дюна Эфа', desc: 'Дюны и панорама Балтики', locationSlug: 'kaliningrad-dyuna-efa' },
