...
export const CITY_INFO: Record<string, CityInfoEntry> = {
  ...
  perm: {
    ...
    significantSuburbs: [
      ...
      {
        name: 'Кунгур',
        desc: 'Купеческий город на Сылве и знаменитая ледяная пещера Урала - около 90 км от Перми.',
        address: 'г. Кунгур, Пермский край',
        locationSlug: 'perm-kungur',
        latitude: 57.4333,
        longitude: 56.95,
        travelVector: 'Купеческий город на Сылве и знаменитая ледяная пещера Урала - около 90 км от Перми.',
        travelVectorBlurb:
    ...
    dayRoutePresets: [
      ...
      },
      {
        ...
        description: 'Купеческий город на Сылве и знаменитая ледяная пещера Урала - около 90 км от Перми.',
        timingNote: 'Вязовская пряничная - удобная остановка на обратном пути в Пермь.',
        travelVector: 'Купеческий город на Сылве и знаменитая ледяная пещера Урала - около 90 км от Перми.',
        travelVectorBlurb:
          'Сначала старый центр, затем авто к ледяной пещере. По желанию - Камень Ермак на Сылве (не совмещать с Белой горой).',
