...
export const CITY_INFO: Record<string, CityInfoEntry> = {
  'saint-petersburg': {
    ...
    mustSee: [
      ...
      { name: 'Юсуповский дворец', desc: 'Интерьеры и легенда Распутина.', mustSeeFilter: 'museum', locationSlug: 'saint-petersburg-yusupovskiy-dvorets' },
      ...
      { name: 'Университетская набережная', desc: 'Сфинксы и вид на стрелку с ВО.', mustSeeFilter: 'views', locationSlug: 'saint-petersburg-universitetskaya-naberezhnaya' },
      ...
      { name: 'Троицкий мост', desc: 'Ракурс на крепость и ростральные колонны.', mustSeeFilter: 'views', locationSlug: 'saint-petersburg-troitskiy-most' },
      { name: 'Улица Зодчего Росси', desc: 'Идеальная перспектива к Александринке.', mustSeeFilter: 'street', locationSlug: 'saint-petersburg-ulitsa-zodchego-rossi' },
      ...
      { name: 'Улица Рубинштейна', desc: 'Вечерняя жизнь и старый доходный фонд.', mustSeeFilter: 'street', locationSlug: 'saint-petersburg-ulitsa-rubinshteyna' },
