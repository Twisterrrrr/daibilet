    ...
    significantSuburbs: [
      {
        ...
        mustSeeFilter: 'main',
        places: [
          { name: 'Нижний парк Петергофа', seasonLabel: 'Летняя навигация - май-октябрь', desc: 'регулярный парадный сад Петра I на берегу Финского залива со знаменитой системой фонтанов, работающей вообще без насосов.', locationSlug: 'saint-petersburg-nizhniy-park-petergofa', latitude: 59.885112, longitude: 29.908214, transitTip: 'От станции Новый Петергоф ~15-20 мин пешком / автобус к входу' },
          { name: 'Большой каскад', seasonLabel: 'Летняя навигация - май-октябрь', desc: 'монументальное фонтанное сооружение с гротами и позолоченной фигурой Самсона, разрывающего пасть льва, символизирующей победу над Швецией.', latitude: 59.88935, longitude: 29.90855, transitTip: 'Пешком вниз по оси парка к каскаду ~5-8 мин' },
          { name: 'Большой дворец Петергофа', desc: 'парадная барочная резиденция Петра I и Елизаветы над каскадом, с тронным залом и анфиладой парадных покоев.', locationSlug: 'saint-petersburg-bolshoy-dvorets-petergofa', latitude: 59.89055, longitude: 29.90785, transitTip: 'Пешком вверх от каскада к дворцу ~3-5 мин' },
          { name: 'Верхний сад', desc: 'регулярный партер перед фасадом Большого дворца с тремя главными фонтанами и видом на Морской канал.', latitude: 59.89185, longitude: 29.90845, transitTip: 'Пешком через дворец / к партеру Верхнего сада' },
          { name: 'Дворец Монплезир', desc: 'любимый приморский дворец Петра Великого со старинной голландской плиткой, где царь лично принимал иностранных послов.', latitude: 59.8879, longitude: 29.9184, transitTip: 'Пешком к заливу, восточная часть Нижнего парка ~10 мин' },
          { name: 'Павильон Марли', desc: 'камерный голландский павильон Петра I у прудов западной части Нижнего парка, любимое место уединения царя.', latitude: 59.88685, longitude: 29.89655, transitTip: 'Пешком к западной части парка / прудам Марли ~10-12 мин' },
          { name: 'Парк Александрия', desc: 'уединенная пейзажная резиденция четырех поколений Романовых, оформленная в стиле романтической английской неоготики.', latitude: 59.8808, longitude: 29.9212, transitTip: 'Пешком / короткий переход в Александрию ~10-15 мин' },
          { name: 'Готическая капелла', desc: 'домашняя церковь императорской семьи в Александрии, являющаяся шедевром ложной готики работы архитектора Шинкеля.', latitude: 59.8786, longitude: 29.9261, transitTip: 'Пешком по Александрии к капелле ~5-8 мин' },
        ],
    ...
    dayRoutePresets: [
      {
        ...
        description:
          'Пешеходная дуга: Сенатская - вдоль Невы - Исаакий - Большая Морская - Дворцовая - дворы/Конюшенные - Невский.',
        timingNote:
        ...
        stops: [
          ...
          spbPresetStop('Адмиралтейство', {
            desc: 'Шпиль и фасад вдоль Невы',
            transitTip: 'Пешком вдоль Невы / Адмиралтейская набережная',
          }),
          spbPresetStop('Александровский сад', {
            desc: 'Сквозь сад к Исаакию',
            transitTip: 'Сквозь Александровский сад - без возврата на Неву',
          }),
          spbPresetStop('Исаакиевский собор', {
            dayRouteId: 'spb-isaakievskiy-sobor',
            latitude: 59.9343,
            longitude: 30.3061,
            desc: 'Собор и интерьер',
            transitTip: 'Пешком из сада к собору',
          }),
          spbPresetStop('Колоннада Исаакия', {
            desc: 'Панорама - если ясно и без длинной очереди',
            transitTip: 'Сейчас: колоннада при хорошей видимости; иначе оставьте на другой приезд',
          }),
          spbPresetStop('Синий мост', {
            desc: 'К Мариинскому дворцу / дальше на Большую Морскую',
            transitTip: 'Пешком к Синему мосту - короткий выход к Мариинскому',
          }),
          spbPresetStop('Большая Морская', {
            desc: 'Парадная улица к Дворцовой',
            transitTip: 'По Большой Морской к Дворцовой; мимо Литературного кафе - гастро-пауза',
          }),
          spbPresetStop('Дворцовая площадь', {
            dayRouteId: 'spb-dvortsovaya-ploschad',
            latitude: 59.939,
            longitude: 30.3158,
            desc: 'Открытое пространство перед музеем',
            transitTip: 'Пешком до арки Главного штаба / Дворцовой',
          }),
          spbPresetStop('Эрмитаж', {
            desc: 'Один музейный блок',
            transitTip: 'Один музей 2-3 часа; Зимний подробнее - на другой день',
          }),
          spbPresetStop('Главный штаб (Эрмитаж)', {
            desc: 'Арка и восточное крыло',
            transitTip: 'Через арку Главного штаба - если Эрмитаж пропускаете',
          }),
          spbPresetStop('Двор Капеллы', {
            desc: 'Тихий поворот с парадной оси',
            transitTip: 'Пешком к Мойке / дворы Капеллы - смена акустики города',
          }),
          spbPresetStop('Пышечная на Большой Конюшенной', {
            desc: 'Простая пауза после дворцов',
            transitTip: 'К Большой Конюшенной - пышка и кофе',
          }),
          spbPresetStop('Храм Святой Екатерины', {
            desc: 'На пути к Невскому',
            transitTip: 'Пешком к Невскому через квартал у Екатерины',
          }),
          spbPresetStop('Дом компании «Зингер»', {
            desc: 'Финал у Дома книги / Невского',
            transitTip: 'Финал на Невском у Зингера - дальше канал Грибоедова по желанию',
          }),
        ],
      },
      {
      ...
      },
      {
        ...
        stops: [
          spbPresetStop('Улица Некрасова / рюмочные «Залив» и «Хроники»', {
            ...
            transitTip: 'Старт на Некрасова - рюмочные «Залив» / «Хроники»',
          }),
          spbPresetStop('Синий Пушкин', {
            ...
            desc: 'Жуковского 3',
            transitTip: '~5 мин пешком к Жуковского 3',
          }),
          spbPresetStop('El Copitas', {
            ...
            transitTip: 'Пешком к Владимирской; бронь ~20:00',
          }),
          spbPresetStop('Улица Рубинштейна', {
          ...
          spbPresetStop('Евгенич', {
            ...
            desc: 'Рубинштейна 23',
            transitTip: 'На Рубинштейна 23 - Евгенич',
          }),
          spbPresetStop('Новая Голландия', {
            ...
            transitTip: 'Такси ~15 мин к Новой Голландии ~23:00',
          }),
    ...
    significantSuburbs: [
      {
        ...
        places: [
          ...
          { name: 'Лебединое озеро', desc: 'пресноводное озеро у Рыбачьего - спокойная пауза на обратном пути', latitude: 55.1535, longitude: 20.8485, transitTip: 'Пешком / коротко у Рыбачьего на обратном пути' },
      ...
      },
      {
        ...
        places: [
          { name: 'Курортный проспект', desc: 'от вокзала - пешеходная улица со старой немецкой застройкой, гирляндами и кошачьими граффити', latitude: 54.9595, longitude: 20.4765, transitTip: 'Пешком от вокзала по Курортному проспекту' },
          { name: 'Памятник зеленоградским котам', desc: 'вращающаяся скульптура кота - символ и фото-точка на линии проспекта', latitude: 54.9598, longitude: 20.4755, transitTip: 'Пешком по проспекту - без возвратов' },
          { name: 'Музей «Домик Ангелов»', desc: 'музейный квартал Саратовская - частная коллекция ангелов в деревянном доме', latitude: 54.9582, longitude: 20.4745, transitTip: 'Пешком в музейный квартал Саратовская' },
          { name: 'Музей кошек «Мурариум»', desc: 'музейный квартал Саратовская - 40-метровая водонапорная башня со смотровой', venueSlug: 'kaliningrad-muzey-koshek-murarium', latitude: 54.958914, longitude: 20.481211, transitTip: 'Пешком рядом - тот же квартал Саратовская' },
          { name: 'Бювет «Королева Луиза»', desc: 'выход к променаду - бесплатная минеральная вода у набережной', latitude: 54.9615, longitude: 20.4785, transitTip: 'Пешком к бювету и выходу на променад' },
          { name: 'Променад и волнорез', desc: 'морской финал линии - длинный променад и волнорез Кранца', latitude: 54.9625, longitude: 20.4795, transitTip: 'Пешком на променад - морской финал' },
          { name: 'Кирха Святого Адальберта', desc: 'неоготический силуэт курорта - доминанта старого Кранца рядом с центром', latitude: 54.9575, longitude: 20.4805, transitTip: 'Пешком у центра - доминанта рядом с линией' },
        ],
      },
      {
        ...
        places: [
          { name: 'Водонапорная башня Раушена', desc: 'у Светлогорск-2 - 25-метровый силуэт в стиле немецкого романтизма, визитная карточка города', locationSlug: 'kaliningrad-vodonapornaya-bashnya-raushena', latitude: 54.943112, longitude: 20.151214, transitTip: 'Пешком от Светлогорск-2 - верхний круг' },
          { name: 'Вилла Порр', desc: 'роскошная немецкая вилла начала XX века с дендропарком - следующий шаг верхнего круга', latitude: 54.9455, longitude: 20.1555, transitTip: 'Пешком по верху к вилле Порр' },
          { name: 'Органный зал «Макаров»', desc: 'концертный зал на месте капеллы Santa Maria Stella Maris - перед спуском к морю', latitude: 54.9445, longitude: 20.1525, transitTip: 'Пешком по верху - перед спуском к морю' },
          ...
          { name: 'Скульптура «Нимфея»', desc: 'русалка у променада - фото-точка у моря перед канаткой', latitude: 54.9398, longitude: 20.1475, transitTip: 'Пешком по променаду у моря' },
          { name: 'Пляж у фуникулера', desc: 'песчаный пляж у нижней станции - перед подъемом', latitude: 54.9408, longitude: 20.1488, transitTip: 'Пешком к нижней станции канатки' },
      ...
      },
      {
        ...
        places: [
          ...
          { name: 'Пехотные казармы', desc: 'красный кирпич начала XX века, штаб Балтийского флота - городской блок до парома', latitude: 54.6405, longitude: 19.8935, transitTip: 'Пешком по городу до парома' },
          { name: 'Маяк Пиллау и памятник Петру I', desc: 'у парома на косу - самый западный маяк России (Шинкель) и памятник Петру I', latitude: 54.6415, longitude: 19.8825, transitTip: 'Пешком к маяку у парома' },
      ...
      },
      {
        ...
        places: [
          ...
          { name: 'Музей янтаря / выставка комбината', desc: 'экспозиция у карьера - короткий контекст перед пешим кругом в центр', latitude: 54.8688, longitude: 19.9425, transitTip: 'Пешком у карьера - перед кругом в центр' },
          { name: 'Янтарный замок', desc: 'пешком в центр - замок XIV века, музей пыток, оружие и янтарная лавка', latitude: 54.8675, longitude: 19.9435, transitTip: 'Пешком в центр к замку' },
          { name: 'Парк Беккера', desc: 'пешком к морю - парк Мориса Беккера с редкими деревьями; дальше выход на променад к пляжу', latitude: 54.8685, longitude: 19.9455, transitTip: 'Пешком к парку и променаду' },
          { name: 'Пляж «Шахта Анна»', desc: 'финал - широкий пляж с «Голубым флагом» после променада', latitude: 54.8725, longitude: 19.9355, transitTip: 'Пешком по променаду к пляжу' },
        ],
      },
    ],
    dayRoutePresets: [
        ...
        places: [
          {
            ...
            latitude: 56.6505,
            longitude: 43.4685,
            transitTip: '7-10 мин пешком от автостанции',
          },
          {
            ...
            latitude: 56.644,
            longitude: 43.472,
            transitTip: 'Пешком вниз к центру / Торговой площади',
          },
          {
            ...
            latitude: 56.6442,
            longitude: 43.4715,
            transitTip: 'Пешком по центру - музейный квартал рядом',
          },
          {
            ...
            latitude: 56.6455,
            longitude: 43.4735,
            transitTip: '2-5 мин пешком между музеями квартала',
          },
          {
            ...
            latitude: 56.6438,
            longitude: 43.4708,
            transitTip: 'Пешком в том же музейном квартале',
          },
          {
            ...
            latitude: 56.6465,
            longitude: 43.4755,
            transitTip: 'Пешком к Волге / набережной Революции',
          },
          {
      ...
      },
      {
        ...
        places: [
          ...
          },
          {
            ...
            latitude: 56.7895,
            longitude: 44.4925,
            transitTip: 'Пешком к МТЦ «Золотая хохлома»',
          },
          {
            ...
            latitude: 56.7885,
            longitude: 44.491,
            transitTip: 'Пешком в исторический центр / пл. Ленина',
          },
          {
            name: 'Парк Победы',
            ...
            latitude: 56.7905,
            longitude: 44.4895,
            transitTip: 'Пешком в Парк Победы; к вокзалу - бонус музей Шарыгина по пути',
          },
        ],
      },
      {
        ...
        places: [
          ...
          },
          {
            ...
            latitude: 55.0488,
            longitude: 43.2418,
            transitTip: 'Пешком по территории монастыря к Троицкому',
          },
          {
            ...
            latitude: 55.0492,
            longitude: 43.2425,
            transitTip: 'Пешком между соборами обители',
          },
          {
            ...
            latitude: 55.0495,
            longitude: 43.2408,
            transitTip: 'Пешком по ансамблю к Благовещенскому',
          },
          {
        ...
        places: [
          {
            ...
            latitude: 56.0835,
            longitude: 45.0615,
            transitTip: 'Паром из Лыскова (~30 мин) - затем пешком к монастырю',
          },
          {
            ...
            latitude: 56.0842,
            longitude: 45.0605,
            transitTip: 'Пешком по двору / стенам к смотровой',
          },
          {
            ...
            latitude: 56.0825,
            longitude: 45.0635,
            transitTip: 'Пешком в посёлок; страусиная ферма - бонус отдельным такси/авто',
          },
        ],
      },
    ],
    ...
    significantSuburbs: [
      {
        ...
        places: [
          { name: 'Усадьба Баяндиных', desc: 'купеческая усадьба с жилым домом и надворными постройками.', latitude: 58.2612, longitude: 56.2642, transitTip: 'От входа - сектор Южное Прикамье, круг против часовой' },
          { name: 'Ветряная мельница', desc: 'классический ветряк среди изб и хозяйственных построек.', latitude: 58.2598, longitude: 56.2612, transitTip: 'Пешком по музейному кругу против часовой' },
          { name: 'Богородицкая церковь', desc: 'деревянный храм экспозиции (+ Георгиевская церковь рядом в музейном секторе), перевезенный с берегов Камы.', latitude: 58.2609, longitude: 56.2621, transitTip: 'Пешком к храмовому сектору' },
          { name: 'Сторожевая башня', desc: 'оборонительная деревянная башня на холме над заливом.', latitude: 58.2624, longitude: 56.2639, transitTip: 'Пешком вверх к башне' },
          { name: 'Охотничий дом / Заимка', desc: 'деревянный охотничий дом и заимка в музейной экспозиции - быт промыслов Прикамья.', latitude: 58.2605, longitude: 56.2635, transitTip: 'Пешком по кругу к заимке' },
          { name: 'Усть-Боровский сользавод', desc: 'комплекс солеваренного промысла - визитная карточка музейной экспозиции; ближе к финалу круга.', latitude: 58.2632, longitude: 56.2648, transitTip: 'Пешком к сользаводу - ближе к финалу круга' },
          { name: 'Смотровая над заливом', desc: 'панорама Камского залива с холма музея - финальный кадр Хохловки.', latitude: 58.2628, longitude: 56.2618, transitTip: 'Финал пешком к смотровой над заливом' },
        ],
      },
      {
        name: 'Кунгур',
        ...
        places: [
          { name: 'Пуп Земли', desc: 'символический «центр» Кунгура и точка сбора для прогулок по старому городу.', latitude: 57.43121, longitude: 56.9428, transitTip: 'Старт пешком в центре Кунгура' },
          { name: 'Набережная Сылвы', desc: 'прогулка вдоль реки в центре - часть пешеходного круга до авто-блока.', latitude: 57.4295, longitude: 56.9485, transitTip: 'Пешком к набережной Сылвы' },
          { name: 'Тихвинская церковь', desc: 'храмовая доминанта старого Кунгура.', latitude: 57.4308, longitude: 56.9512, transitTip: 'Пешком по старому центру' },
          { name: 'Гостиный двор', desc: 'купеческий центр старого Кунгура - торговые ряды и каменная застройка.', latitude: 57.4328, longitude: 56.9438, transitTip: 'Пешком к Гостиному двору' },
          { name: 'Музей истории купечества', desc: 'быт и история кунгурских купцов в историческом особняке.', latitude: 57.4335, longitude: 56.9455, transitTip: 'Пешком по центру к музею' },
          { name: 'Кунгурская ледяная пещера', desc: 'одна из самых известных карстовых пещер Урала с ледяными гротами - авто-блок дня.', locationSlug: 'perm-kungurskaya-ledyanaya-peshchera', latitude: 57.4409, longitude: 57.006, transitTip: 'Авто к пещере после центра (~15-20 мин)' },
      ...
      },
      {
        ...
        places: [
          ...
          { name: 'Царский крест', desc: 'крупный поклонный крест с видом на округу.', latitude: 57.3914, longitude: 56.2306, transitTip: 'Пешком у вершины к кресту' },
          ...
          { name: 'Водопад Плакун', desc: 'живописный известняковый водопад в Суксунском районе - финал православного дня.', latitude: 57.3481, longitude: 57.0506, transitTip: 'Авто к Плакуну (Суксун); Ермак в этот день не брать' },
        ],
      },
      {
        ...
        places: [
          { name: 'Камень Ермак', desc: 'скальный останец на Сылве, связанный с маршрутами Ермака - якорь «кунгурского экстрима».', latitude: 57.3736, longitude: 57.0667, transitTip: 'Авто к Сылве; стык с кунгурским днём, без Белой горы' },
        ],
      },
      {
        name: 'Усьва (день 1)',
        ...
        places: [
          { name: 'Усьвинские столбы', desc: 'вертикальные скалы над рекой Усьвой - визитная карточка района.', locationSlug: 'perm-usvinskie-stolby', latitude: 58.7175, longitude: 57.6152, transitTip: 'Трек / авто к столбам - день 1' },
          { name: 'Смотровая Усьвинских столбов', desc: 'площадка с видом на отвесные скалы над Усьвой - ключевой кадр дня.', latitude: 58.7168, longitude: 57.6145, transitTip: 'Пешком к смотровой у столбов' },
          { name: 'Сердце Пармы (Загубашка)', desc: 'декорации и виды фильма/книги о Парме - после трека к столбам, без спешки.', latitude: 58.705, longitude: 57.602, transitTip: 'После трека - Загубашка; Каменный город оставьте на день 2' },
        ],
      },
      {
        name: 'Губаха (день 2)',
        ...
        places: [
          { name: 'Каменный город', desc: 'скальный «город» останцев среди тайги у Губахи.', locationSlug: 'perm-kamennyy-gorod', latitude: 58.72359, longitude: 57.63404, transitTip: 'День 2 - авто/трек к Каменному городу' },
          { name: 'Пещера Российская', desc: 'карстовая пещера у Каменного города - осторожно на входе, без лишней авантюры.', latitude: 58.7245, longitude: 57.636, transitTip: 'Пешком у Каменного города; осторожно на входе' },
          { name: 'Гора Крестовая', desc: 'горнолыжный и видовой склон над Губахой - лучше на закат.', latitude: 58.82861, longitude: 57.585, transitTip: 'Авто к Крестовой на закат; Полюд (~250 км) не брать' },
        ],
      },
    ],
    dayRoutePresets: [
