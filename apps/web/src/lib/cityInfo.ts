  ...
  smolensk: {
    brief:
      'Один из древнейших городов России, хранящий многовековую историю и величие крепостных стен. Гостей ждут экскурсии по монументальному Смоленскому кремлю, старинные храмы и богатая театральная жизнь. Посетите городские фестивали и прикоснитесь к культурному наследию «щита Руси».',
        mustSee: [
      { name: 'Смоленская крепостная стена', desc: 'Главный символ Смоленска - уцелевшие участки грандиозной каменной крепости с башнями на холмах над Днепром.',
        locationSlug: 'smolensk-smolenskaya-krepostnaya-stena',
      },
      { name: 'Свято-Успенский кафедральный собор', desc: 'Главный духовный символ Смоленска - величественный барочный собор на Соборной горе с панорамным видом на Днепр.',
        venueSlug: 'smolensk-svyato-uspenskiy-kafedral-nyy-sobor',
      },
      { name: 'Громовая башня', desc: 'Самая знаменитая башня Смоленской крепости с реставрированной деревянной крышей и современным интерактивным музеем внутри.',
        locationSlug: 'smolensk-gromovaya-bashnya',
      },
      { name: 'Лопатинский сад', desc: 'Старейший городской парк Смоленска внутри крепостного рва с прудами, черными лебедями, аттракционами и колесом обозрения.',
        locationSlug: 'smolensk-lopatinskiy-sad',
      },
      { name: 'Памятник «Благодарная Россия героям 1812 года» (Памятник с орлами)', desc: 'Самый известный памятник Смоленска - экспрессивная скульптурная композиция с гранитной скалой и двумя орлами в сквере Памяти Героев.',
        locationSlug: 'smolensk-pamyatnik-blagodarnaya-rossiya-geroyam-1812-goda-pamyatnik-s-or',
      },
      { name: 'Историко-архитектурный комплекс «Теремок» (Флёново)', desc: 'Сказочный неорусский комплекс в усадьбе Флёново под Смоленском с деревянным теремом и храмом по эскизам Николая Рериха.',
  ...
  syktyvkar: {
    brief:
      'Столица Республики Коми, где современный городской ритм гармонично сочетается с самобытными традициями Севера. Туристов привлекают уникальные этнографические музеи, яркие театральные постановки и национальные праздники. Отсюда удобно начинать путешествие к природным памятникам региона.',
        mustSee: [
      { name: 'Свято-Стефановский кафедральный собор', desc: 'Главный православный храм Сыктывкара - белокаменный неовизантийский собор высотой с 20-этажный дом на улице Свободы.',
        venueSlug: 'syktyvkar-svyato-stefanovskiy-kafedral-nyy-sobor',
      },
      { name: 'Национальная галерея Республики Коми', desc: 'Главный художественный музей Коми с коллекцией русской классики, авангарда и северных икон в здании бывшего Духовного училища.',
        venueSlug: 'syktyvkar-natsional-naya-galereya-respubliki-komi',
      },
      { name: 'Улица Куратова и купеческие дома', desc: 'Старейшая атмосферная улица Сыктывкара с ансамблем резных деревянных и каменных купеческих особняков и кофейнями.',
        locationSlug: 'syktyvkar-ulitsa-kuratova-i-kupecheskie-doma',
      },
      { name: 'Пожарная каланча', desc: 'Краснокирпичная часовая пожарная башня 1907 года - парадный архитектурный символ Сыктывкара с курантами и музеем.',
        locationSlug: 'syktyvkar-pozharnaya-kalancha',
      },
      { name: 'Памятник купеческому сундуку', desc: 'Популярный жанровый памятник в виде массивного бронзового купеческого сундука с монетами в центре Сыктывкара.',
        locationSlug: 'syktyvkar-pamyatnik-kupecheskomu-sunduku',
      },
      { name: 'Арт-объект «Коми пасы»', desc: 'Этно-футуристическая чугунная стела с древними рунами-пасами в пешеходной зоне улицы Карла Маркса в Сыктывкаре.',
        locationSlug: 'syktyvkar-art-ob-ekt-komi-pasy',
      },
    ],
    sights: [
  ...
  'yuzhno-sahalinsk': {
    brief:
      'Уникальный островной город, окружённый живописными сопками и девственной природой Дальнего Востока. Здесь можно найти как современные культурные события, так и музеи с редкими экспонатами эпохи Карафуто. Идеальное место для любителей активного отдыха, гастрономических фестивалей и морепродуктов.',
        mustSee: [
      { name: 'Сахалинский областной краеведческий музей', desc: 'Подлинный памятник японской архитектуры с экспозицией о природе, коренных народах и истории Сахалина.',
        venueSlug: 'yuzhno-sahalinsk-sahalinskiy-oblastnoy-kraevedcheskiy-muzey',
      },
      { name: 'Горнолыжный комплекс «Горный воздух»', desc: 'Крупный городской горнолыжный курорт с гондольными подъемниками и смотровыми площадками над Сусунайской долиной.',
        locationSlug: 'yuzhno-sahalinsk-gornolyzhnyy-kompleks-gornyy-vozduh',
      },
      { name: 'Музейно-мемориальный комплекс «Победа»', desc: 'Современный военно-исторический комплекс с мультимедийными панорамами и экспозицией техники на площади Победы.',
        venueSlug: 'yuzhno-sahalinsk-muzeyno-memorial-nyy-kompleks-pobeda',
      },
      { name: 'Кафедральный собор Рождества Христова', desc: 'Главный собор Сахалина и Курил с гигантской мозаикой из самоцветов и белокаменным 77-метровым объемом.',
        venueSlug: 'yuzhno-sahalinsk-kafedral-nyy-sobor-rozhdestva-hristova',
      },
      { name: 'Сахалинский зооботанический парк', desc: 'Островной зоопарк и ботанический сад с амурскими тиграми, леопардами и панорамными вольерами без решеток.',
        venueSlug: 'yuzhno-sahalinsk-sahalinskiy-zoobotanicheskiy-park',
      },
      { name: 'Грязевой вулкан Южно-Сахалинский', desc: 'Геологический памятник с десятками глиняных конусов, из которых круглый год булькает прохладная лечебная грязь.',
  ...
  kostroma: {
    brief:
      ...
      { name: 'Свято-Троицкий Ипатьевский монастырь', desc: 'Главная святыня Костромы и колыбель дома Романовых у слияния Костромы и Волги.',
        venueSlug: 'kostroma-svyato-troitskiy-ipat-evskiy-monastyr',
      },
  ...
  murmansk: {
    brief:
      'Крупнейший в мире город за Полярным кругом — для романтиков, искателей приключений и охотников за уникальными природными явлениями. Отсюда стартуют популярные туры за Северным сиянием и поездки к побережью Северного Ледовитого океана в Териберку.',
        mustSee: [
      { name: 'Атомный ледокол «Ленин»', desc: 'Первый в мире гражданский атомный ледокол, превращенный в интерактивный музей с сохраненными интерьерами и машинным залом.',
        venueSlug: 'murmansk-atomnyy-ledokol-lenin',
      },
      { name: 'Мемориал «Защитникам Советского Заполярья в годы Великой Отечественной войны» («Алёша»)', desc: 'Главная смотровая доминанта Мурманска на сопке Зеленый мыс с гигантским солдатом, Вечным огнем и круговой панорамой на Кольский залив.',
        locationSlug: 'murmansk-memorial-zaschitnikam-sovetskogo-zapolyar-ya-v-gody-velikoy-ote',
      },
      { name: 'Мемориальный комплекс «Морякам, погибшим в мирное время»', desc: 'Трогательный мемориальный комплекс на холме с маяком, залом памяти и фрагментом рубки атомной подводной лодки «Курск».',
        locationSlug: 'murmansk-memorial-nyy-kompleks-moryakam-pogibshim-v-mirnoe-vremya',
      },
      { name: 'Мурманский областной краеведческий музей', desc: 'Старейший музей Кольского Севера с коллекцией минералов, арктической фауной и материалами о Кольской сверхглубокой скважине.',
        venueSlug: 'murmansk-murmanskiy-oblastnoy-kraevedcheskiy-muzey',
      },
      { name: 'Памятник «Ждущая»', desc: 'Самый поэтичный жанровый памятник Мурманска - бронзовая девушка на уступе над Кольским заливом, всматривающаяся в морскую даль.',
        locationSlug: 'murmansk-pamyatnik-zhduschaya',
      },
      { name: 'Мост через Кольский залив', desc: 'Грандиозный четырехполосный мост длиной 2,5 километра - главный транспортный переход через Кольский залив и площадка фестиваля «Гольфстрим».',
        locationSlug: 'murmansk-most-cherez-kol-skiy-zaliv',
      },
    ],
    sights: [
  ...
  tambov: {
    brief:
      'Очаровательный зелёный южно-русский город с роскошными купеческими усадьбами и белокаменными соборами. Манит яркими фестивалями, знаменитыми гастрономическими брендами и атмосферой душевного провинциального уюта.',
        mustSee: [
      { name: 'Музей-усадьба Асеевых', desc: 'Роскошная усадьба фабриканта Асеева на берегу Цны с дворцом, парком и трехсотлетним дубом-свидетелем основания Тамбова.',
        venueSlug: 'tambov-muzey-usad-ba-aseevyh',
      },
      { name: 'Набережная реки Цны', desc: 'Самая длинная прогулочная зона Тамбова - ухоженная двухъярусная набережная Цны с мостами, ротондами и поющими фонтанами.',
        locationSlug: 'tambov-naberezhnaya-reki-tsny',
      },
      { name: 'Спасо-Преображенский кафедральный собор', desc: 'Самое старое каменное здание Тамбовской области - белокаменный собор с восстановленной 84-метровой колокольней на Соборной площади.',
        venueSlug: 'tambov-spaso-preobrazhenskiy-kafedral-nyy-sobor',
      },
      { name: 'Казанский мужской монастырь', desc: 'Уникальный духовный ансамбль Тамбова с ярко-розовым Казанским собором и 107-метровой надвратной колокольней.',
        venueSlug: 'tambov-kazanskiy-muzhskoy-monastyr',
      },
      { name: 'Памятник Тамбовскому мужику', desc: 'Философский памятник крестьянину-пахарю на Кронштадтской площади - один из самых узнаваемых символов Тамбова.',
        locationSlug: 'tambov-pamyatnik-tambovskomu-muzhiku',
      },
      { name: 'Тамбовский областной краеведческий музей', desc: 'Один из старейших музеев Поволжья в бывшем Доме политического просвещения с коллекцией живописи, археологии и скелетом мамонта.',
  ...
  chita: {
    brief:
      'Колоритная столица Забайкалья с богатой историей, где удивительным образом переплелись купеческое наследие, память о ссыльных декабристах и восточные традиции. Чита привлекает путешественников возможностью прикоснуться к самобытной культуре коренных народов и близостью к живописным Ивано-Арахлейским озерам.',
        mustSee: [
      { name: 'Музей декабристов (Михайло-Архангельская церковь)', desc: 'Старинная деревянная церковь XVIII века без единого гвоздя, ставшая мемориальным музеем декабристов.',
        venueSlug: 'chita-muzey-dekabristov-mihaylo-arhangel-skaya-tserkov',
      },
      { name: 'Читинский дацан «Дамба Брейбулинг»', desc: 'Главный буддийский центр Забайкалья с ярким храмовым комплексом и молитвенными барабанами.',
        venueSlug: 'chita-chitinskiy-datsan-damba-breybuling',
      },
      { name: 'Кафедральный собор Казанской иконы Божией Матери', desc: 'Величественный лазурно-белый собор с девятью куполами и огромным благовестным колоколом.',
        venueSlug: 'chita-kafedral-nyy-sobor-kazanskoy-ikony-bozhiey-materi',
      },
      { name: 'Титовская сопка', desc: 'Древний потухший вулкан и главная смотровая площадка Читы с панорамой Ингоды и тайги.',
        locationSlug: 'chita-titovskaya-sopka',
      },
      { name: 'Дворец Шумовых', desc: 'Роскошный купеческий особняк начала XX века с грифонами, башенками и богатым декором фасада.',
        venueSlug: 'chita-dvorets-shumovyh',
      },
      { name: 'Ивано-Арахлейские озера', desc: 'Каскад чистейших озер на Великом водоразделе с пляжами, турбазами и панорамами забайкальской тайги.',
  ...
  kurgan: {
    brief:
      ...
      { name: 'Центр «Восстановительная травматология и ортопедия» имени академика Г. А. Илизарова', desc: 'Мирово известный медицинский центр Илизарова с музеем ортопедии и парком.',
        venueSlug: 'kurgan-tsentr-vosstanovitel-naya-travmatologiya-i-ortopediya-imeni-akade',
      },
      ...
      { name: 'Музей истории города Кургана (Усадьба купца Березина)', desc: 'Купеческая усадьба XIX века с экспозицией о быте слободы Царёво Городище.',
        venueSlug: 'kurgan-muzey-istorii-goroda-kurgana-usad-ba-kuptsa-berezina',
      },
      ...
      { name: 'Курганский областной культурно-выставочный центр (КВЦ)', desc: 'Главная культурная сцена Зауралья в здании советского модернизма с крупными выставками.',
        venueSlug: 'kurgan-kurganskiy-oblastnoy-kul-turno-vystavochnyy-tsentr-kvts',
      },
  ...
  lipeck: {
    brief:
      ...
      { name: 'Соборная площадь и Христорождественский кафедральный собор', desc: 'Парадный центр Липецка на вершине Соборной горы с белоснежным классицистическим собором и каскадами фонтанов.',
        venueSlug: 'lipeck-sobornaya-ploschad-i-hristorozhdestvenskiy-kafedral-nyy-sobor',
      },
  ...
  cheboksary: {
    brief:
      'Колоритная и невероятно зеленая столица Чувашии, раскинувшаяся на живописном берегу Волги. Пешеходные экскурсии здесь традиционно начинаются у величественного монумента Матери-Покровительнице и продолжаются на Красной площади у Чебоксарского залива. Город влюбляет в себя путешественников самобытными национальными традициями, интерактивным Музеем истории трактора и дегустациями знаменитых чувашских блюд и напитков.',
        mustSee: [
      { name: 'Монумент «Мать-Покровительница»', desc: 'Главный символ Чебоксар на холме над заливом с панорамной площадкой и надписью о мире и любви.',
        locationSlug: 'cheboksary-monument-mat-pokrovitel-nitsa',
      },
      { name: 'Чебоксарский залив и Красная площадь', desc: 'Главное общественное пространство Чебоксар с заливом, фонтанами, колесом обозрения и обновленной Красной площадью.',
        locationSlug: 'cheboksary-cheboksarskiy-zaliv-i-krasnaya-ploschad',
      },
      { name: 'Бульвар Купца Ефремова', desc: 'Пешеходный «чувашский Арбат» со старинными купеческими особняками, кофейнями и памятниками.',
        locationSlug: 'cheboksary-bul-var-kuptsa-efremova',
      },
      { name: 'Научно-технический музей истории трактора', desc: 'Уникальный музей тягловой техники с десятками рабочих тракторов и интерактивными симуляторами.',
        venueSlug: 'cheboksary-nauchno-tehnicheskiy-muzey-istorii-traktora',
      },
      { name: 'Чувашский национальный музей', desc: 'Главный музей Чувашии на Красной площади с уникальной «вышитой картой» республики.',
        venueSlug: 'cheboksary-chuvashskiy-natsional-nyy-muzey',
      },
      { name: 'Введенский кафедральный собор', desc: 'Старейший каменный храм Чувашии с мощными стенами, древними фресками и чудотворной иконой.',
        venueSlug: 'cheboksary-vvedenskiy-kafedral-nyy-sobor',
      },
    ],
    sights: [
  ...
  saransk: {
    brief:
      'Яркая и невероятно ухоженная столица Мордовии, гармонично сочетающая современные спортивные арены с бережно хранимой национальной культурой. Этот город славится своим гостеприимством, колоритной финно-угорской кухней и колоссальным количеством живописных фонтанов.',
        mustSee: [
      { name: 'Кафедральный собор святого праведного воина Феодора Ушакова', desc: 'Главный духовный символ Мордовии в стиле ампир с позолоченным куполом высотой 62 метра и смотровой террасой у подножия.',
        venueSlug: 'saransk-kafedral-nyy-sobor-svyatogo-pravednogo-voina-feodora-ushakova',
      },
      { name: 'Музей изобразительных искусств им. С. Д. Эрьзи', desc: 'Передовой музейный комплекс с крупнейшей коллекцией скульптур Степана Эрьзи и высокотехнологичными мультимедийными залами.',
        venueSlug: 'saransk-muzey-izobrazitel-nyh-iskusstv-im-s-d-er-zi',
      },
      { name: 'Площадь Тысячелетия и фонтан «Звезда Мордовии»', desc: 'Ультрасовременная площадь с плоскостным фонтаном «Звезда Мордовии» диаметром 60 метров, лазерным шоу и гранитной плиткой.',
        locationSlug: 'saransk-ploschad-tysyacheletiya-i-fontan-zvezda-mordovii',
      },
      { name: 'Этнографический комплекс «Мордовское подворье»', desc: 'Живописный этнографический музей под открытым небом на берегу Саранки с воссозданной крестьянской усадьбой и ремесленными мастерскими.',
        locationSlug: 'saransk-etnograficheskiy-kompleks-mordovskoe-podvor-e',
      },
      { name: 'Музей мордовской народной культуры', desc: 'Колоритный музей в бывшем купеческом особняке, посвященный обрядами, костюмам и быту эрзян и мокшан.',
        venueSlug: 'saransk-muzey-mordovskoy-narodnoy-kul-tury',
      },
      { name: 'Стадион «Мордовия Арена»', desc: 'Грандиозный стадион чемпионата мира 2018 года с ярко-оранжевым фасадом, набережной Инсара и крупными спортивными и культурными событиями.',
  ...
  habarovsk: {
    brief:
      'Величественный и солнечный город на Дальнем Востоке, раскинувшийся на высоких утесах могучего Амура. Хабаровск очаровывает путешественников своими масштабными площадями, зелеными бульварами и возможностью увидеть легендарный Амурский мост, изображенный на пятитысячной купюре.',
        mustSee: [
      { name: 'Набережная Адмирала Невельского и Хабаровский утес', desc: 'Многоуровневая набережная у Амура с Хабаровским утесом и открыточными панорамами на реку и город.',
        locationSlug: 'habarovsk-naberezhnaya-admirala-nevel-skogo-i-habarovskiy-utes',
      },
      { name: 'Амурский мост (Музей истории Амурского моста)', desc: 'Грандиозный совмещенный мост через Амур с музеем под открытым небом и подлинной царской фермой.',
        venueSlug: 'habarovsk-amurskiy-most-muzey-istorii-amurskogo-mosta',
      },
      { name: 'Площадь имени Ленина', desc: 'Главная площадь Хабаровска со сталинским ампиром, фонтанами и ключевым транспортным узлом города.',
        locationSlug: 'habarovsk-ploschad-imeni-lenina',
      },
      { name: 'Хабаровский краевой музей имени Н. И. Гродекова', desc: 'Крупнейший музей Дальнего Востока с финвалом, 3D-панорамой «Волочаевская битва» и этнографическими коллекциями.',
        venueSlug: 'habarovsk-habarovskiy-kraevoy-muzey-imeni-n-i-grodekova',
      },
      { name: 'Градо-Хабаровский собор Успения Божией Матери', desc: 'Монументальный собор в неорусском стиле на Комсомольской площади с панорамным видом на Амурский затон.',
        venueSlug: 'habarovsk-grado-habarovskiy-sobor-uspeniya-bozhiey-materi',
      },
      { name: 'Городские пруды и парк «Динамо»', desc: 'Главный зеленый оазис Хабаровска с прудами, мостками и светомузыкальными фонтанами.',
