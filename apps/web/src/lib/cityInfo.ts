...
export const CITY_INFO: Record<string, CityInfoEntry> = {
  ...
  perm: {
    ...
    mustSee: [
      ...
      { name: 'Пермяк - солёные уши', desc: 'Жанровый памятник у «Грибоедова»: фото с бронзовыми ушами.', address: 'Комсомольский проспект, 27', locationSlug: 'permsky-solenye-ushi', mustSeeFilter: 'main', visitMinutes: 15, latitude: 58.0108, longitude: 56.2415 },
      { name: 'Пермский медведь', desc: 'Бронзовый символ города на пешеходной Ленина.', address: 'ул. Ленина, 58', locationSlug: 'perm-permskiy-medved', mustSeeFilter: 'main', visitMinutes: 15, latitude: 58.0116, longitude: 56.2393 },
      { name: 'Дом Грибушина', desc: 'Особняк в стиле модерн с богатым фасадным декором.', address: 'ул. Ленина, 13А', locationSlug: 'perm-dom-gribushina', mustSeeFilter: 'houses', visitMinutes: 20, latitude: 58.0177, longitude: 56.2514 },
    ...
    dayRoutePresets: [
      {
        ...
        description:
          '3.6 км, около 2-2.5 часов. Главное культурное и архитектурное наследие для первого визита.',
        timingNote: 'Пешком по зелёной разметке на тротуаре - гид не нужен.',
        stops: [
          {
            name: 'Пермский академический Театр-Театр',
            desc: 'Отправная точка, современный символ театральной Перми.',
          ...
          },
          {
            ...
            desc: 'Самый знаменитый жанровый памятник города.',
          ...
          {
            name: 'Дом чекистов',
            desc: 'Монументальный памятник советского конструктивизма.',
          ...
          },
          {
            ...
            desc: 'Красивое историческое здание, где бывали Чехов и Пастернак.',
          ...
          },
          {
            ...
            desc: 'Классическое купеческое подворье.',
          ...
          },
          {
            ...
            desc: 'Красивейший старинный вокзал, откуда начиналась Уральская железная дорога.',
          ...
          },
          {
            ...
            desc: 'Здание в стиле сталинского ампира, рядом с которым стоит знаменитый арт-объект «Счастье не за горами».',
      ...
      },
      {
        ...
        description:
          '2.5 км, около 1.5 часов. Литература, тайны, старинные особняки и тихие прогулки.',
        timingNote: 'Пешком по красной разметке - истории любви, связанные с Пермью.',
        stops: [
          {
          ...
          {
            name: 'Дом Грибушина',
            desc: 'Живописный особняк в стиле модерн с лепными ликами (считается «домом с фигурами» из романа «Доктор Живаго»). История любви купца Сергея Грибушина.',
          ...
          },
          {
            ...
            desc: 'История платонической любви и переписки философа Александра Герцена и Натальи Захарьиной во время его ссылки.',
          ...
          },
          {
            ...
            desc: 'Связана с визитами писателя Антона Чехова, который вдохновился пермскими сёстрами Циммерман для создания пьесы «Три сестры».',
          ...
          },
          {
            ...
            desc: 'Конечная точка с панорамным видом на Каму, место традиционных свиданий и прогулок поэтов Серебряного века.',
