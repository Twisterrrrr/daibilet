  ...
  perm: {
    ...
    significantSuburbs: [
      ...
      },
      {
        ...
        desc: 'Белогорский монастырь, Царский крест, купель у горы и водопад Плакун - один реалистичный день по Р-242 / Суксун.',
        address: 'с. Белая Гора / Суксунский район',
        locationSlug: 'perm-belaya-gora',
        latitude: 57.39202,
        longitude: 56.229,
        travelVector: 'Р-242 / Суксун',
        travelVectorBlurb:
          'Трасса Р-242 / Суксун: монастырь - Царский крест - купель/источник у горы - Плакун. Камень Ермак оставляйте на день Кунгура - иначе крюк 80-100+ км.',
        timingNote:
          'Купель в связке с монастырём. Ермак + Плакун с Белой горой за один день - невозможно (крюк 80-100+ км).',
        places: [
      ...
      {
        name: 'Губаха / Усьва',
        desc: 'Горнозаводской край на 2 дня: Усьвинские столбы и «Сердце Пармы», затем Каменный город и Крестовая. Полюд (~250 км) не брать.',
        address: 'Губаха / Усьва, Пермский край',
        locationSlug: 'perm-gubakha-usva',
        latitude: 58.723,
        longitude: 57.633,
        travelVector: 'Усьва / Губаха - 2 дня',
        travelVectorBlurb:
          'Два дня без гонки: день 1 - Усьва (столбы, смотровая, Загубашка); день 2 - Губаха (Каменный город, пещера Российская, Крестовая на закат). Полюд (~250 км) не совмещать.',
        timingNote:
          '2 дня. День 1: после столбов - Загубашка, Каменный город не пихать. День 2: пещера осторожно на входе; Крестовая на закат; Полюд не брать.',
        places: [
          {
          ...
          {
            name: 'Гора Крестовая',
            desc: 'горнолыжный и видовой склон над Губахой - лучше на закат.',
            latitude: 58.82861,
            longitude: 57.585,
            transitTip: 'Авто к Крестовой на закат; Полюд (~250 км) не брать'
          },
        ]
      },
    ],
    dayRoutePresets: [
      ...
      },
      {
        ...
        description: 'Белогорский монастырь, Царский крест, купель и Плакун по Р-242 / Суксун.',
        timingNote:
          'Выезд по Р-242 / Суксун. Купель держите в связке с монастырём; Ермак оставляйте на день Кунгура.',
        travelVector: 'Р-242 / Суксун',
        travelVectorBlurb:
          'Монастырь - Царский крест - купель - Плакун. Камень Ермак - в карточке Кунгура, не сюда.',
        stops: [
      ...
      },
      {
        ...
        title: 'Губаха / Усьва - 2 дня',
        description:
          'День 1: Усьвинские столбы, смотровая, Загубашка. День 2: Каменный город, пещера Российская, Крестовая на закат.',
        timingNote:
          '2 дня. День 1 - Усьва (не пихать Каменный город). День 2 - Губаха; пещера осторожно; Полюд (~250 км) не брать.',
        travelVector: 'Усьва / Губаха - 2 дня',
        travelVectorBlurb:
          'День 1 - Усьва: столбы + смотровая + Загубашка. День 2 - Губаха: Каменный город - пещера - Крестовая на закат.',
        stops: [
