  ...
  'saint-petersburg': {
    ...
    dayRoutePresets: [
      ...
      },
      {
        ...
        stops: [
          spbPresetStop('Улица Рубинштейна'),
          spbPresetStop('Бар «Евгенич»'),
          spbPresetStop('Улица Некрасова'),
          spbPresetStop('Рюмочная «Хроники»'),
          spbPresetStop('Рюмочная «Маяк»'),
          spbPresetStop('Новая Голландия'),
          spbPresetStop('Рюмочная «Залив»'),
          spbPresetStop('Коктейльный бар «El Copitas»'),
          spbPresetStop('Бар «Orthodox»'),
          spbPresetStop('Бар «Синий Пушкин»'),
        ],
      },
    ],
    travel:
