...
export const PENZA_MUST_SEE: any[] = [
  ...
  place('Скульптура «Дама с собачкой»', 'Бронзовая дама с собачкой на Московской - чеховский кадр на главной улице.', 53.194712, 45.015212, { address: 'ул. Московская', locationSlug: 'penza-dama-s-sobachkoy', mustSeeFilter: 'monument', visitMinutes: 10 }),
  ...
  place('Тарханы', 'Главный литературный day trip Пензы и родина Лермонтова в области.', 52.995724, 43.676417, { address: 'с. Лермонтово, музей-заповедник «Тарханы»', venueSlug: 'penza-muzey-zapovednik-tarhany', mustSeeFilter: 'museum', visitMinutes: 'полдня', alsoMain: true }),
  ...
  place('Здание Государственного банка', 'Главный банковский фасад центра.', 53.184912, 45.010912, { address: 'ул. Московская', locationSlug: 'penza-zdanie-gosudarstvennogo-banka', mustSeeFilter: 'houses', visitMinutes: 15 }),
  ...
  place('Ротонда в парке Белинского', 'Белая беседка на верхнем ярусе парка Белинского, откуда открывается город.', 53.200912, 45.014612, { address: 'парк Белинского', locationSlug: 'penza-rotonda-v-parke-belinskogo', mustSeeFilter: 'views', visitMinutes: 15 }),
...
export const PENZA_SUBURBS: any[] = [
  {
    ...
    places: [
      place('Барский дом Лермонтовых', 'Главное ядро усадьбы и главный музейный рассказ о ранних годах поэта.', 52.995724, 43.676417, { address: 'территория музея', locationSlug: 'penza-tarhany-barskiy-dom', mustSeeFilter: 'museum', visitMinutes: 45 }),
      place('Церковь Марии Египетской', 'Усадебный храм и важная часть ансамбля.', 52.995524, 43.676017, { address: 'территория музея', locationSlug: 'penza-tarhany-cerkov-marii-egipetskoy', mustSeeFilter: 'temple', visitMinutes: 20 }),
      place('Парк и липовые аллеи', 'Тихие маршруты, которые лучше всего объясняют атмосферу Тархан.', 52.996124, 43.675717, { address: 'территория музея', locationSlug: 'penza-tarhany-park', mustSeeFilter: 'park', visitMinutes: 40 }),
      place('Людская изба', 'Бытовой слой усадьбы без музейной лакировки.', 52.995824, 43.676717, { address: 'территория музея', locationSlug: 'penza-tarhany-lyudskaya-izba', mustSeeFilter: 'museum', visitMinutes: 20 }),
      place('Склеп-часовня Арсеньевых', 'Родовой мемориал и еще одна важная эмоциональная точка маршрута.', 52.995124, 43.677617, { address: 'территория музея', locationSlug: 'penza-tarhany-sklep-arsenevyh', mustSeeFilter: 'monument', visitMinutes: 20 }),
    ],
  },
  {
    ...
    places: [
      place('Сосновые аллеи Ахуна', 'Главное, ради чего сюда едут: длинная прогулка по хвойному лесу.', 53.177684, 45.137865, { address: 'лесопарк Ахуны', locationSlug: 'penza-ahuny-sosnovye-allei', mustSeeFilter: 'park', visitMinutes: 60 }),
      place('Смотровые просеки', 'Открытые участки леса с более свободным воздухом и светом.', 53.178684, 45.137165, { address: 'лесопарк Ахуны', locationSlug: 'penza-ahuny-smotrovye-proseki', mustSeeFilter: 'views', visitMinutes: 25 }),
      place('Санаторный квартал', 'Редкий слой советской курортной архитектуры внутри городского леса.', 53.177084, 45.138765, { address: 'район Ахуны', locationSlug: 'penza-ahuny-sanatornyy-kvartal', mustSeeFilter: 'houses', visitMinutes: 20 }),
      place('Лесные тропы здоровья', 'Неспешные кольцевые маршруты без сложного рельефа.', 53.178384, 45.136665, { address: 'лесопарк Ахуны', locationSlug: 'penza-ahuny-tropy-zdorovya', mustSeeFilter: 'park', visitMinutes: 45 }),
    ],
  },
  {
