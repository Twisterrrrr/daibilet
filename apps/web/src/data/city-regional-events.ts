...
export const CITY_REGIONAL_EVENTS: Record<string, CityRegionalEvent[]> = {
  ...
  tula: [
    {
      id: 'tula-elektrofest-2026',
      title: 'Фестиваль электронной музыки «Электрофест»',
      startDate: '2026-08-29',
      endDate: '2026-08-30',
      datesLabel: '29-30 августа 2026',
      place: 'Креативный кластер «Октава» (ул. Каминского, 24)',
      blurb:
        'Главный постиндустриальный рейв региона: независимые диджеи, концептуальный хип-хоп и лазерное шоу на территории действующего завода.',
      sourceUrl: 'https://afisha.yandex.ru/tula',
      sourceLabel: 'Яндекс Афиша Тула',
    },
    {
      id: 'tula-slet-pod-ryukzakom-2026',
      title: 'Слёт под рюкзаком - 2026',
      startDate: '2026-09-11',
      endDate: '2026-09-13',
      datesLabel: '11-13 сентября 2026',
      place: 'Арт-кэмп «Дикая Мята» (Алексинский р-н, пос. Бунырево)',
      blurb:
        'Всероссийский фестиваль путешественников и аутдор-культуры: лекции у костра, мастер-классы по выживанию и акустические концерты.',
      sourceUrl: 'https://wildmint.ru/',
      sourceLabel: 'Дикая Мята Camp',
    },
    {
      id: 'tula-tolstoy-fest-2026',
      title: 'Театральный фестиваль «Толстой»',
      startDate: '2026-07-03',
      endDate: '2026-07-05',
      datesLabel: '3-5 июля 2026',
      place: 'Музей-усадьба Л. Н. Толстого «Ясная Поляна»',
      blurb:
        'Юбилейный X фестиваль театрального искусства под открытым небом: ведущие режиссеры ставят спектакли в живых усадебных декорациях.',
      sourceUrl: 'https://tolstoyfest.ru/',
      sourceLabel: 'tolstoyfest.ru',
    },
    {
      id: 'tula-dikaya-myata-2026',
      title: 'Мультиформатный опен-эйр «Дикая Мята - 2026»',
      startDate: '2026-06-19',
      endDate: '2026-06-21',
      datesLabel: '19-21 июня 2026',
      place: 'Алексинский район, поселок Бунырево',
      blurb:
        'Крупнейший независимый музыкальный фестиваль России с десятками хэдлайнеров, бассейнами, лекториями и палаточными городами.',
      sourceUrl: 'https://wildmint.ru/',
      sourceLabel: 'Дикая Мята',
    },
  ],
