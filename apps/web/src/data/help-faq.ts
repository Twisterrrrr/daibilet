  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        a: 'При оплате в виджете билет обычно приходит сразу после успешной транзакции. Если статус не обновился — проверьте email и раздел «Проверить заказ» по номеру из письма.',
      },
      {
