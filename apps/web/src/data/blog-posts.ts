...
export const BLOG_POSTS: BlogPost[] = [
  ...
  },
  {
    ...
    title:
      'Питерский дождь и дети: 4 умных места, где можно переждать непогоду без родительского героизма',
    excerpt:
      'Планетарий 1, Музей Матрёшки, выставка по мотивам Гарри Поттера и Особняк Мясникова - как переждать дождь с ребёнком без героизма.',
    date: '11 авг 2026',
    readMin: 8,
    tag: 'От автора',
    city: 'Санкт-Петербург',
