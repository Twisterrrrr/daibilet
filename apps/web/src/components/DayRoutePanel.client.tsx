        ...
        <section className="mt-5 w-full sm:mt-8" data-day-route-list>
          <div className="flex flex-col gap-3 lg:flex-row lg:items-center lg:justify-between lg:gap-3">
            <div className="flex min-w-0 items-center justify-between gap-2 lg:justify-start">
              ...
              {hasMapStops ? (
                <div
                  className="inline-flex shrink-0 rounded-full border border-slate-200 bg-white p-0.5 lg:hidden"
                  role="group"
          ...
          {totalDistanceMeters > 0 ? (
            <div
              className="mt-3 rounded-xl border border-slate-200 bg-white px-3 py-2 sm:py-3"
              data-day-distance-summary
            >
              {/* Mobile: Итого+Около left; Пешком/Авто top-right */}
              <div className="flex items-start justify-between gap-2 sm:hidden" data-day-distance-summary-mobile>
