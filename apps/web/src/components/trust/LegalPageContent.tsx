        ...
        <article className="space-y-14">
            ...
            <div className="mt-4 space-y-3 text-slate-700">
              ...
              <ul className="list-disc space-y-1 pl-5">
                <li>
                  ...
                  или воспользуйтесь{' '}
                  <a href="/help#contact" className="text-primary-600 hover:underline">
          ...
          <section id="partner-data" className="scroll-mt-24">
            ...
            <div className="mt-4 space-y-3 text-slate-700">
              ...
              <p>
                Подробности — в{' '}
                <a href="/offer" className="text-primary-600 hover:underline">
          ...
          <section id="payments" className="scroll-mt-24">
            ...
            <div className="mt-4 space-y-3 text-slate-700">
              <p>
                Оплата билетов проходит в официальном виджете билетной системы организатора
                (Ticketscloud, Teplohod.info и др.), который открывается с daibilet.ru. Доступные
                способы зависят от оператора:
              </p>
              <ul className="list-disc space-y-1 pl-5">
                <li>Банковские карты: Visa, Mastercard, МИР</li>
                <li>СБП (Система быстрых платежей)</li>
                <li>Другие способы — если поддерживает виджет партнёра</li>
              </ul>
              <p>
                Дайбилет не принимает платежи и не хранит данные банковских карт. Платёжные данные
                вводятся и обрабатываются оператором билетной системы в его защищённом интерфейсе.
              </p>
            </div>
          </section>
          ...
          <section id="contacts" className="scroll-mt-24">
            ...
            <div className="mt-4 space-y-3 text-slate-700">
              ...
              <p>
                ...
                <a href="/requisites" className="text-primary-600 hover:underline">
                  Реквизиты
                </a>
              </p>
              <p>
