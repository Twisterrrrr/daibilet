...
export const metadata: Metadata = {
  ...
  description: 'Изолированный smoke featured bento-cluster и fade media до релиза на /events.',
      ...
      <div className="container-page py-8 sm:py-10">
        <div className="mb-6 max-w-3xl space-y-2">
          ...
          <p className="text-sm leading-relaxed text-graphite-muted sm:text-base">
            ...
            бейдж «Выбор редакции». На mobile/tablet сетка плоская (1→2 колонки), без bento и без
            пустых ячеек. На lg+ (3 колонки) - editorial cluster на полную ширину ряда. Preview:
