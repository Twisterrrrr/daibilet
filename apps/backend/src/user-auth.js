...
const JWT_SECRET = process.env.USER_JWT_SECRET || (process.env.NODE_ENV === 'production' ? '' : 'dev-user-jwt-secret-change-me');
...
function requireJwtSecret() {
  if (!JWT_SECRET) throw authError('USER_JWT_SECRET is not configured.', 503);
  return JWT_SECRET;
}
