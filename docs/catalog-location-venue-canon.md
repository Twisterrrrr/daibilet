...
- Билет, чтобы **войти** (экскурсия по залам, колоннада, экспозиция) или сеанс внутри → **Площадка**. Пример: Юсуповский дворец, Екатерининский дворец, Исаакий, Спас на Крови.
- Точка на маршруте с улицы, без нашего входного продукта (Адмиралтейство, кремль как ансамбль, кирха) → **Локация** `ATTRACTION`.
...
| Дворец-музей / собор с платным входом (Юсуповский, Исаакий, Спас на Крови) | **Venue сразу** (`MUSEUM_ART_SPACE`) |
