...
**Открытая локация (`OUTDOOR_LOCATION`)** - только улица / мост / площадь / набережная / иное место с открытым уличным доступом. Здания в этот чип не кладём (owner 2026-08-05).
