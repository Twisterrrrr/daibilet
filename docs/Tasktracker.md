...
| MS.SPB-KGD-SEED | Owner-verified SPB + KGD must-see, gastro и suburb POI: idempotent catalog dual-write, verified address/coords, slug wiring | Критический | 🔄 MSK seed: 67 inserted, 20 updated, no missing city; cityInfo wiring and web deploy pending |
