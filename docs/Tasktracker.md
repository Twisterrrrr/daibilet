...
| UX.BLOG-MOBILE-OWNER | `/blog` mobile: hide topic chips + view toggle; +30-40% touch targets / cards; excerpt «провести» (`spb-s-rebenkom-v-dozhd`) | Высокий | 🔄 commit+push; deploy n/a |
