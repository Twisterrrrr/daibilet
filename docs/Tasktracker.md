...
| UX.HERO3j | Mobile gap after lead before tag/stats/CTA (`mt-5 md:mt-3`) | Высокий | ✅ `55253504` (deploy с HERO3k) |
| UX.HERO3k | Real `mask-image` on photo (`.city-hero-photo-mask` in globals.css); drop navy overlay | Критический | 🔄 commit+deploy |
