...
| P.3g | **Supplier write flows** — создание/редактирование admission и событий через заявки | Средний | 🔄 backend + supplier UI; ручной admin apply для create/admission |
