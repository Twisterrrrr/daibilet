...
| P.2l | Адрес UI: «Проспект Кольский» → «Кольский проспект» (нормализатор прилагательных + hub venues) | Средний | 🔄 |
| P.2m | City hub chips: визуальный gap между группами date и category (`gap-x-4`) | Средний | 🔄 |
