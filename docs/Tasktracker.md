...
|---|---|---|---|
| UX.HOME-BLOG-EXCERPT | Home 3-card blog: один абзац excerpt/first body под заголовком, line-clamp-3 | Высокий | ✅ live `31790635325` SHA `d7d77b6`/`5142146` BUILD_ID=`HOI4exTECrPJBi1CNwzUN` |
