...
| UX.MYDAY-STARTER | Empty starter: mobile **A** equal py; desktop two-col + 2-line subtitle; **full-width** + edge inset (не max-w-6xl); places+events search | Критический | ✅ `378fb3e` MSK **BUILD_ID=`I1b39S7TOIRax4a8s4z--`** |
