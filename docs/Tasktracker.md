...
| MS.TIER3 | Phase B: Санкт-Петербург - широкий `cityInfo` с тематическими chip, гастро-слоем и пригородами | Высокий | ✅ 120 city must-see, 20 gastro, 5 пригородов / 25 POI, 5 day presets. Production rebuild на MSK подтвердил SSR `/cities/sankt-peterburg` 200; seed не был причиной 500 |
| MS.TIER4 | Phase C: второй город тем же шаблоном (Москва после СПб) | Средний | ⏳ |
| MS.TIER5 | Phase 2 optional: `dayRoutePresets` / multi-day для MSK/SPB после стабильного широкого каталога | Низкий | ✅ СПб: 5 пеших кластеров с гастро-остановками; каждый preset связан с опубликованным companion-гидом |
