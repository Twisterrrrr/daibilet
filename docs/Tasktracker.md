...
| UX.MYDAY-STARTER | Full width; grid/list; H1 «Мой день в…»; mobile starter **A**; stop card **owner-v2** (N+maps+X top-right of title; ↑↓+далее bottom; square thumb) | Критический | ✅ `d1425e5` MSK **BUILD_ID=`D_jH5Sawp7UnqaOX4IJsC`** |
