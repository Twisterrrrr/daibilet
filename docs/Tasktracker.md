...
| UX.MYDAY-STARTER | Compact starter **A** all breakpoints (no lg hero); sym pad; stop card **owner-v3** (N top-left; tight address; далее=title col; ✈+X top-right) | Критический | ✅ `ce60cd7` MSK **BUILD_ID=`jp_TWUUNvcjQD_x1UwJfz`** |
