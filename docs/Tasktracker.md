...
| UX.MYDAY-PRESET-BLOG | Preset cards: quiet «Читать об этом в блоге» via `blogSlug` under title (NN ×3) | Высокий | ✅ `bb4e2f7` tip `3957b9a` MSK **BUILD_ID=`neGTZ9t_aXfs0StFNoZZo`** `/my-day` 200 |
