...
| UX.MYDAY-STARTER | Empty starter: mobile **A** equal py; desktop two-col + 2-line subtitle; **full-width** + edge inset (не max-w-6xl); places+events search | Критический | 🔄 commit+deploy |
