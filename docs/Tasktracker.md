...
| UX.MYDAY-STARTER | Full width; grid/list; H1 «Мой день в…»; mobile starter **A** (inline icon, no labels); exact stop card (N+maps+X top-right; ↑↓+далее bottom) | Критический | ✅ `e548187` MSK **BUILD_ID=`PqFdFw3F8VBu_mGMaS9MN`** |
