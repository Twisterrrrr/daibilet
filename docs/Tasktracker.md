...
| UX.MYDAY-STARTER | Empty starter: mobile **A** locked; desktop left centered in half + right stretch/justify-center; stable geometry (disabled search if !city); equal px=gap | Критический | 🔄 commit+deploy |
