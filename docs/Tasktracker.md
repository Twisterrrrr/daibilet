...
| UX.BLOG-LISTING-VITALITY | `/blog`: featured overlay, magazine mix (banner/strip), serif titles, color chips, less-grey empty/skeleton | Высокий | 🔄 code ready, await MSK deploy |
