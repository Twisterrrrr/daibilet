...
| UX.MYDAY-STARTER | Empty `/my-day`: starter = icon+hint+city/search+«или добавь своё место»; drop «План пока пуст» | Критический | ✅ `6721c9c` MSK **BUILD_ID=`meNSWERi0trhkT0vGq8lO`** |
