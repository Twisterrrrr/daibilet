...
| LOC.SPB-MUSTSEE | SPB editorial locations missing from `/locations` despite DB seed (content take 400 A→Z + warm short-circuit) | Критический | 🔄 fix lean take + location hub + city refetch + Kazan stem |
