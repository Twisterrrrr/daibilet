...
| P.3e8 | **Stage 0 public buyer order DTO** - order-by-code + purchases-by-email expose issued ticket numbers and admission venue snapshot | High | ✅ live `.159`; pending-order lookup verified 2026-09-07 |
