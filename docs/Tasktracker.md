...
| UX.MYDAY-PRESET-BLOG | Preset cards: «Читать об этом в блоге» via `blogSlug` under title - link blue + underline + arrow (NN ×3) | Высокий | ✅ `f48d174` MSK **BUILD_ID=`hKq8B95CQsiBuD4keUJm6`** `/my-day` 200 |
