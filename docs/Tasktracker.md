...
| # | Задача | Приоритет | Статус |
|---|--------|-----------|--------|
| BLOG.TOP100-PLACE-IMGS | Top-100 Parts 1-5: компактный float `[image]` на каждую точку 1-75 + те же JPG в venues для my-day/каталога | Высокий | 🔄 ассеты+MD+renderer+resolveVenueHeroImage локально; commit/push, deploy batch |
