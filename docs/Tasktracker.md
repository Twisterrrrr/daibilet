...
| UX.MYDAY-STARTER | Empty starter: mobile **A**; desktop lg+ **two-col**; unified search shows places+events (round-robin + q); placeholder «Найти место или событие» | Критический | 🔄 commit+deploy |
