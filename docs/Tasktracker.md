...
| MS.SPB-KGD-SEED | Owner-verified SPB + KGD must-see, gastro и suburb POI: idempotent catalog dual-write, verified address/coords, slug wiring | Критический | 🔄 owner pack committed; MSK DB apply and web deploy pending |
