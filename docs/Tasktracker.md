...
| SEO.8b | `country-tours`: требовать экскурсионный и направленческий сигналы, исключить культурные события по топонимам | Высокий | 🔄 2026-07-23 | исправлен legacy runtime `dto.js`; нужны commit, deploy и prod smoke |
...
| Дата | Изменение |
|------|-----------|
| 2026-07-23 | SEO.8b: найдено расхождение `landing-rules.ts` и legacy runtime `dto.js`; синхронизировано правило `country-tours`, deploy + smoke в работе |
