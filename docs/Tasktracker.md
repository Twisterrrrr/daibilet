...
| H.8f | `/blog` afisha promo: цена/события/chips по geo; full-width после 3 статей фида | Критический | ✅ `e43ee4e`+`d47c300` prod @`5e06ae8` |
...
| B.28b | Afisha promo: цена/тайтлы/chips по header geo; полоса под 3 первыми статьями фида | Критический | ✅ `e43ee4e`+`d47c300` prod | агент |
