...
| UX.HOME-GUIDE2 | Mobile stories «Реки и каналы!» / «Бесплатно»; hero = snap + **auto 2с** real afisha events (до 5, city-aware); My Day «Спланируй свой день в {prep}» + одна CTA «Спланировать день» | Высокий | ✅ код; deploy пачкой / по запросу |
