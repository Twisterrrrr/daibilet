...
| MS.TIER3 | Phase B: Санкт-Петербург - широкий `cityInfo` с тематическими chip, гастро-слоем и пригородами | Высокий | ⚠️ 120 city must-see, 20 gastro, 5 пригородов / 25 POI, 5 day presets; MSK deploy `HJMykSPWiCKr0u6cmgWg2`, SPB hub smoke 500 - требует исправления |
