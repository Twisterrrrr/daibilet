...
| UX.BLOG-CARD-POLISH | `/blog` cards: no mid-sentence clamp; serif titles everywhere; CTA left-wrap; contextual CTA labels | Высокий | ✅ commit+push; deploy ждёт owner |
