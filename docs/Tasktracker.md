...
| UX.MYDAY-STARTER | Empty starter: mobile **A**; desktop two-col; **max-w-6xl** (1152px) card; places+events search; placeholder «Найти место или событие» | Критический | 🔄 commit+deploy |
