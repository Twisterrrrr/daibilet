## 2026-08-17 - /events и /places: hero + фильтры

| ID | Задача | Приоритет | Статус |
|---|---|---|---|
| UX.EVENTS-PLACES-HERO | Общий chrome: H1 афиша+типы / места+род.; чип-капсула графит с тенью; лид без длинного тире; sticky поиск+чипы, без FAB и без city-select на /places | Высокий | 🔄 code |
...
## 2026-08-17 - Туристический хаб Рязани

| ID | Задача | Приоритет | Статус |
|---|---|---|---|
| CONT.RYAZAN-HUB | Рязань: 50 мест + 15 памятников + 7 грибов, Константиново/Солотча, карта грибов, green/red, FAQ, lifehacks, фестивали | Высокий | ✅ code; commit+push+Deploy MSK web |
