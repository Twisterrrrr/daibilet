...
|----|--------|-----------|--------|
| UX.HERMITAGE-PDP-V3 | Hermitage PDP: hide commercial tickets; no hero chips; hours above map; Факт; sticky tabs; gallery; open-now; event thumbs; MSK/SPB nearest metro | Критический | 🔄 deploy |
