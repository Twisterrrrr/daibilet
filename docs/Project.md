...
2. **`significantSuburbs` - блок «Значимые пригороды {City_Род}»** на city hub **после** in-city mustSee (не в chips «Главные места»). Snap carousel: одна мини-локация на экран (swipe / arrows), nested POI внутринутри карточки. Copy: «это не город, но очень интересно к посещению». Для СПб: Петергоф, Царское Село, Кронштадт; Калининград: коса / Зеленоградск / Светлогорск / Балтийск / Янтарный.
