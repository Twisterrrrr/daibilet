...
**Структура контента:**
1. Первые **6** оставить как ядро вкладки «Главные» (**в городе**, без дальних day-trip).
2. **`significantSuburbs` - блок «Значимые пригороды {City_Род}»** на city hub **после** in-city mustSee (не в chips «Главные места»). Snap carousel: одна мини-локация на экран (swipe / arrows), nested POI внутринутри карточки. Copy: «Day-trip рядом с городом - отдельные мини-локации и точки внутри них»; бейдж карточки - «Пригород». Для СПб: Петергоф, Царское Село, Кронштадт; Калининград: коса / Зеленоградск / Светлогорск / Балтийск / Янтарный.
