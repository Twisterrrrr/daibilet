...
- **INC.504.5:** dual Soft-SWR collapsed - canonical rebuild only in `public-catalog.dto.ts`; `dto.js` adopts sessions + builds indexes (no second SQL rebuild in API process).
