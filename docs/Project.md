...
**Allowlist городов:** не расширять массово без готовых хабов; иначе каталог растёт без витрины.

См. [Diary.md](./Diary.md) (2026-07-19), задачи P.* в [Tasktracker.md](./Tasktracker.md).
