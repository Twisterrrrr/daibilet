...
Реестр и voice bible: [ai-journalists/README.md](./ai-journalists/README.md), JSON: [ai-journalists/personas.json](./ai-journalists/personas.json).

| authorId | Автор | Колонка | Когда брать |
|----------|-------|---------|-------------|
| `rodion-vetrov` | Родион Ветров | «Ветром и рублём» | Бюджет, экстрим, регионы, «сколько стоит день» |
| `aglaya-fontanskaya` | Аглая Фонтанская | «По эту сторону фасада» | СПб/культура, дворы, мосты, музеи, выставки, театр |
| `mila-orlova` | Мила Орлова | «Семейный радиус» | Дети, быт, безопасность, семейные слоты |
| `tikhon-zarechny` | Тихон Заречный | «Заречье» | Байкал/Север/этно/легенды (бережно) |
| `pavel-yuzhny` | Павел Южный | «Соль и дым» | Рынки, стритфуд, гастро-круизы, регионы вкуса |

**Правила**

- Не дублировать evergreen-кластеры из инвентаря выше без нового угла колонки.
- CTA Дайбилет — мягкий, в голосе автора.
- Статья пишется **только** после промпта пользователя; сначала выбор `authorId`.

**Пилот (fit с текущим каталогом):** 1) Аглая — дворы/мосты/иммерсив/театр; 2) Мила — семья/планетарий/реки с детьми.
