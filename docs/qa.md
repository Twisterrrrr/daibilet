...
3. Поиск в разделе **один** (`/places?q=`): музей и набережная в одном списке с тегом семейства. Чипы Все / С афишей / Достопримечательности фильтруют ту же ленту. Каталоги `/venues` и `/locations` для узкого обзора. **Мой день:** один поиск в шапке подбора (места + события, тег семейства).
