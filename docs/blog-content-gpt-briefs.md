...
> **Сдвиг 2026-08-01 (owner):** очередь live-слотов сдвинута на сегодня. Уже в MD/DB: `bylinnyy-bereg-fentezi-fest-volhov` → **01.08 10:05**, `moskva-parki-open-air-vyhodnye` → **02.08 10:40**, `ural-den-v-gorah-max` → **09.08 11:10**. Ниже таблица Pack B для ещё не написанных промптов A1-A9 - без изменений дат черновиков.
...
> **Сдвиг 2026-08-01:** даты ниже = актуальные `publishedAt` в MD/DB (−2 дня от исходного плана).

| Дата | Время | Тип | Slug | Промпт |
|------|-------|-----|------|--------|
| 2026-08-15 пт | 11:35 | top5 | `nn-stendap-impprov-pyat-voprosov` | A10 |
| 2026-08-07 пт | 19:40 | long | `samara-vykhodnye-dva-dnya-bez-gonki` | A11 |

> **Early live 2026-08-07:** A11 Самара опубликована по запросу owner (из списка 8 городов); исходный слот был 2026-08-16.
